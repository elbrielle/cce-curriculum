...
STUDENT_GOOGLE_COPY_URLS = {
    1: "https://docs.google.com/document/d/1TWgRMdH-gDvpUO-BxB0y4316mCo8t3IjRCBLeIXUbpk/copy",
    2: "https://docs.google.com/document/d/192n8TANNnRP7PpN89Bw9R_2oKXZmOAjZ-oyHZs3M_ts/copy",
    3: "https://docs.google.com/document/d/1G_DYmms-Q5MmXddjZaY1WDA9isDINbuYxNdkN7qG9e4/copy",
    4: "https://docs.google.com/document/d/1qXRmR9Hit6ebMt9tG9_ClIetVXSSR4S5IT2fpE5M4UQ/copy",
    5: "https://docs.google.com/document/d/1UAxy4EoWYyjsL94cbZ0ZG-4sNKqBsfsW1DDb40yw7zw/copy",
}
...
STUDENT_WORKSHEET_COPY_URLS = {
    (1, 'the two-page record'): "https://docs.google.com/document/d/1vO_piUAOfHODIlsEhjPg7XzzpsiEpn8ZAelQGCpmvGI/copy",
    (2, 'the three-page cover-letter lab'): "https://docs.google.com/document/d/1XtO5Gyq9wKdK_xrDzU7y8lv7XoZLZ8AAJaJaX9uZ_xY/copy",
    (3, 'the four-page fictional application and reference record'): "https://docs.google.com/document/d/1KD_WtLPmyvWEMr8bBpQpptW8jmoXpvIZ04BCNOK-Pjg/copy",
    (4, 'the three-page planner'): "https://docs.google.com/document/d/1aa7m_sx5tdu-KyXtif38gvxxSBSTbJyi-bxPPHaRxCU/copy",
    (5, 'the four-page Day 5 record'): "https://docs.google.com/document/d/1KW3lZV0jzOXcUjZAxNEd4y3foG-3dbAtwG2urRCJneU/copy",
}
...
def teacher_content(files, quiz_url):
    ...
    return {
        1: {"TITLE": "Job Search and Posting Screen", "SUBTITLE": "50 minutes · Two-page record", "ALERT": "<strong>Fictional posting:</strong> a posting is a lead, not proof. Students do not register, apply, contact an employer, or share personal data.", "PREP": f'<ul><li>Post {link(files["SEARCH"]["id"], "the two-page record")} and private annotation route; default printing is zero.</li><li>Display the seven mixed actions and the fictional Pecan Creek posting.</li><li>Open the coordinated Student Guide.</li></ul>', "EVIDENCE": "<p>Collect the ordered cycle, marked posting, two truthful matches, one honest gap, two independent verification checks, authorized next action, and exit response.</p>", "FLOW": (
            flow(color, "Minutes 0-5 - Welcome and job search sequencing warm-up", '''<p>Welcome students to Week 5 of 6SW (Job Search, Applications &amp; Mock Interviews) and project the 7 mixed job-search actions on the screen.</p><ul><li>Ask students: <em>“If you find an enticing job posting online that says ‘Make $500 a day from home—click here to register immediately!’, what happens if you apply and send personal information before verifying whether the employer is legitimate? Why must every effective job search follow a strict sequence of screening and verification under TEKS d(6)(A)?”</em></li><li>Collect 2-3 student thoughts: You could get scammed or identity-theft; you have to research the company first!</li><li>Bridge with, <em>“Professional job hunting requires disciplined skepticism and strategic targeting. Today we sequence the 7 steps of an effective job search, analyze a fictional job posting for Pecan Creek Animal Care, and practice independent employer screening.”</em></li></ul>''')
            + flow("#4c8b38", "Minutes 5-13 - Modeling the 7-step search cycle &amp; Pecan Creek screening", '''<p>Deconstruct the 7-Step Job Search Process on the main board:</p><ul><li>1. <strong>Self-Inventory &amp; Target:</strong> Clarify skills, interests, and scheduling boundaries.</li><li>2. <strong>Prepare Master Portfolio:</strong> Gather verified coursework, activities, and references.</li><li>3. <strong>Sourced Search:</strong> Locate open positions through legitimate employer portals or verified school boards.</li><li>4. <strong>Screen Posting:</strong> Compare duties against skills; identify missing qualifications; flag suspicious red flags.</li><li>5. <strong>Track Application Pipeline:</strong> Log deadlines, contact titles, and requirements in a private spreadsheet.</li><li>6. <strong>Tailor Application &amp; Cover Letter:</strong> Match evidence directly to stated qualifications.</li><li>7. <strong>Interview &amp; Professional Follow-Up:</strong> Deliver interview responses and send formal thank-you correspondence.</li><li>Model Pecan Creek Screening: Read the Student Office Assistant posting. Highlight: 20 hours/week, $14/hour, duties: client greeting, scheduling, record entry. Match 2 truthful qualifications; identify 1 honest skill gap (e.g., zero prior veterinary software experience).</li></ul>''')
            + flow("#155d7a", "Minutes 13-30 - Posting screen &amp; verification analysis sprint", '''<p>Students analyze the Pecan Creek posting on their 2-page decision record:</p><ul><li>Section 1: Sequence the 7 search steps in correct chronological order.</li><li>Section 2: Annotate the Pecan Creek posting—label duties, minimum requirements, and working conditions.</li><li>Section 3: Document 2 Truthful Qualification Matches and 1 Honest Skill Gap for fictional applicant Jordan Rivera.</li><li>Section 4: Formulate 2 Independent Verification Checks (e.g., cross-referencing physical clinic address on Google Maps; checking state veterinary licensing boards).</li><li><strong>Active Monitoring Checkpoints:</strong><br>• Lap 1 (Minute 19): Verify students order the 7 steps correctly (sequence key: 6, 1, 7, 4, 2, 5, 3).<br>• Lap 2 (Minute 26): Ensure independent checks use third-party verification, not just trusting the posting text.</li></ul>''')
            + flow("#d39b22", "Minutes 30-45 - Elbow partner risk review &amp; authorized next action", '''<p>Elbow partners compare their verification strategies:</p><ul><li>Partner checks: 'Did your partner identify an honest skill gap rather than pretending to be fully qualified?'</li><li>Students formulate the Authorized Next Action: (A) Proceed to tailored application, (B) Pause and contact clinic to clarify schedule, or (C) Stop if red flags appear.</li></ul>''')
            + flow(color, "Minutes 45-50 - Submit Day 1 Record and wrap-up", '''<p>Students submit their completed 2-page record in Canvas or place paper copies in the collection tray.</p><ul><li><strong>Safe Trim:</strong> Shorten partner discussion; fiercely protect the 7-step sequence, 2 matches + 1 gap, 2 verification checks, and private exit.</li></ul>''')
        ), "MONITOR": "<p><strong>Sequence key by printed row:</strong> 6, 1, 7, 4, 2, 5, 3. Full evidence distinguishes the posting from independent employer verification. A safe conclusion can be continue through a verified route, pause and verify, or stop and report when supported. Trim partner sharing first.</p>", "RESOURCES": source_block[1], "SUPPORT": common_support, "FALLBACK": common_fallback},
        2: {"TITLE": "Tailored Cover Letter", "SUBTITLE": "50 minutes · Three-page lab", "ALERT": "<strong>Not sent:</strong> students use the fictional posting and Jordan evidence only. Requirements vary; a real applicant follows the posting about whether a cover letter is required.", "PREP": f'<ul><li>Post {link(files["COVER"]["id"], "the three-page cover-letter lab")}, {link(files["RUBRIC"]["id"], "the two-page Major profile")}, and private annotation route.</li><li>Keep the posting and Jordan evidence visible.</li><li>Prepare the model evidence links below.</li></ul>', "EVIDENCE": "<p>Collect two accurate evidence links, one honest gap, a three-paragraph plan/draft, claim audit, final fictional letter, and visible revision.</p>", "FLOW": (
            flow(color, "Minutes 0-5 - Welcome and resume vs. cover letter warm-up", '''<p>Welcome students, seat them with devices or the 3-page cover-letter lab, and project the document comparison prompt.</p><ul><li>Ask students: <em>“If your resume is a concise, factual summary of your education, skills, and activities, what is the unique job of a cover letter? Why do hiring managers discard generic form letters that say ‘To Whom It May Concern, I want a job’?”</em></li><li>Collect 2-3 student thoughts: A cover letter tells your personal story and connects your exact skills to the specific job duties!</li><li>Bridge with, <em>“A tailored cover letter bridges the gap between your resume facts and the employer's specific organizational needs under TEKS d(7)(B). Today we draft a professional 3-paragraph letter for Jordan Rivera applying to Pecan Creek Animal Care, audit every claim, and execute a visible revision.”</em></li></ul>''')
            + flow("#4c8b38", "Minutes 5-13 - 3-paragraph letter architecture &amp; truth-in-evidence modeling", '''<p>Deconstruct the Standard 3-Paragraph Cover Letter Structure on the screen:</p><ul><li>1. <strong>Paragraph 1 (Opening &amp; Intent):</strong> State the exact position applied for (Student Office Assistant), where the lead was found, and an enthusiastic thesis statement matching company mission.</li><li>2. <strong>Paragraph 2 (Body &amp; Evidence Match):</strong> Pair 2 specific job requirements with 2 verified evidence points from Jordan's background (e.g., requirement: data entry &rarr; evidence: accurately managed 120 inventory records in school club; requirement: customer service &rarr; evidence: greeted over 80 parents during school orientation). Honestly acknowledge 1 learning curve (e.g., eager to master clinic scheduling software).</li><li>3. <strong>Paragraph 3 (Closing &amp; Call to Action):</strong> Reiterate enthusiasm, reference attached resume, request an interview opportunity, provide professional contact routing, and close with courteous sign-off (<em>“Sincerely,”</em>).</li><li>The Golden Rule of Cover Letters: Zero invented claims! Never fabricate past job titles, exaggerated years of experience, or fake certifications.</li></ul>''')
            + flow("#155d7a", "Minutes 13-32 - Cover letter drafting sprint (3-page lab)", '''<p>Students author Jordan's tailored cover letter on their 3-page packet (or Canvas):</p><ul><li>Part 1: Map 2 Pecan Creek needs to 2 verified Jordan Rivera achievements.</li><li>Part 2: Draft 3 structured paragraphs adhering strictly to business letter formatting.</li><li>Part 3: Audit all factual assertions—highlight verified evidence; cross out any puffery or unprovable adjectives.</li><li><strong>Active Monitoring Checkpoints:</strong><br>• Lap 1 (Minute 20): Check that Paragraph 1 specifies the exact job title and company name.<br>• Lap 2 (Minute 27): Verify that Paragraph 2 cites concrete numbers and specific past tasks.</li></ul>''')
            + flow("#d39b22", "Minutes 32-45 - Claim audit, visible revision &amp; rubric alignment", '''<p>Students conduct an evidence audit and execute a visible before-and-after edit:</p><ul><li>Self-Audit: Verify that no real student personal data is entered (use <code>Jordan Rivera</code>, <code>555-0199</code>, <code>jordan@example.com</code>).</li><li>Execute One Visible Revision: Replace a generic phrase (e.g., <em>“I am good with animals”</em>) with an active, evidence-based statement (<em>“Volunteered 15 hours assisting veterinary staff with clean crate setups”</em>).</li></ul>''')
            + flow(color, "Minutes 45-50 - Submit Day 2 Cover Letter and wrap-up", '''<p>Students submit their completed 3-page lab in Canvas or file paper packets.</p><ul><li><strong>Safe Trim:</strong> Provide pre-formatted paragraph frame templates; fiercely protect 3-paragraph structure, 2 evidence links, claim audit, visible revision, and private submission.</li></ul>''')
        ), "MONITOR": "<p><strong>Model links:</strong> accurate data entry → checked 120 entries; organization/communication → revised labels after confusion, greeted families under supervision, or asked clarifying questions. Full evidence names the role, uses two supplied links, invents no credential/work history/result, and closes courteously. Trim peer exchange first.</p>", "RESOURCES": source_block[2], "SUPPORT": common_support, "FALLBACK": common_fallback},
        3: {"TITLE": "Sample Application and References", "SUBTITLE": "50 minutes · Four-page simulation", "ALERT": "<strong>Privacy boundary:</strong> use supplied facts or N/A only. Never collect or display real identity, availability, signature, health, family, immigration, or reference data, and never ask students to provide it.", "PREP": f'<ul><li>Post {link(files["APP"]["id"], "the four-page packet")} and private annotation route.</li><li>Keep Jordan Rivera and Pecan Creek visible from start to finish.</li><li>Prepare three field-sort examples: supplied fact, N/A, and excluded/private.</li></ul>', "EVIDENCE": "<p>Collect complete/N/A fields, consistent experience and skills, reference roles tied to firsthand evidence, an unsent permission request, and privacy audit.</p>", "FLOW": (
            flow(color, "Minutes 0-5 - Welcome and job application legalities warm-up", '''<p>Welcome students, seat them with devices or the 4-page application simulation, and project the application legalities prompt.</p><ul><li>Ask students: <em>“Why is a job application considered a binding legal document rather than a casual questionnaire? What happens if an applicant enters false employment dates or invents a past job title on an official application form?”</em></li><li>Collect 2-3 student thoughts: You can be disqualified immediately or fired later for falsifying an application!</li><li>Bridge with, <em>“Job applications demand precision, absolute honesty, and strict privacy protection under TEKS d(7)(C) and d(7)(D). Today we complete a standardized employment application for Jordan Rivera, establish legal privacy boundaries, and master professional reference protocols.”</em></li></ul>''')
            + flow("#4c8b38", "Minutes 5-12 - Application anatomy, N/A protocols &amp; EEOC boundaries", '''<p>Display Application Guidelines and EEOC Pre-Employment Inquiries on the screen:</p><ul><li>1. <strong>Completing Applicable Fields:</strong> Every field must be completed. If a question does not apply (e.g., Military Service, Prior Felonies), write <em>“N/A”</em> (Not Applicable)—never leave blank lines that suggest oversight!</li><li>2. <strong>Consistency Invariant:</strong> Dates, titles, and duties must match the resume and cover letter exactly.</li><li>3. <strong>EEOC Legal Boundaries &amp; Red Flags:</strong> Under Federal Equal Employment Opportunity Commission (EEOC) laws, employers CANNOT require: age/birthdate, race/ethnicity, religion, marital status, child plans, medical history, disability disclosures, or Social Security numbers on an initial screening form!</li><li>4. <strong>Professional Reference Protocols (TEKS d(7)(D)):</strong><br>• <strong>Who Qualifies:</strong> Supervisors, teachers, coaches, and club sponsors who observed your work firsthand.<br>• <strong>Who Does NOT Qualify:</strong> Best friends, family members, or peers.<br>• <strong>The Permission Protocol:</strong> Always ask permission BEFORE listing anyone as a reference! Verify their preferred contact phone and email, and brief them on the job description.</li></ul>''')
            + flow("#155d7a", "Minutes 12-32 - 4-page job application simulation sprint", '''<p>Students complete Jordan Rivera's 4-page application packet:</p><ul><li>Chunk 1 (Minutes 12-22): Complete Personal Info (<code>jordan@example.com</code>), Position Target, Education History, and Work/Volunteer Experience using verified facts or N/A.</li><li>Chunk 2 (Minutes 22-32): Select 2 qualified reference roles for Jordan (e.g., Middle School Science Teacher, Volunteer Coordinator at Animal Shelter); draft a formal, polite reference permission inquiry email.</li><li><strong>Active Monitoring Checkpoints:</strong><br>• Lap 1 (Minute 18): Verify students enter 'N/A' for inapplicable fields rather than leaving blanks.<br>• Lap 2 (Minute 27): Check that reference choices cite specific professional observation roles, not family relatives.</li></ul>''')
            + flow("#d39b22", "Minutes 32-45 - Application quality audit &amp; permission draft screening", '''<p>Elbow partners audit each other's application packets:</p><ul><li>Partner checks: 'Are all dates consistent? Does the reference permission draft explain the specific job requirements?'</li><li>Students refine the permission email draft to ensure courteous, professional tone.</li></ul>''')
            + flow(color, "Minutes 45-50 - Submit Day 3 Application and wrap-up", '''<p>Students submit their completed 4-page application simulation in Canvas or file paper packets.</p><ul><li><strong>Safe Trim:</strong> Provide prefilled education section; fiercely protect application completeness, N/A protocol, reference role justification, permission draft, and private submission.</li></ul>''')
        ), "MONITOR": "<p><strong>Key:</strong> use Jordan's supplied facts; use N/A only when allowed; never fill a blank by inventing. Strong reference choices can speak from firsthand observation. Permission precedes sharing, even when the person is a teacher. Trim optional comparison first.</p>", "RESOURCES": source_block[3], "SUPPORT": common_support, "FALLBACK": common_fallback},
        4: {"TITLE": "Interview Preparation", "SUBTITLE": "50 minutes · Planner plus retryable Quiz", "ALERT": "<strong>Context first:</strong> workplace, task, safety, format, technology, and accommodation determine preparation. Do not teach one expensive, gendered, body-based, cultural, eye-contact, handshake, or camera rule.", "PREP": f'<ul><li>Post {link(files["READY"]["id"], "the three-page planner")}, the private planner route, and <a href="{quiz_url}">{QUIZ_TITLE}</a>.</li><li>Ask students to open one <strong>CCE Six-Weeks Evidence Log</strong> entry as a source. Do not collect the log or old artifacts again; use the complete Jordan bank when the log is missing or not appropriate.</li><li>Project this complete response model: <em>Situation/task: our design team had two versions of the event flyer. Action: I compared the audience and deadline, asked which information had to be noticed first, and revised the larger heading. Result/reflection: the viewer found the date faster; next time I would run the test before choosing colors.</em> Nonexample: <em>I am creative and helped my group.</em></li><li>Project the accessible opening and close: <em>Hello. I’m Jordan. I’m here to discuss the office assistant role. Thank you for meeting with me.</em> / <em>Thank you for your time. What is the next step in your process?</em> Model the same words through speech, AAC, text-to-speech, an interpreter, or private conference.</li><li>Preassign paired, small-group, teacher-conference, private-recording, and AAC routes. No student writes private accommodation details or performs publicly.</li></ul>', "EVIDENCE": "<p>Collect three context decisions, three truthful response plans, one growth action, an accessible opening and close, interviewer follow-up and neutral note, route confirmation, and review of all five Quiz explanations. The Evidence Log stays with the student.</p>", "FLOW": (
            flow(color, "Minutes 0-5 - Welcome and behavioral interview questions warm-up", '''<p>Welcome students, seat them with devices or the 3-page interview planner, and project the behavioral interview prompt.</p><ul><li>Ask students: <em>“When an interviewer asks, ‘Tell me about a time you had a disagreement with a team member and how you resolved it,’ why is giving a vague answer like ‘I'm really nice and get along with everyone’ ineffective? How does the STAR method provide concrete proof of your problem-solving abilities?”</em></li><li>Collect 2-3 student thoughts: Vague answers sound made up; sharing a specific real story proves what you actually did!</li><li>Bridge with, <em>“Behavioral interviews evaluate past behavior as the best predictor of future performance under TEKS d(6)(B). Today we master the STAR method, plan 3 structured interview responses using our CCE Evidence Log or Jordan's bank, and complete our rehearsal check.”</em></li></ul>''')
            + flow("#4c8b38", "Minutes 5-13 - The STAR framework, accessible greetings &amp; interview attire", '''<p>Display the STAR Framework and Accessible Interview Standards on the screen:</p><ul><li>1. <strong>The STAR Method Architecture:</strong><br>• <strong>Situation:</strong> Set the scene with specific context (1-2 sentences).<br>• <strong>Task:</strong> Describe the challenge or goal you needed to accomplish.<br>• <strong>Action:</strong> Detail the specific actions YOU took to solve the problem (use action verbs!).<br>• <strong>Result / Reflection:</strong> Explain the positive outcome and what you learned.</li><li>2. <strong>Accessible Professional Greetings &amp; Closings:</strong><br>• Opening: <em>“Hello, my name is Jordan Rivera. Thank you for taking the time to meet with me today.”</em><br>• Closing: <em>“Thank you for your time. Could you share what the next steps are in your hiring process?”</em><br>• Accessible through speech, AAC speech-generating device, interpreter, or private conference.</li><li>3. <strong>Context-Driven Appearance Review (TEKS d(6)(B)):</strong> Context determines clothing (business casual for veterinary office; clean workwear for animal handling).</li></ul>''')
            + flow("#155d7a", "Minutes 13-33 - STAR response planning &amp; rehearsal sprint", '''<p>Students plan 3 structured interview answers on their 3-page planner:</p><ul><li>Question 1 (Teamwork / Conflict): Handling differing opinions on a project.</li><li>Question 2 (Task Management / Pressure): Managing competing deadlines or heavy workloads.</li><li>Question 3 (Customer Service / Communication): Assisting a confused or frustrated client.</li><li>Students utilize experiences from their CCE Six-Weeks Evidence Log (or Jordan Rivera case facts).</li><li><strong>Active Monitoring Checkpoints:</strong><br>• Lap 1 (Minute 21): Ensure students articulate a specific Action rather than general personality traits.<br>• Lap 2 (Minute 28): Confirm students draft an accessible greeting and thoughtful closing inquiry.</li></ul>''')
            + flow("#d39b22", "Minutes 33-45 - Practice Quiz &amp; partner whisper run", '''<p>Students execute a quick rehearsal and complete the practice check:</p><ul><li>Whisper Run: Practice speaking Question 1 aloud to self or partner in 45-60 seconds.</li><li>Complete the 5-question retryable Canvas Quiz on interview etiquette, EEOC protections, and STAR response components.</li></ul>''')
            + flow(color, "Minutes 45-50 - Submit Day 4 Planner and wrap-up", '''<p>Students submit their completed 3-page planner in Canvas and confirm Day 5 mock interview roles.</p><ul><li><strong>Safe Trim:</strong> Limit rehearsal to Question 1; fiercely protect the 3 STAR plans, accessible greeting/closing, Quiz review, and private submission.</li></ul>''')
        ), "MONITOR": "<p><strong>Minute 13:</strong> context choices match the actual workplace, task, safety, format, technology, or access need. <strong>Minute 25:</strong> each student has one complete evidence arc with a specific action; if one-third use only traits, label the model's Situation/Task, Action, and Result/Reflection. <strong>Minute 39:</strong> three response notes are truthful and brief enough to speak rather than read, and the opening/close works through the assigned communication route. <strong>Minute 47:</strong> route, technology/communication check, and interviewer follow-up are ready. Trim optional partner rehearsal first; protect the evidence arc, accessible opening/close, assigned route, and private support check.</p>", "RESOURCES": source_block[4], "SUPPORT": common_support, "FALLBACK": common_fallback},
        5: {"TITLE": "Mock Interview and Follow-Up", "SUBTITLE": "50 minutes · Major 1", "ALERT": "<strong>One new submission:</strong> Days 1-3 and the CCE Evidence Log stay in their original locations. Day 5 requires the written record plus recorded media or a named teacher oral/AAC checkoff.", "PREP": f'<ul><li>Post {link(files["MOCK"]["id"], "the four-page Day 5 record")}, {link(files["RUBRIC"]["id"], "the two-page evidence profile")}, the private mapped Major Assignment, and a roster titled <strong>Day 5 Interview Evidence Checkoff</strong>.</li><li>Checkoff fields: <strong>student, date, route, accessible opening/close complete, interviewee evidence complete, interviewer follow-up/neutral notes complete, feedback applied in Round 2, oral/AAC complete, written record complete, and follow-up date when needed</strong>.</li><li>Students may keep one Evidence Log entry open as a prompt; it is not collected or uploaded. Jordan is the complete fallback.</li><li>Confirm every route and feedback method before class. For pairs: A interviews B for 3 minutes, switch for 3 minutes, and use 4 minutes for neutral notes. Repeat one improved response each in Round 2. Speech, AAC, text-to-speech, an interpreter, and private conference are equal opening/close routes.</li></ul>', "EVIDENCE": "<p>Collect the written Day 5 record and either private recorded media or the named teacher checkoff for an accessible opening/close, interviewee/interviewer evidence, specific feedback, applied revision, context preparation, fictional thank-you note, and six-criterion self-score. Score Days 1-3 from their original locations; do not collect the Evidence Log.</p>", "FLOW": (
            flow(color, "Minutes 0-5 - Welcome and Major 1 mock interview readiness gate", '''<p>Welcome students, execute the Major 1 readiness gate, and project the mock interview protocol.</p><ul><li><strong>Readiness Gate (Minutes 0-4):</strong> Confirm student pairings, private conference schedule, recording stations, and AAC setups. Review the 6-criterion rubric (24 raw points / 100% Major 1 grade).</li><li>Ask students: <em>“In a mock interview, why is the interviewer's role just as important as the interviewee's? How does taking neutral, objective interview notes ensure fair hiring evaluations?”</em></li><li>Collect 2-3 student thoughts: Interviewers have to listen actively, ask good follow-ups, and avoid bias!</li><li>Bridge with, <em>“Today is Major 1: Mock Interview and Follow-Up under TEKS d(6)(C) and d(7)(B)! Every student will serve as both professional interviewer and interviewee, apply feedback in Round 2, and author an executive thank-you note.”</em></li></ul>''')
            + flow("#4c8b38", "Minutes 5-30 - Mock interview simulation: Rounds 1 &amp; 2", '''<p>Manage the paired interview rounds and teacher conference queue:</p><ul><li><strong>Round 1 (Minutes 5-15):</strong><br>• Partner A interviews Partner B (3 mins): Greeting &rarr; 2 STAR questions &rarr; Closing inquiry.<br>• Partner B interviews Partner A (3 mins): Greeting &rarr; 2 STAR questions &rarr; Closing inquiry.<br>• Log 4 minutes of Neutral Feedback Notes: Document 1 specific strength and 1 actionable revision point.</li><li><strong>Round 2 (Minutes 15-25):</strong> Repeat one revised question each; directly apply the peer or teacher feedback!</li><li>Teacher Conference Queue: Simultaneously conduct individual checkoffs for private conference and AAC students at the desk.</li><li><strong>Active Monitoring Checkpoints:</strong><br>• Lap 1 (Minute 10): Ensure students deliver structured STAR responses and maintain professional demeanor.<br>• Lap 2 (Minute 20): Check that Round 2 shows visible improvement in pacing or evidence detail.</li></ul>''')
            + flow("#155d7a", "Minutes 30-40 - Executive thank-you note authoring sprint", '''<p>Students author a tailored post-interview thank-you letter to Pecan Creek Animal Care:</p><ul><li>Header &amp; Salutation: Addressed to hiring manager Dr. Aris Thorne.</li><li>Opening: Express sincere appreciation for the interview conversation.</li><li>Specific Recall Point: Mention one specific topic discussed during the interview (e.g., digital record migration).</li><li>Reiteration of Value &amp; Professional Closing: Reaffirm enthusiasm and provide contact availability.</li></ul>''')
            + flow("#d39b22", "Minutes 40-47 - Rubric self-score &amp; visible evidence repair", '''<p>Students evaluate their performance on the 6-criterion Major 1 rubric (24 raw points):</p><ul><li>Self-Score across: 1. Job Search &amp; Screening, 2. Tailored Cover Letter, 3. Sample Application, 4. Professional References, 5. Mock Interview Evidence, 6. Thank-You Correspondence.</li><li>Execute One Visible Revision: Elevate wording in their thank-you note or interview response record.</li></ul>''')
            + flow(color, "Minutes 47-50 - Submit Major 1 Package and wrap-up", '''<p>Students submit their completed 4-page Day 5 record in Canvas; teacher finalizes checkoff roster.</p><ul><li>Congratulate students on demonstrating workplace professionalism and completing Major 1!</li><li><strong>Safe Trim:</strong> Shorten Round 2 to one question; fiercely protect Round 1 interview evidence, thank-you note, rubric self-score, and private submission.</li></ul>''')
        ), "MONITOR": "<p><strong>Minute 5:</strong> every student has a prepared example, accessible opening/close, assigned route, feedback method, and checkoff or recording plan; use Jordan immediately when a log or partner is unavailable. <strong>Minute 15:</strong> the opening/close and both pair roles or the equivalent conference/recording/AAC jobs are documented. <strong>Minute 31:</strong> one specific feedback move is visible in Round 2. <strong>Minute 43:</strong> the fictional thank-you note is accurate, specific, and unsent. <strong>Minute 48:</strong> all six criteria are self-scored and both parts are routed: recorded students upload written record + media together; live/conference/AAC students submit writing while the teacher completes the named checkoff. Text or media alone is incomplete. Trim an extra exchange, not the accessible opening/close, revision, thank-you, self-score, or two-part collection.</p>", "RESOURCES": source_block[5], "SUPPORT": common_support, "FALLBACK": common_fallback},
    }
...
async def main():
    ...
    async with httpx.AsyncClient(headers={"Authorization": f"Bearer {token}"}, timeout=120) as client:
        ...
        for day in range(1, 6):
            ...
            student_page = await common.upsert_page(client, student_title, common.render("6sw-wk5-student.html", {"COURSE_ID": COURSE_ID, "DAY": day, "MEDIA": "", **CONTRACTS[day], **students[day]}))
