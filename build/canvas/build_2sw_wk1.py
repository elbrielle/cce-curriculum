...
async def main():
    ...
    async with httpx.AsyncClient(headers={"Authorization":f"Bearer {token}"},timeout=120) as c:
        ...
        teacher_data={
          ...
          5:{"TITLE":"Position Revision and Xello Life Experiences","SUBTITLE":"50 minutes · TEKS d(1)(C), d(3)(H)","ALERT":"<strong>Original coordinator-scope exception:</strong> protect 10 minutes for Xello Life experiences and verify at least one saved entry privately. This is not a live Grade 7 Completion Standards task. H&amp;L is supplemental.","PREP":f'<ul><li>Open the licensed <a href="/courses/{COURSE_ID}/files/{files["XELLO"]["id"]}/preview">My Experiences teacher plan</a> as background.</li><li>Print/post the <a href="/courses/{COURSE_ID}/files/{files["CONNECTION"]["id"]}/preview">Life Experience Connection</a> and <a href="/courses/{COURSE_ID}/files/{files["RUBRIC"]["id"]}/preview">position-paper rubric</a>.</li><li>Plan a private saved-entry check without collecting profile screenshots.</li></ul>',"EVIDENCE":f'<p><strong>One major grade:</strong> final position plus Entrepreneur Card, 16 points. The original-scope Xello save is a separate formative checkpoint; login success is not part of the major.</p>',"FLOW":flow("#5a2d91","Career-fit warm-up · 5 minutes","Interested, unsure, or not interested—with one job-detail reason.")+flow("#4a9d2f","Revise and submit · 10 minutes","Use rubric: position, two details, career connection, completed card.")+flow("#1f617a","Xello Life experiences · 10 minutes","About Me > Experiences; add and save at least one authentic life experience.")+flow("#e3ad19","Experience-to-career connection · 15 minutes","Name what the experience shows and connect it to a specific task.")+flow("#1f617a","Private check and catch-up · 7 minutes","Verify saves privately; paper route for access issues.")+flow("#5a2d91","Close · 3 minutes","Name one next question about a legal career or route."),"MONITOR":"<p>Original-scope minimum: at least one saved life experience. Students control which non-private experience they share. A valid connection names what the student did or learned and a specific career task. A well-supported “not a fit” remains valid.</p>","SUPPORT":"<p>Offer examples by category—home responsibility, team, hobby, school project, club, volunteering—without requiring sensitive disclosure. Students may rehearse orally, use the printed English/Spanish labels, or use speech-to-text.</p>","FALLBACK":"<p>If Xello fails, record the access issue and collect the paper connection. The original-scope save moves to the next catch-up block. H&amp;L may be omitted with no loss of core evidence.</p>"}}
        contracts={
