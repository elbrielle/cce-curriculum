...
STUDENT_WORKSHEET_COPY_URLS = {
    (1, 'the three-page paper route'): "https://docs.google.com/document/d/1WyLqBY3hX5UX6fuMWBNH4eKEvezIbGs8kgvy6JAv0pQ/copy",
    (2, 'the four-page paper or enlarged route'): "https://docs.google.com/document/d/15h32N9itO7hoBHQi4tY_a3WA2ORZ1A52MVfrJM5k-V8/copy",
    (3, 'the four-page concept route'): "https://docs.google.com/document/d/1nIpFmoSQ-7Dp0PzRstXGSl224qcBXa6HKZQz_KBKz10/copy",
    (4, 'the three-page revision record'): "https://docs.google.com/document/d/1TEjPakUM-BNYG1777-VvHFXA6x1Db-JlIUL78f_5uA8/copy",
    (5, 'the two-page individual fallback'): "https://docs.google.com/document/d/1op2c7H4YULQ6reBoQu69AjgMKOVsBcvfFtN7-pJcDfc/copy",
}
    ...
    async with httpx.AsyncClient(headers={"Authorization": f"Bearer {token}"}, timeout=120) as client:
        ...
        student = {
            ...
            5: {
                ...
                "STEPS": step(1, "Read the city goals", "<p>Choose two goals from the brief. A memorable shape must still serve users.</p>")
        ...
        teacher = {
            1: {
                ...
                "FLOW": (
                    flow("#5a2d91", "Minutes 0-5 - Welcome and construction site safety warm-up", '''<p>Welcome students to Week 1 of 5SW (Architecture &amp; Construction) and project the job site prompt.</p><ul><li>Ask students: <em>“When you look at a multi-story building being constructed in Irving or Dallas, who is ultimately responsible for making sure the building doesn't collapse, the workers don't fall, and the finished spaces are safe for humans: the architect, the engineer, the construction manager, or the safety inspector?”</em></li><li>Collect 2-3 student thoughts: They all work together as an interconnected system!</li><li>Bridge with, <em>“Every building begins as a design and survives through safety standards. Today we explore the Architecture &amp; Construction cluster on FYF pp. 171-173, investigate MacArthur High School's School of ACE, and draft a Safety Supervisor Evidence Plan.”</em></li></ul>''')
                    + flow("#4a9d2f", "Minutes 5-15 - Cluster roles, Irving ACE pathway &amp; safety plan modeling", '''<p>Direct students to the cluster overview and model the Safety Supervisor task on the main display:</p><ul><li>Deconstruct the 4 Core Cluster Pathways:<br>1. <strong>Design &amp; Pre-Construction:</strong> Architects, civil engineers, drafters/CAD operators creating blueprints and 3D BIM models.<br>2. <strong>Construction Management:</strong> Project managers, estimators, superintendents scheduling trades and managing budgets.<br>3. <strong>Skilled Trades / Maintenance:</strong> Electricians, carpenters, plumbers, HVAC technicians, welders.<br>4. <strong>Safety &amp; Compliance:</strong> Environmental safety officers and OSHA site inspectors.</li><li>Highlight MacArthur High School's School of Architecture, Construction, and Civil Engineering (ACE).</li><li>Model the 4-Part Safety Matrix: (1) Physical Site Hazard (e.g., open elevator shaft at height), (2) Required Protective Equipment / Control (guardrails &amp; safety harness), (3) Clear Behavioral Protocol (100% tie-off requirement), (4) Verification Record (daily safety log signature).</li></ul>''')
                    + flow("#1f617a", "Minutes 15-35 - Safety Supervisor evidence planning sprint (Packet pp. 1-2)", '''<p>Students analyze the job site scenario on FYF pp. 172-173 (or companion packet):</p><ul><li>Identify 4 Distinct Construction Hazards: Categorize by falls, electrical, falling objects, and hazardous dust/fumes.</li><li>Specify Mandatory PPE and OSHA-Compliant Engineering Controls for each hazard.</li><li>Draft an Emergency Evacuation &amp; First Response Protocol for the job site.</li><li><strong>Active Monitoring Checkpoints:</strong><br>• Lap 1 (Minute 22): Ensure students describe specific physical hazards rather than vague labels like 'danger.'<br>• Lap 2 (Minute 30): Confirm students pair every hazard with an actionable physical control and a verification log.</li></ul>''')
                    + flow("#e3ad19", "Minutes 35-43 - Peer protocol audit &amp; career role connection", '''<p>Students swap safety plans with an elbow partner for a 3-minute peer safety audit:</p><ul><li>Checker verifies: Could a new worker understand and follow these four rules without confusion?</li><li>Students record which cluster career they would personally investigate (Architect, Drafter, Construction Manager, Safety Officer) and cite one daily task reason.</li></ul>''')
                    + flow("#1f617a", "Minutes 43-50 - Exit check and Week 1 evidence folder storage", '''<p>Students submit their private Canvas practice response and store their safety plan in their Week 1 folder.</p><ul><li><strong>Safe Trim:</strong> Shorten peer audit; fiercely protect the 4 hazard-control pairs, emergency protocol, career connection, and folder retention.</li></ul>''')
                ),
            ...
            2: {
                ...
                "FLOW": (
                    flow("#5a2d91", "Minutes 0-5 - Welcome and architecture career evidence warm-up", '''<p>Welcome students, seat them with devices or the 3-page reference guide, and project the career salary prompt.</p><ul><li>Ask students: <em>“If a website claims 'Architects make $150,000 right after graduation with no license needed,' how can we use official May 2024 Bureau of Labor Statistics (BLS) data to verify or disprove that claim?”</em></li><li>Collect 2-3 student thoughts: Starting pay is lower than median pay, and architecture requires a professional degree, thousands of hours of documented internship experience (AXP), and passing the national ARE licensing exam.</li><li>Bridge with, <em>“Today is Minor 1: Three-Career Architecture Comparison! We will audit three distinct architecture careers using May 2024 BLS national medians and author an evidence-based recommendation.”</em></li></ul>''')
                    + flow("#4a9d2f", "Minutes 5-15 - Sourced labor data &amp; deconstructing Minor 1 rubric", '''<p>Guide students through the official BLS occupational profiles on the main display:</p><ul><li>1. <strong>Architect (except Landscape and Naval):</strong> May 2024 U.S. median pay: $93,310; 8% projected growth (about 8,200 annual openings). Typical entry: 5-year B.Arch professional degree, internship hours, and passing the Architect Registration Examination (ARE).</li><li>2. <strong>Architectural and Civil Drafter / CAD Tech:</strong> May 2024 U.S. median pay: $62,530; 2% projected growth (about 15,200 annual openings). Typical entry: Associate degree or technical certificate in computer-aided drafting (CAD) and BIM modeling.</li><li>3. <strong>Construction Manager:</strong> May 2024 U.S. median pay: $104,900; 8% projected growth (about 38,700 annual openings). Typical entry: Bachelor's degree in construction science or civil engineering + extensive job site experience.</li><li>Deconstruct the 16-Point Minor 1 Rubric: (1) Sourced labor data with exact labels, (2) Detailed education and credentialing comparison, (3) Balanced trade-offs, (4) Fictional Jordan recommendation with a counselor verification question.</li></ul>''')
                    + flow("#1f617a", "Minutes 15-37 - Independent Three-Career Comparison sprint", '''<p>Students complete their comparison in Canvas (or 3-page landscape packet):</p><ul><li>Section 1: Record May 2024 U.S. median wages, projected growth, and annual openings with full source attribution.</li><li>Section 2: Compare daily work duties and educational/licensing pathways across all three careers.</li><li>Section 3: Author the Fictional Jordan Recommendation: Jordan loves digital 3D modeling, wants to start working after a 2-year college program, and wants the option to earn a 4-year degree later. Which career fits Jordan best? Defend citing 1 pay fact and 1 credential trade-off.</li><li>Section 4: Formulate ONE question about MacArthur High School's School of ACE architecture courses.</li><li><strong>Active Monitoring Checkpoints:</strong><br>• Lap 1 (Minute 22): Verify students include complete statistical labels: 'May 2024 U.S. Median Wage' (not local starting pay).<br>• Lap 2 (Minute 31): Confirm students explain the difference between a 2-year drafter credential and professional architect licensure.</li></ul>''')
                    + flow("#e3ad19", "Minutes 37-45 - Rubric self-score and targeted revision", '''<p>Students self-evaluate their comparison against the 16-point rubric:</p><ul><li>Self-score each section and execute a 2-minute revision to elevate the evidence in their lowest-scoring section.</li><li>Teacher provides targeted writing support to students with accommodations.</li></ul>''')
                    + flow("#1f617a", "Minutes 45-50 - Submit Minor 1 in Canvas", '''<p>Students submit their completed Three-Career Comparison in Canvas or hand in paper packets.</p><ul><li>Congratulate students on completing Minor 1!</li><li><strong>Safe Trim:</strong> Skip whole-class sharing; fiercely protect all three career rows, Jordan defense, rubric self-audit, and private submission.</li></ul>''')
                ),
            ...
            3: {
                ...
                "FLOW": (
                    flow("#5a2d91", "Minutes 0-5 - Welcome and architectural user need warm-up", '''<p>Welcome students, seat them with drawing materials or devices, and project the design brief prompt.</p><ul><li>Ask students: <em>“When an architect designs a public community learning center or youth makerspace, what features must be included to make it truly welcoming, accessible, and functional for people of all ages and abilities?”</em></li><li>Collect 2-3 student thoughts: Natural lighting, wide ADA ramps, flexible seating, sound dampening, power outlet accessibility, emergency exits.</li><li>Bridge with, <em>“Architecture blends aesthetics, human needs, and spatial math. Today we begin our multi-day design project by creating a Two-View Concept Design for a modern Community Learning Space.”</em></li></ul>''')
                    + flow("#4a9d2f", "Minutes 5-15 - Architectural drawing conventions &amp; two-view modeling", '''<p>Explain standard architectural drafting views on the main display:</p><ul><li>1. <strong>Top-Down Floor Plan (Bird's-Eye View):</strong> Shows wall layout, room dimensions, door swings, window placements, and spatial circulation paths.</li><li>2. <strong>Front Exterior Elevation (Eye-Level View):</strong> Shows vertical height, rooflines, main entrance, facade materials, and natural daylight windows.</li><li>Review the 4 Mandatory Design Constraints:<br>• Dedicated quiet study and collaborative project zones.<br>• Minimum of two ADA-compliant accessible entrances with double doors and ramp access.<br>• Designated storage/mechanical area and emergency egress paths.<br>• Clear spatial dimensions or grid scale (e.g., 1 grid square = 5 feet).</li><li>Explain Equal Design Modes: Hand-drawn on grid paper with ruler, digital Canvas annotation, or teacher-managed Tinkercad Classroom (if approved/enabled).</li></ul>''')
                    + flow("#1f617a", "Minutes 15-38 - Architectural concept sketching sprint (Two Views)", '''<p>Students draft their Community Learning Space concept:</p><ul><li>View 1 (Floor Plan, Min 15-28): Draft room layout with labeled zones, doors, windows, and dimensions.</li><li>View 2 (Front Elevation, Min 28-38): Draft front facade showing height scale, roof geometry, and entryway.</li><li><strong>Active Monitoring Checkpoints:</strong><br>• Lap 1 (Minute 23): Verify floor plans include clear scale and room labels, not just random boxes.<br>• Lap 2 (Minute 33): Confirm students draft the second elevation view showing vertical scale and exterior materials.</li></ul>''')
                    + flow("#e3ad19", "Minutes 38-45 - First design checkpoint &amp; user need justification", '''<p>Students record a 3-sentence architectural brief explaining how their design satisfies three specific user needs (e.g., accessibility, natural light, quiet collaboration).</p>''')
                    + flow("#1f617a", "Minutes 45-50 - Design storage and station reset", '''<p>Students save their digital files or place paper floor plans into their team portfolio folder.</p><ul><li><strong>Safe Trim:</strong> Protect both views and user need justifications; omit colored rendering if time is short.</li></ul>''')
                ),
            ...
            4: {
                ...
                "FLOW": (
                    flow("#5a2d91", "Minutes 0-5 - Welcome and structural constraint warm-up", '''<p>Welcome students, seat them with their Day 3 concept designs, and project the building inspection prompt.</p><ul><li>Ask students: <em>“What happens to a gorgeous architectural drawing when the structural engineer, fire marshal, and building inspector review it? Do they just stamp 'approved,' or do they find code violations and safety conflicts that require redesign?”</em></li><li>Collect 2-3 student thoughts: Fire exits are too narrow, load-bearing columns are missing, staircases block wheelchair access, plumbing walls are misaligned.</li><li>Bridge with, <em>“Great architecture is iterative. Today we test our Day 3 building concepts against three realistic building codes, execute documented revisions, and connect our work to career roles.”</em></li></ul>''')
                    + flow("#4a9d2f", "Minutes 5-12 - Three building code stress-tests &amp; revision log modeling", '''<p>Display the Three Inspection Standards on the screen:</p><ul><li>Test 1 (Universal Accessibility - ADA): Are all corridors at least 4 feet wide? Are restrooms and main entrances fully wheelchair accessible with zero barrier steps?</li><li>Test 2 (Fire &amp; Life Safety Code): Does the building feature at least two separated outward-swinging emergency exit doors within 75 feet of all points?</li><li>Test 3 (Structural &amp; Environmental Efficiency): Does the roof design support local snow/rain drainage? Are large windows positioned to maximize daylight without excessive solar heat gain?</li><li>Model the Revision Log: (1) Identified Code Violation / Bottleneck, (2) Root Architectural Cause, (3) Concrete Design Modification, (4) Verification on Updated Floor Plan.</li></ul>''')
                    + flow("#1f617a", "Minutes 12-35 - Concept testing, modification &amp; revision logging sprint", '''<p>Students audit their Day 3 designs and execute required modifications:</p><ul><li>Execute Inspection Audit: Test their design against ADA, Fire Safety, and Structural criteria.</li><li>Redraw / Modify Blueprint: Add missing emergency exit, widen narrow doorways, or reposition partitions directly on their drawing.</li><li>Document Changes in Revision Log: Record 2 major design modifications with engineering justifications.</li><li>Draft Career Connection: Explain how an Architect, Civil Engineer, and Interior Designer would each interact with this revised plan.</li><li><strong>Active Monitoring Checkpoints:</strong><br>• Lap 1 (Minute 20): Check that students identify an authentic flaw or bottleneck, not just say 'everything passed.'<br>• Lap 2 (Minute 30): Verify students draw the physical revision directly on the floor plan with revision callout tags.</li></ul>''')
                    + flow("#e3ad19", "Minutes 35-43 - Partner code review &amp; peer verification", '''<p>Elbow partners conduct a 3-minute Building Code Sign-Off:</p><ul><li>Partner verifies that the revision log accurately matches the drawn changes on the updated floor plan.</li></ul>''')
                    + flow("#1f617a", "Minutes 43-50 - Submit Formative Revision Portfolio in Canvas", '''<p>Students submit their revised design and revision log in Canvas or file paper packets in their portfolio folder.</p><ul><li><strong>Safe Trim:</strong> Shorten partner sign-off; fiercely protect the 3 code stress-tests, documented revision log, blueprint update, and private submission.</li></ul>''')
                ),
            ...
            5: {
                ...
                "FLOW": (
                    flow("#5a2d91", "Minutes 0-5 - Welcome and extreme architecture warm-up", '''<p>Welcome students, distribute the Unexpected Architecture materials, and project the extreme design prompt.</p><ul><li>Ask students: <em>“If an architecture firm is hired to design an underwater research habitat in the Gulf of Mexico, or a scientific research outpost in Antarctica, how do the laws of physics and environmental forces completely transform architectural design?”</em></li><li>Collect 2-3 student thoughts: Hydrostatic water pressure, freezing thermal insulation, self-contained oxygen and water recycling, corrosion resistance.</li><li>Bridge with, <em>“Architecture shapes how humans survive and thrive in extreme environments. Today we explore FYF pp. 182-184 and the licensed Climber City goals, present a 1-minute paired concept pitch, and synthesize our 5SW Week 1 Architecture Portfolio!”</em></li></ul>''')
                    + flow("#4a9d2f", "Minutes 5-15 - Climber City goals, extreme environments &amp; pitch protocol", '''<p>Guide students through the Unexpected Architecture design scenario on the main display:</p><ul><li>Explore Extreme Environmental Architecture:<br>• <strong>Underwater Research Lab:</strong> Curved cylindrical reinforced hulls, ballasting systems, airtight airlocks, non-corrosive materials.<br>• <strong>Climber City Urban Goals:</strong> Integrating public green roofs, pedestrian-first skybridges, solar harvesting facades, and stormwater catchment.</li><li>Establish 1-Minute Paired Pitch Protocol: (1) Name the project &amp; environmental challenge, (2) Point to 2 signature architectural features, (3) Explain how it solves the city/research goal, (4) Cite 1 transferable skill used during the project.</li><li>Explain Equal Presentation Routes: 1-minute partner walk, private recorded video/audio, or written executive summary.</li></ul>''')
                    + flow("#1f617a", "Minutes 15-32 - Extreme concept design &amp; 1-minute paired pitches", '''<p>Students finalize their extreme concept and execute 1-minute paired pitches:</p><ul><li>Phase 1 (Design Polish, Min 15-22): Add 2 signature environmental protection features to their extreme concept.</li><li>Phase 2 (Paired Pitching, Min 22-32): Partners take turns pitching their concepts using the 1-minute structured framework. Listeners record 1 positive observation and 1 clarifying question.</li><li><strong>Active Monitoring Checkpoints:</strong><br>• Lap 1 (Minute 20): Verify students include environmental engineering features (pressure hulls, thermal insulation, solar capture).<br>• Lap 2 (Minute 28): Ensure partners keep strict 1-minute timing and use professional technical terminology.</li></ul>''')
                    + flow("#e3ad19", "Minutes 32-43 - Individual weekly portfolio synthesis", '''<p>Students independently complete the Architecture Evidence Portfolio synthesis on their handout (or Canvas):</p><ul><li>Reference one correctly labeled salary or licensing fact from their Day 2 Minor.</li><li>Explain how design, safety, and testing roles collaborate across the Architecture &amp; Construction cluster.</li><li>Record two personal takeaways regarding high school CTE courses in Irving ISD.</li></ul>''')
                    + flow("#1f617a", "Minutes 43-50 - Submit Formative Portfolio and 5SW Week 1 wrap-up", '''<p>Students submit their completed Architecture Evidence Portfolio in Canvas or hand in paper packets.</p><ul><li>Congratulate students on completing Blueprint Builders!</li><li><strong>Safe Trim:</strong> Use written pitch summary if paired speaking is delayed; fiercely protect the extreme design features, portfolio synthesis, and private submission.</li></ul>''')
                ),
