...
async def main():
    ...
    async with httpx.AsyncClient(headers={"Authorization":f"Bearer {token}"},timeout=120) as c:
        ...
        student_values={
          ...
          2:{"APP_IMAGE_ID":uploads[2]["it-app-exploration.png"]["id"],"SALARY_FILE_ID":files["SALARY"]["id"],"EXAMPLE_FILE_ID":files["MODEL"]["id"],"EXIT_FILE_ID":files["E2"]["id"]},
        ...
        contracts={
          ...
          2:{"TOPIC":"Programming Careers","OBJECTIVE":"Students will identify programming career opportunities and research the work and preparation for three careers using Hats &amp; Ladders or Xello (the district-localized app figure).","TEKS":"d(1)(C), d(2)(A)","DOL":"Day 2 app-evidence sections on packet pp. 1-3 and a supported hiring decision."},
          3:{"TOPIC":"Resilience and Labor-Market Evidence","OBJECTIVE":"Students will plan a specific response to a failed technology test and compare three IT careers using one dated national data set.","TEKS":"d(1)(C), d(5)(A), d(5)(E)","DOL":"Four-row Flip the Failure chart in FYF p. 27 and a supported three-career comparison on packet p. 4."},
        ...
        teacher_data={
          ...
          2:{
            ...
            "ALERT":"<strong>Verify live titles, then preserve them.</strong> Students record the exact available programming titles. Day 3 teaches the dated BLS table printed on packet p. 4; students will not collect another set of numbers.",
            "PREP":f'<ul><li>Open H&amp;L Information Technology &gt; Programming and Software Development and verify the available Hats.</li><li>Open the coordinated Student Guide, the five-page salary packet, and the <a href="/courses/{COURSE_ID}/files/{files["MODEL"]["id"]}/preview">evidence-label model</a> only if a student needs help locating a task or preparation detail.</li><li>Keep packet p. 4 closed today; it contains tomorrow’s dated national comparison.</li></ul>',
            ...
            "EVIDENCE":"<p>Students choose three careers and complete the app-evidence records on packet pp. 1-3. The mobile-game hiring case is formative. Packet p. 4 holds tomorrow’s national comparison.</p>",
            "FLOW":(
              ...
              flow("#4a9d2f","Minutes 4-16 - Browse programming Hats in H&L",'''<p>Direct students through ClassLink to H&amp;L &gt; Information Technology &gt; Programming and Software Development.</p><ul><li>Offer four examples: <strong>Software Developer</strong>, <strong>Web Developer</strong>, <strong>Mobile App Developer</strong>, and <strong>Game Developer</strong>. Use the exact titles that are actually visible.</li><li>Students browse for about 3 minutes per Hat and choose three for the packet. Ask them to say one possible task or reaction as they browse; no notebook rows are required because packet pp. 1-3 hold the career evidence.</li><li>If a student gravitates to Game Developer, ask, <em>“What does the profile say about its tasks and preparation compared with Software Developer?”</em></li><li>Before releasing the packet, project p. 1 and have students point to the platform, geography, measure, and date fields.</li></ul>''')+
              flow("#1f617a","Minutes 16-40 - Complete Day 2 app-evidence sections on pages 1-3",'''<p>Students select three careers from their browse and open the five-page IT Salary Comparison packet. Where possible, those three careers should come from the Hats students rated on FYF p. 38 yesterday.</p><ul><li>Students complete ONLY the <strong>Day 2 - Hats &amp; Ladders or Xello career evidence</strong> section on pages 1-3 for their three chosen careers: exact title, platform/date, job task, and common preparation.</li><li>Explicit instruction: <em>“Leave p. 4 for tomorrow. It already contains the dated national comparison table.”</em></li><li>Provide the preparation word bank: <em>degree, certificate, certification, training, experience, skill</em>, and model the frame: <em>“A [career] commonly prepares by [training/education].”</em></li><li>Refer students needing support to the evidence-label model to distinguish a daily task from preparation requirements.</li><li><strong>Active Monitoring Checkpoints:</strong><br>• Lap 1 (Minute 22): Confirm every student has chosen three distinct careers and recorded exact displayed titles.<br>• Lap 2 (Minute 30): Check that students are recording specific job tasks rather than generic phrases like 'works on computers.'<br>• Lap 3 (Minute 36): Verify that preparation entries name concrete credentials (e.g. bachelor's degree, coding bootcamp, portfolio).</li></ul>''')+
            ...
            "SUPPORT":"<p>The Student Guide places a preparation word bank and complete hiring frame beside the task. Use the evidence-label model only to show where a task or preparation detail lives, then return students to their own packet.</p>",
            "FALLBACK":"<p>Use the verified evidence-label model for one career and any available Hats &amp; Ladders Hat pages for the other two. Complete only the Day 2 sections of pages 1-3 and the hiring case. Record live H&amp;L browsing for supervised catch-up.</p>"},
          3:{
            "TITLE":"Resilience and Reading Career Data","SUBTITLE":"50 minutes · TEKS d(1)(C), d(5)(A), d(5)(E)",
            "ALERT":"<strong>Teach one BLS row first.</strong> Packet p. 4 already has three comparable national careers. Students analyze that table; they do not search for or recopy three BLS pages. FYF p. 27 holds the resilience chart.",
            "PREP":f'<ul><li>Open FYF pp. 26-27 and return the existing five-page packet.</li><li>Project p. 4 and model the Software Developers row: May 2025 U.S. median annual pay and projected 2025-2035 growth.</li><li>Keep the <a href="/courses/{COURSE_ID}/files/{files["GUIDE"]["id"]}/preview">one-row BLS reading guide</a> and the alternate Flip the Failure scaffold for students who need them.</li></ul>',
            "LOGISTICS":"<p>Use the workbook for Flip the Failure and p. 4 of the same packet for the career comparison. A student who needs a digital writing surface may use the linked comparison Doc instead of p. 4; collect one response. The supplied BLS table is the normal data source; live browsing is optional for teacher demonstration.</p>",
            "EVIDENCE":"<p>FYF p. 27 has four repairs and team tips. Packet p. 4 compares three May 2025 U.S. median annual wages, three 2025-2035 growth estimates, and one limitation. The packet remains Minor 2 evidence for Day 5.</p>",
            "FLOW":(
              flow("#5a2d91","Minutes 0-5 - What failed?",'''<p>Ask, <em>“The alert arrived too late. What specific change should the team test next?”</em> Take two answers and distinguish a testable repair from blaming a teammate.</p>''')+
              flow("#4a9d2f","Minutes 5-18 - Flip the Failure in FYF",'''<p>Read FYF pp. 26-27 aloud. Point to the four failed test events, then model one repair and one resilience tip for the slow alert. Students complete all four rows on p. 27 and compare one row with a partner. Ask, <em>“Which fix can the team actually test?”</em></p>''')+
              flow("#1f617a","Minutes 18-28 - Read one BLS row together",'''<p>Introduce BLS as the U.S. Bureau of Labor Statistics. Project packet p. 4. Read the Software Developers title, $135,980 May 2025 U.S. median annual pay, and 10% projected growth for 2025-2035 separately. Ask, <em>“Is this a new worker's Irving wage?”</em> and <em>“Does growth promise this student a job?”</em> Both answers are no. Students underline the place, measure, and dates.</p>''')+
              flow("#e3ad19","Minutes 28-45 - Compare three careers",'''<p>Students answer the four p. 4 questions using the printed same-source table. At minute 34, inspect two papers for source labels and a genuine data limit; if needed, stop for a two-minute repair. At minute 42, partners point to two facts supporting a next-investigation choice. No student copies the table onto another sheet.</p>''')+
              flow("#24323d","Minutes 45-50 - Close and collect",'''<p>Ask students to read one accurate comparison claim. Collect the same five-page packet for Day 5. Page 4 is today's exit evidence; FYF p. 27 remains in the workbook.</p>''')
            ),
            "MONITOR":"<p>Key: Software Developers $135,980 and 10%; Software Quality Assurance Analysts and Testers $104,300 and 6%; Web Developers $92,650 and 4%. Pay is May 2025 U.S. median annual; growth is projected 2025-2035. Watch for students calling a median local starting pay or treating growth as a promise.</p>",
            "SUPPORT":f'<p>Read the scenario aloud. Use <a href="/courses/{COURSE_ID}/files/{files["GUIDE"]["id"]}/preview">the one-row reading guide</a> beside p. 4 only when needed. Use the prefilled Flip the Failure scaffold instead of workbook p. 27 when a student needs that writing surface.</p>',
            "FALLBACK":"<p>All required data are printed on packet p. 4. A student does not need the live BLS site. An absent student uses FYF pp. 26-27 and the same packet; missing Day 2 app records can be completed later without invented numbers.</p>"},
          4:{
          ...
          5:{
            ...
            "FLOW":(
              ...
              flow("#e3ad19","Minutes 42-47 - Minor 2 packet audit and submission",'''<p>Students conduct a self-audit of all five packet pages against the Minor 2 rubric before turning it in.</p><ul><li>Page 1: Career 1 app evidence complete.</li><li>Page 2: Career 2 app evidence complete.</li><li>Page 3: Career 3 app evidence complete.</li><li>Page 4: three-career salary and growth comparison with a data limit.</li><li>Page 5: Complete Career Fit Reflection with evidence.</li><li>Students staple or organize pages 1-5 and submit the completed Minor 2 portfolio.</li></ul>''')+
        ...
        glances={
          1:{"WORKBOOK":"FYF p. 23 and pp. 36-38","PLATFORM":"H&amp;L Information Technology Cluster through ClassLink","NOTEBOOK":"None; short notes stay in the workbook margin","SLIDES":"No separate deck; project the workbook and student guide","SCAFFOLDS":"Optional enlarged program sheet, word bank, and Venn comparison frame","EXIT_EVIDENCE":"Programming/Cybersecurity Venn comparison exit ticket"},
          2:{"WORKBOOK":"FYF p. 38 holds the prior Hat ratings; no new workbook writing","PLATFORM":"H&amp;L Programming and Software Development through ClassLink; Xello app evidence if selected","NOTEBOOK":"None; career facts go on packet pp. 1-3","SLIDES":"No separate deck; project packet p. 1 and the student guide","SCAFFOLDS":"Evidence-label model and preparation word bank, used only when needed","EXIT_EVIDENCE":"Three app career records on packet pp. 1-3 and one hiring decision"},
          3:{"WORKBOOK":"FYF pp. 26-27; write in the p. 27 resilience chart","PLATFORM":"None required; the BLS comparison is printed on packet p. 4","NOTEBOOK":"None","SLIDES":"No separate deck; project the modeled packet row","SCAFFOLDS":"One-row BLS reading guide and alternate Flip the Failure scaffold only when needed","EXIT_EVIDENCE":"Packet p. 4 three-career comparison and one data limit"},
          4:{"WORKBOOK":"None today","PLATFORM":"Code.org optional; the student guide has a complete trace","NOTEBOOK":"None","SLIDES":"No separate deck; project the student-guide robot trace","SCAFFOLDS":"Worked trace, concept definitions, and career explanation frame","EXIT_EVIDENCE":"One working or traced example plus a concept-and-career explanation"},
          5:{"WORKBOOK":"No new page; return the same five-page packet","PLATFORM":"Xello Personality Style through ClassLink when the prerequisite is complete","NOTEBOOK":"None","SLIDES":"No separate deck; project the sample result and Minor 2 rubric","SCAFFOLDS":"Sample Personality Style result, fit word bank, and packet rubric","EXIT_EVIDENCE":"Packet p. 5 reflection and one Minor 2 submission"}}
        ...
        for day in range(1,6):
            ...
            tt=f"TEACHER: 1SW Wk2 Day {day} Facilitator Guide"; tu=slugify(tt); teacher=await upsert_page(c,tt,render("wk2-teacher.html",{"COURSE_ID":COURSE_ID,"DAY":day,"STUDENT_PAGE_URL":student["url"],**contracts[day],**glances[day],**teacher_data[day]}),tu)
