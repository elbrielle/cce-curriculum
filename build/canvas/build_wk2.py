    ...
    async with httpx.AsyncClient(headers={"Authorization":f"Bearer {token}"},timeout=120) as c:
        ...
        teacher_data={
          ...
          3:{
            ...
            "FALLBACK":"<p>If a live source fails, use the student's Day 2 HQIM record and the fixed career card inside the BLS guide. Keep the source and date visible. An absent student completes the workbook chart and the same packet without making a separate replacement worksheet.</p>"},
          4:{
          ...
          5:{
            ...
            "FLOW":flow("#5a2d91","Launch and written route · 5 minutes","Open Personality Style; move blocked students to the sample result and page 5.")+flow("#4a9d2f","Xello Personality Style · 20 minutes","Complete, review, and record one chosen trait with a real example.")+flow("#1f617a","Save three researched careers · 20 minutes","Search the three careers marked in the salary packet, confirm each title, and save it for next week's lesson.")+flow("#e3ad19","Minor reflection and submission · 5 minutes","Complete page 5 and submit all five pages."),
