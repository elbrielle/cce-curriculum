...
STUDENT_WORKSHEET_COPY_URLS = {
    (1, 'the three-page career evidence packet'): "https://docs.google.com/document/d/1oi_sE9fJ-s1quEY_0Ym7TuA9eD6YyGKbJHDhppVdJlI/copy",
    (2, 'the six-page safe-label fallback'): "https://docs.google.com/document/d/1uvtNQFqKDTpnW7olbC9bPalNCRgkk7kCGUlZBK2RxWM/copy",
    (3, 'the four-page classification packet'): "https://docs.google.com/document/d/14BL8OiS_V-XcJp5V-a_8VL11MYwEREa0eg38dV6aAew/copy",
    (4, 'the four-page current entry-routes packet'): "https://docs.google.com/document/d/1BVcYskdlNDZAdFdbDGlbfzAtW5UTKN-bHMLJmzOWIkk/copy",
    (5, 'the two-page individual response companion'): "https://docs.google.com/document/d/1brOPJUWYcVFUNILv0f7Dv_-ybiMKgbKOC3MLIFt3N60/copy",
    (5, 'your Day 3 classification evidence'): "https://docs.google.com/document/d/14BL8OiS_V-XcJp5V-a_8VL11MYwEREa0eg38dV6aAew/copy",
}
...
def student_content(files, visuals, urls):
    ...
    day2_media = (
        '<h3 style="color:#1f6073;border-bottom:3px solid #b8d5dd">Visual references</h3>'
    ...
    day5_media = (
        '<h3 style="color:#1f6073;border-bottom:3px solid #b8d5dd">Scenario references</h3>'
    ...
    return {
        ...
        5: {
            ...
            "RESPONSE_SOURCE_FILE_IDS": [files["WATER"]["id"], files["CLASSIFY"]["id"]],
...
def teacher_content(files):
    ...
    return {
        1: {
            ...
            "FLOW": (
                flow(color, "Minutes 0-5 - Welcome and skilled trades infrastructure warm-up", '''<p>Welcome students to Week 4 of 5SW (Skilled Trades) and project the building utilities prompt.</p><ul><li>Ask students: <em>“When you flip a light switch, turn on a hot shower, or adjust the thermostat in your home, what happens behind the drywall and beneath the slab? What distinct trades installed and maintain each of those interconnected utility systems?”</em></li><li>Collect 2-3 student thoughts: Electricians wire circuits, plumbers lay supply and waste lines, and HVAC technicians install refrigerant coils and ductwork!</li><li>Bridge with, <em>“Skilled trades keep modern society functioning. Today we examine four core trade careers, analyze May 2024 BLS earnings data, and distinguish between training routes, industry credentials, and state licenses.”</em></li></ul>''')
                + flow("#4c8b38", "Minutes 5-13 - Occupation vs. route vs. credential vs. state license", '''<p>Deconstruct the 4 Critical Legal and Professional Boundaries on the screen:</p><ul><li>1. <strong>Occupation:</strong> The job role itself (e.g., Electrician, Plumber).</li><li>2. <strong>Training Route:</strong> How you learn the trade (e.g., a 4-5 year Registered Apprenticeship or community college certificate).</li><li>3. <strong>Industry Credential:</strong> A voluntary skill certification issued by an industry group (e.g., AWS Certified Welder or EPA Section 608 Universal Refrigerant Certification).</li><li>4. <strong>State License:</strong> A mandatory government legal authorization required by law to work independently (e.g., Texas TDLR Journeyman Electrician License or TSBPE Journeyman Plumber License).</li><li>Model the Electrician Boundary: You cannot legally wire a Texas commercial building alone just because you finished school—you MUST hold a state TDLR license!</li></ul>''')
                + flow("#b35d2e", "Minutes 13-35 - Four-trade career evidence mapping sprint", '''<p>Students analyze the four fixed career cards in their guide (or Canvas):</p><ul><li>1. <strong>Electrician:</strong> May 2024 U.S. median pay: $61,590; 11% projected growth. Route: Apprenticeship; State Boundary: TDLR licensing.</li><li>2. <strong>Plumber / Pipefitter:</strong> May 2024 U.S. median pay: $61,550; 6% projected growth. Route: Apprenticeship; State Boundary: TSBPE registration &amp; licensing.</li><li>3. <strong>HVAC Mechanic / Installer:</strong> May 2024 U.S. median pay: $57,300; 9% projected growth. Route: Postsecondary award / OJT; State Boundary: TDLR technician registration &amp; EPA 608.</li><li>4. <strong>Welder / Cutter:</strong> May 2024 U.S. median pay: $48,940; 2% projected growth. Route: Technical training / OJT; State Boundary: Employer/AWS certification; no universal Texas license.</li><li>Document Two Substantive Differences: Compare preparation and legal regulation between welding and licensed electrical work.</li><li>Formulate ONE Official-Source Verification Question: Formulate a question for TDLR or TSBPE regarding apprentice registration rules.</li><li><strong>Active Monitoring Checkpoints:</strong><br>• Lap 1 (Minute 21): Verify students write complete BLS statistical labels: 'May 2024 U.S. Median Wage.'<br>• Lap 2 (Minute 30): Confirm students distinguish between TDLR (electrician/HVAC) and TSBPE (plumbing).</li></ul>''')
                + flow("#d39b22", "Minutes 35-43 - Partner verification audit &amp; career reflection", '''<p>Elbow partners swap career cards for a 3-minute check:</p><ul><li>Checker verifies: Did the student clearly separate training routes from state legal licenses?</li><li>Students record which trade matches their personal hands-on mechanical interests.</li></ul>''')
                + flow(color, "Minutes 43-50 - Exit check and Week 4 evidence folder storage", '''<p>Students submit their private Canvas response and file their career card in their Week 4 folder.</p><ul><li><strong>Safe Trim:</strong> Shorten partner discussion; fiercely protect all 4 career rows, TDLR/TSBPE boundary notes, and private exit.</li></ul>''')
            ),
        ...
        2: {
            ...
            "FLOW": (
                flow(color, "Minutes 0-5 - Welcome and technical field documentation warm-up", '''<p>Welcome students, seat them with FYF workbooks (pp. 185-190) or the safe-label fallback, and project the service ticket prompt.</p><ul><li>Ask students: <em>“If an HVAC technician writes on a service ticket, 'Unit is completely broken, customer needs a new $8,000 system,' why will the service manager reject that ticket? What specific technical facts must be documented before recommending expensive repairs?”</em></li><li>Collect 2-3 student thoughts: A professional must document the customer complaint, observable sensor readings, visible ice or airflow restrictions, and root-cause diagnostic steps!</li><li>Bridge with, <em>“Clear written communication protects customers and technicians alike. Today we examine four fictional HVAC service tickets on FYF pp. 185-190, apply rigorous evidence-first field note labels, and demonstrate cross-career skill transfer.”</em></li></ul>''')
                + flow("#4c8b38", "Minutes 5-13 - Relabeling workbook fields &amp; objective field note modeling", '''<p>Deconstruct the 4-Part Evidence-First Field Note Architecture on the main screen:</p><ul><li>1. <strong>Customer Complaint:</strong> Record the reported symptom (e.g., 'Master bedroom blowing warm air').</li><li>2. <strong>Objective Visual / Physical Clue:</strong> Document observable facts only (e.g., 'Indoor evaporator coil surface coated in 1/4-inch frost/ice; return air filter saturated with dark dust').</li><li>3. <strong>Supported Possibility:</strong> State a cautious technical hypothesis (e.g., 'Restricted airflow across evaporator coil could prevent heat transfer, causing coil to freeze').</li><li>4. <strong>Evidence Boundary &amp; Next Check:</strong> State what remains unverified and name the diagnostic tool required (e.g., 'This visual clue does not prove a refrigerant leak; a licensed HVAC technician must let coil thaw and perform a manifold gauge pressure test').</li><li>Point out the Workbook Label Adjustment: Replace 'Diagnosis' with 'Supported Possibility' and 'Action' with 'Evidence Limit &amp; Qualified Next Check.'</li></ul>''')
                + flow("#b35d2e", "Minutes 13-38 - Four HVAC service ticket field note sprint (FYF pp. 187-190)", '''<p>Students analyze the 4 embedded service tickets on FYF pp. 187-190 (or safe fallback):</p><ul><li>Ticket 1: Visible ice on refrigerant line &amp; weak airflow &rarr; Clue, possibility, limit, pressure gauge test.</li><li>Ticket 2: Heavy dust and pet hair on indoor blower wheel &rarr; Clue, possibility, limit, airflow CFM measurement.</li><li>Ticket 3: Saturated pleated filter with dust buildup &rarr; Clue, possibility, limit, filter replacement &amp; static pressure check.</li><li>Ticket 4: Weathered, debris-clogged outdoor condenser fins &rarr; Clue, possibility, limit, fin cleaning &amp; compressor amp draw check.</li><li>Synthesize Cross-Career Skill Transfer: Write a 2-sentence explanation of how this exact 4-part evidence note transfers to medical charting (Nurse/Doctor) or automotive repair (Technician).</li><li><strong>Active Monitoring Checkpoints:</strong><br>• Lap 1 (Minute 22): Ensure students describe observable facts rather than declaring a broken compressor.<br>• Lap 2 (Minute 32): Confirm students include the qualified specialist and diagnostic test in every limit field.</li></ul>''')
                + flow("#d39b22", "Minutes 38-45 - Field note peer audit &amp; rewrite", '''<p>Elbow partners audit one ticket for objective professional tone:</p><ul><li>Ensure speculative words like 'definitely ruined' are rewritten to 'consistent with restricted airflow.'</li></ul>''')
                + flow(color, "Minutes 45-50 - Submit Field Notes &amp; Day 2 wrap-up", '''<p>Students submit their completed field notes in Canvas or turn in workbook sheets.</p><ul><li><strong>Safe Trim:</strong> Shorten partner audit; fiercely protect all 4 ticket entries, diagnostic boundaries, and cross-career transfer sentence.</li></ul>''')
            ),
        ...
        3: {
            ...
            "FLOW": (
                flow(color, "Minutes 0-5 - Welcome and job growth vs. job openings warm-up", '''<p>Welcome students, seat them with devices or the 4-page classification packet, and project the labor market prompt.</p><ul><li>Ask students: <em>“If welding has 45,600 annual openings nationwide but only 2% projected job growth, while electricians have 11% growth with 79,000 openings, which number measures new jobs being created, and which number measures older workers retiring?”</em></li><li>Collect 2-3 student thoughts: Growth percentage measures new jobs being created; annual openings include retirements and career transitions!</li><li>Bridge with, <em>“Today is Major 1, Part A: Skilled-Trades Labor Classification! We apply our transparent 3-factor classification rule to four skilled trades using official May 2024 BLS labor data.”</em></li></ul>''')
                + flow("#4c8b38", "Minutes 5-13 - Sourced BLS labor benchmarks &amp; Major 1 Part A rubric", '''<p>Display the Course Classification Benchmarks on the screen:</p><ul><li>1. <strong>National Median Wage Benchmark:</strong> $49,500 (May 2024 all-occupations U.S. median). Above $49,500 = High-Wage.</li><li>2. <strong>National Job Growth Benchmark:</strong> 3.1% (2024-34 all-occupations projected growth). Above 3.1% = High-Demand.</li><li>3. <strong>High-Skill Benchmark:</strong> Requires formal apprenticeship, postsecondary technical certificate, or state license/credential.</li><li>Review the 4 Trades:<br>• <strong>Electrician:</strong> $61,590 (High-Wage), 11% (High-Demand), Apprenticeship/TDLR (High-Skill) &rarr; Triple Qualified.<br>• <strong>Plumber:</strong> $61,550 (High-Wage), 6% (High-Demand), Apprenticeship/TSBPE (High-Skill) &rarr; Triple Qualified.<br>• <strong>HVAC Mechanic:</strong> $57,300 (High-Wage), 9% (High-Demand), Postsecondary Award/TDLR (High-Skill) &rarr; Triple Qualified.<br>• <strong>Welder:</strong> $48,940 (Below wage benchmark), 2% (Below growth benchmark), AWS Credentials (High-Skill) &rarr; High-Skill only.</li><li>Deconstruct Scored Rubric Criteria: Accurate numbers, explicit rule-based classification, openings vs. growth analysis, and national-to-local limitation.</li></ul>''')
                + flow("#b35d2e", "Minutes 13-38 - Independent Major 1 Part A Classification sprint", '''<p>Students complete their classification matrix in Canvas (or 4-page landscape packet):</p><ul><li>Section 1: Record May 2024 BLS medians and 2024-34 growth rates with explicit statistical source labels.</li><li>Section 2: Apply the 3-Factor Classification Matrix (Skill, Wage, Demand) to all four skilled trade occupations.</li><li>Section 3: Analyze the Annual Openings Limitation: Explain why welding has 45,600 openings despite slow 2% growth.</li><li>Section 4: Formulate a National-to-Local Limitation: Explain why national BLS medians do not guarantee starting wages in Dallas-Fort Worth.</li><li><strong>Active Monitoring Checkpoints:</strong><br>• Lap 1 (Minute 22): Verify students apply the $49,500 and 3.1% thresholds consistently.<br>• Lap 2 (Minute 32): Confirm students explain replacement needs when analyzing annual openings.</li></ul>''')
                + flow("#d39b22", "Minutes 38-45 - Rubric self-score and targeted revision", '''<p>Students self-evaluate their Part A submission against the rubric:</p><ul><li>Self-score each section and execute a 2-minute revision to elevate the evidence in their lowest-scoring part.</li><li>Teacher provides targeted writing support to students with accommodations.</li></ul>''')
                + flow(color, "Minutes 45-50 - Submit Major 1 Part A in Canvas", '''<p>Students submit their completed Part A classification in Canvas (0-point collector) or store paper packets for Day 5 combined scoring.</p><ul><li><strong>Safe Trim:</strong> Skip whole-class debrief; fiercely protect all 4 classification rows, annual openings analysis, rubric self-audit, and private submission.</li></ul>''')
            ),
        ...
        4: {
            ...
            "FLOW": (
                flow(color, "Minutes 0-5 - Welcome and postsecondary pathway comparison warm-up", '''<p>Welcome students, seat them with devices or the 4-page route packet, and project the training route prompt.</p><ul><li>Ask students: <em>“If a high school senior wants to enter the electrical or HVAC trade in North Texas, what are the exact trade-offs between enrolling in a Dallas College certificate program versus applying directly to an IBEW or independent contractor apprenticeship?”</em></li><li>Collect 2-3 student thoughts: Classroom college structure vs. immediate paid full-time job with night classes!</li><li>Bridge with, <em>“Every skilled trade has structured entry pathways. Today we compare a union/non-union Registered Apprenticeship with a community college technical program, and map out concrete next steps.”</em></li></ul>''')
                + flow("#4c8b38", "Minutes 5-15 - State credential rules &amp; two-route modeling", '''<p>Guide students through the Two Entry Pathways and Texas trade regulatory bodies on the screen:</p><ul><li>1. <strong>Registered Apprenticeship Route:</strong> Paid employment from Day 1; 2,000 hours of on-the-job training per year under a journeyman mentor; 144+ hours of related technical instruction; progressive wage scale.</li><li>2. <strong>Community / Technical College Route (e.g., Dallas College Electrical Technology):</strong> Hands-on lab classes, college credits, certificate earned in 1-2 years; flexible schedule; students pay tuition (or use financial aid) and seek employment upon completion.</li><li>3. <strong>State Regulatory Verification Rules:</strong><br>• Electrician: Must register as an Apprentice Electrician with TDLR before touching wiring on a job site.<br>• Plumber: Must register as an Apprentice Plumber with TSBPE before working on plumbing systems.</li><li>Notice Rule: Students do NOT fill out real applications or enter personal data during class.</li></ul>''')
                + flow("#b35d2e", "Minutes 15-35 - Route comparison &amp; action sequence sprint", '''<p>Students analyze the two route cards in their guide (or Canvas):</p><ul><li>Part 1: Complete the Side-by-Side Comparison Matrix across 5 criteria (Start Cost, Earning Potential, Time to Completion, Credential Earned, Verification Requirement).</li><li>Part 2: Author the Fictional Jordan Recommendation: Jordan wants hands-on learning, wants to avoid tuition debt, and has reliable transportation. Which route should Jordan prioritize? Defend with 2 concrete facts from today's evidence.</li><li>Part 3: Document 3 Step-by-Step Action Steps: Order the exact steps Jordan must take to enter the chosen route.</li><li>Part 4: Identify ONE Variable to Verify: What variable (e.g., application deadline, sponsor hiring schedule) must Jordan confirm?</li><li><strong>Active Monitoring Checkpoints:</strong><br>• Lap 1 (Minute 22): Check that students cite specific facts from both route cards.<br>• Lap 2 (Minute 30): Confirm students sequence the 3 action steps logically.</li></ul>''')
                + flow("#d39b22", "Minutes 35-43 - Partner route audit &amp; elbow check", '''<p>Elbow partners swap route plans to ensure Jordan's action steps are realistic and logically ordered.</p>''')
                + flow(color, "Minutes 43-50 - Submit Day 4 Evidence &amp; wrap-up", '''<p>Students submit their completed route comparison in Canvas or file paper packets.</p><ul><li><strong>Safe Trim:</strong> Shorten partner check; fiercely protect both route comparison columns, Jordan defense, 3 action steps, and private submission.</li></ul>''')
            ),
        ...
        5: {
            ...
            "FLOW": (
                flow(color, "Minutes 0-4 - Welcome and emergency infrastructure response warm-up", '''<p>Welcome students, seat them in teams of 3 with FYF workbooks (pp. 194-195) or individual companions, and project the municipal emergency prompt.</p><ul><li>Ask students: <em>“If water is bubbling up through the asphalt on an Irving residential street, who has the legal authority and specialized equipment to shut down the main valve, locate underground high-voltage cables, and dig up the roadway: the neighborhood residents, or municipal water utility crews?”</em></li><li>Collect 2-3 student thoughts: Only authorized city water and utility crews have the training and legal authority to touch underground mains!</li><li>Bridge with, <em>“Emergency response requires strict role boundaries and rapid communication. Today is Major 1, Part B: Fictional Water-Line Response! We collaborate on a response plan, then deliver our individual 30-45 second professional oral/AAC briefing using appropriate technology!”</em></li></ul>''')
                + flow("#4c8b38", "Minutes 4-11 - Team role boundaries &amp; 30-45s briefing structure", '''<p>Deconstruct Team Roles and the Professional Briefing Architecture on the main screen:</p><ul><li>Three Functional Team Roles:<br>1. <strong>Safety &amp; Communication Lead:</strong> Establishes the safe perimeter, contacts city dispatch, and logs incoming reports.<br>2. <strong>System-Evidence Lead:</strong> Maps observable water flow, pressure drops, and coordinates with Texas 811 utility locators.<br>3. <strong>Plan &amp; Record Lead:</strong> Synthesizes the timeline, equipment staging, and specialist handoff documentation.</li><li>Safety Invariant: Students plan communication and coordination only—they NEVER simulate touching valves, operating tools, or directing street traffic!</li><li>The 30-45 Second Structured Briefing Protocol (TEKS d(4)(C)):<br>• Professional Introduction &amp; Role (5s)<br>• Observable Physical Evidence (10s)<br>• Potential Hazard &amp; Safety Boundary (15s)<br>• Specialist Handoff &amp; Verification Action (10s)</li><li>Equal Technology Presentation Modes: (1) Companion card for live teacher/partner conference, (2) Private Canvas audio/video recording, or (3) Speech-generating AAC device playback.</li></ul>''')
                + flow("#b35d2e", "Minutes 11-27 - Fictional water-line response planning sprint (FYF pp. 194-195)", '''<p>Teams collaborate on FYF pp. 194-195 while each student authors their individual response companion:</p><ul><li>Step 1 (Min 11-18): Analyze initial water leak scenario; map safety perimeter and dispatch notification.</li><li>Step 2 (The Scenario Twist, Min 18-27): Sudden electrical sparking reported near adjacent transformer pad! Teams revise response protocol immediately to prioritize electrical hazard evacuation before water containment.</li><li>Individual Companion Entries: Record the updated safety protocol, authority boundary, and exact trade specialists required (Master Plumber / Municipal Utility Crew + Master Electrician / Oncor).</li><li><strong>Active Monitoring Checkpoints:</strong><br>• Lap 1 (Minute 16): Verify teams prioritize calling emergency utility dispatch before attempting any containment.<br>• Lap 2 (Minute 24): Confirm students adapt to the electrical twist by widening the safety perimeter.</li></ul>''')
                + flow("#d39b22", "Minutes 27-45 - Individual 30-45 second professional briefings (TEKS d(4)(C))", '''<p>Students deliver their individual 30-45 second professional briefings using their chosen technology route:</p><ul><li>Live/Conference Route: Students use their visible evidence companion card to brief the teacher or elbow partner. Partner signs off on the 30-45s timing and professional delivery rubric. Roles swap.</li><li>Private Recording / AAC Route: Students record their 30-45s briefing directly into Canvas using microphone/webcam or AAC speech-generating device.</li><li><strong>Scoring Invariant:</strong> Grade purely on technical accuracy, evidence boundaries, and professional structure—never on accent, eye contact, speech difference, or video polish!</li></ul>''')
                + flow(color, "Minutes 45-50 - Submit Major 1 and 5SW Week 4 wrap-up", '''<p>Students submit their completed Major 1 Part B companion in Canvas or hand in paper packets.</p><ul><li>Congratulate students on completing Major 1 across both Parts A and B!</li><li><strong>Safe Trim:</strong> Keep team sketch simple; fiercely protect the individual companion, technology support, and individual 30-45s oral/AAC briefing.</li></ul>''')
            ),
