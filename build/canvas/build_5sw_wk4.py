...
def teacher_content(files):
    ...
    return {
        ...
        2: {
            ...
            "EVIDENCE": "<p>Formative set of four roomy fictional service notes and one written-communication transfer.</p>",
        ...
        3: {
            ...
            "EVIDENCE": "<p><strong>Major 1, Part A, in the 5SW assessment map:</strong> four supported classifications, trend/openings comparison, and national-to-local limitation. Combine with the Day 5 response under the published rubric; convert to 100 points only after the Major group is verified.</p>",
