    ...
    async with httpx.AsyncClient(headers={"Authorization": f"Bearer {token}"}, timeout=120) as client:
        ...
        teacher = {
            ...
            3: {
                ...
                "FALLBACK": "<p>No live site is load-bearing. Xello-localized data stays in a separately labeled cross-check; H&amp;L is optional. At minute 45, students submit the annotation/upload/text response or place the paper packet in the tray. An incomplete student resumes the same practice Assignment.</p>",
            },
            4: {
                "TITLE": "Evaluate Automotive Training Routes",
