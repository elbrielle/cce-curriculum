...
STUDENT_WORKSHEET_COPY_URLS = {
    (1, 'the three-page companion'): "https://docs.google.com/document/d/1UGVLwn95TzwKjh5TMie3vevmTipWhCT2mJhAvIcMOLo/copy",
    (2, 'the three-page fallback'): "https://docs.google.com/document/d/1q4zKpAD-i2cRJP5_1uWHcgXnFuEr6vow50xye1JR05U/copy",
    (3, 'the three-page landscape comparison'): "https://docs.google.com/document/d/1JsdOmMzpypwNuPMfeyb7bXU4hywWB0Y0qeZpzkP6duI/copy",
    (4, 'the two-page fallback'): "https://docs.google.com/document/d/1sNo526Z1jAWVNNgL81_mMlTZaxXk_F6Iy82zn-VIqzc/copy",
    (5, 'the four-page Evidence Brief'): "https://docs.google.com/document/d/1VKzps1fkDDCd0edwIaKYKbzlX-tkt36C1tSqgD_ojhs/copy",
}
...
QUIZZES = {
    ...
    SOURCE_QUIZ_TITLE: [
        {
            "name": "Q1 - Workbook and current source",
            ...
            "yes": "Correct. Your Find Your Future workbook supplies the program names; current sources answer current logistics questions.",
            "no": "Keep the workbook program names and use the correct current source for details it does not state.",
        },
        {
            "name": "Q2 - Source gap",
...
async def main():
    ...
    async with httpx.AsyncClient(headers={"Authorization": f"Bearer {token}"}, timeout=120) as client:
        ...
        media = {
            ...
            3: "",
            4: (
                image_tag(day4_assets["programs"]["id"], "Find Your Future Irving ISD programs page naming Automotive Technology, Collision Repair, Diesel and Heavy Equipment Technology, and Aviation Maintenance", "FYF p. 168: use these workbook program names.")
        ...
        student = {
            1: {
                ...
                "READY": f'<p>Open your <em>Find Your Future</em> workbook to p. 149 for the Transportation cluster, then work on pp. 150-151 with <a href="{urls["crash"]}">the private Crash Crew evidence check</a>. Use {student_copy_link(1, "the three-page companion")} only if you need the no-workbook, enlarged, or annotation route.</p>',
            ...
            4: {
                ...
                "PURPOSE": "Use the workbook program names, current logistics, and route evidence to recommend a first investigation step.",
                ...
                "STEPS": step(1, "Use your workbook and current district evidence", "<p>FYF names Automotive Technology, Collision Repair, and Diesel &amp; Heavy Equipment Technology. The current district page confirms the broader Automotive, Collision Repair and Diesel offering at Cardwell, Irving, MacArthur, and Nimitz.</p>")
                ...
                "DONE": "<ul><li>four Quiz items;</li><li>workbook program names;</li><li>three routes considered;</li><li>two source facts;</li><li>one tradeoff or missing fact;</li><li>authorized verification source.</li></ul>",
                "SUPPORT": "<p>Accurate uncertainty is stronger than a guess. Use the images, read-aloud, chunked cards, or speech-to-text.</p>",
                "FALLBACK": "<p>The two-page fallback and the embedded workbook pages are the complete route when a site fails. No private-school search is required.</p>",
            },
            5: {
        ...
        teacher = {
            1: {
                ...
                "FLOW": (
                    flow("#5a2d91", "Minutes 0-5 - Welcome and vehicle collision evidence warm-up", '''<p>Welcome students to Week 5 of 4SW and project the collision inspection prompt.</p><ul><li>Ask students: <em>“When an insurance adjuster or collision technician looks at a car that was in an accident, what is the critical difference between what is directly VISIBLE on the outside versus what remains UNKNOWN under the surface until diagnostic testing is performed?”</em></li><li>Collect 2-3 student thoughts: Dents and cracked bumper covers are visible; bent frame rails, damaged suspension alignment, cracked radiator cores, and damaged wiring/sensors are hidden.</li><li>Bridge with, <em>“In automotive repair, jumping to conclusions costs thousands and risks lives. Today we explore Transportation &amp; Collision Repair on FYF pp. 150-151 and conduct an objective Crash Crew inspection.”</em></li></ul>''')
                    + flow("#4a9d2f", "Minutes 5-13 - Objective damage logging &amp; visible vs. uninspected boundary", '''<p>Direct students to the vehicle diagrams on FYF p. 151 (or the 3-page companion) and model objective technical documentation:</p><ul><li>Exemplar Visible Evidence: <em>“Front bumper cover cracked and displaced 3 inches inward; right headlamp assembly shattered; hood misaligned with right fender gap.”</em></li><li>Exemplar Unknown / Diagnostic Question: <em>“Is the front bumper reinforcement beam deformed, and has the radiator support shifted or punctured the cooling core?”</em></li><li>Non-Example Overclaim: <em>“The car is totaled and the engine is completely ruined.”</em> (Unsubstantiated assumption without teardown or mechanical testing).</li><li>Review the Safety Invariant: Technicians never declare a vehicle structurally safe to drive based on a visual exterior walkaround alone.</li></ul>''')
                    + flow("#1f617a", "Minutes 13-33 - Damage inspection sprint &amp; repair question drafting", '''<p>Students analyze the Crash Crew vehicle in their workbook (or packet):</p><ul><li>Document 4 Distinct Visible Damage Observations: Use neutral, descriptive technical vocabulary (creased, cracked, displaced, gouged).</li><li>Draft 3 Mandatory Diagnostic Teardown Questions: Target internal mechanical, electrical, and structural systems.</li><li>Establish a 3-Step Preliminary Repair Sequence: (1) Disassembly &amp; frame laser measurement, (2) Structural pull &amp; component replacement, (3) Prep, paint &amp; electronic sensor recalibration.</li><li><strong>Active Monitoring Checkpoints:</strong><br>• Lap 1 (Minute 20): Ensure students record only what the image proves, avoiding wild claims about engine failure.<br>• Lap 2 (Minute 28): Confirm repair sequences follow logical order (structural repair before paint and sensor calibration).</li></ul>''')
                    + flow("#e3ad19", "Minutes 33-43 - The modern tech challenge: Advanced Driver Assistance Systems (ADAS)", '''<p>Introduce the modern vehicle complication prompt:</p><ul><li>Prompt: <em>“If this vehicle is a 2024 model equipped with radar sensors and front emergency braking cameras mounted behind the damaged bumper, why can't a body shop simply bolt on a new bumper and return the car to the owner?”</em></li><li>Students analyze sensor calibration requirements: Cameras and millimeter-wave radar require dynamic or static electronic recalibration with specialized target boards to prevent false emergency braking.</li></ul>''')
                    + flow("#1f617a", "Minutes 43-50 - Exit check and Week 5 evidence folder storage", '''<p>Students complete the exit card responding to an unsafe repair claim and store work in their folder.</p><ul><li><strong>Safe Trim:</strong> Shorten ADAS discussion; fiercely protect the 4 visible observations, 3 diagnostic questions, repair sequence, and folder retention.</li></ul>''')
                ),
            ...
            2: {
                ...
                "FLOW": (
                    flow("#5a2d91", "Minutes 0-5 - Welcome and technician credentialing warm-up", '''<p>Welcome students, seat them with devices or the 3-page reference guide, and project the certification prompt.</p><ul><li>Ask students: <em>“If an auto repair shop advertises 'All technicians ASE Certified,' what does that blue ASE patch actually mean to a customer, and how does a high school student earn entry into that trade?”</em></li><li>Collect 2-3 student thoughts: Industry standards, validated competence, trust, testing.</li><li>Bridge with, <em>“Automotive repair requires verified technical mastery. Today we deconstruct the National Institute for Automotive Service Excellence (ASE) credentials and compare three major training routes: OJT, Registered Apprenticeship, and Technical College.”</em></li></ul>''')
                    + flow("#4a9d2f", "Minutes 5-17 - ASE Entry-Level vs. professional certification &amp; three training pathways", '''<p>Deconstruct credentialing rules on the main display:</p><ul><li>1. <strong>ASE Entry-Level Certification:</strong> Designed for high school and career-tech students. Tests fundamental theory across areas like brakes, steering/suspension, electrical, and engine repair. Requires ZERO work experience, but expires in 2 years and DOES NOT give you professional master technician status.</li><li>2. <strong>Professional ASE Certification:</strong> Requires passing rigorous specialty tests PLUS completing 2 full years of verified hands-on work experience (or 1 year with a qualifying 2-year postsecondary degree).</li><li>Contrast Three Postsecondary Training Routes:<br>• <strong>Employer On-The-Job Training (OJT):</strong> Start as lube/tire tech, learn on the shop floor. Pros: Immediate hourly wage, zero student debt. Cons: Narrow training dependent on shop owner, slower credential progression.<br>• <strong>Registered Apprenticeship:</strong> Federally registered paid job combining structured mentorship, related technical classroom instruction, and progressive wage increases culminating in a nationally recognized credential.<br>• <strong>Community / Technical College (e.g., TCC):</strong> Associate of Applied Science (AAS) or Certificate. Structured classroom + lab training. Tuition required, but comprehensive technical foundations and college credit.</li></ul>''')
                    + flow("#1f617a", "Minutes 17-35 - Route evaluation sprint &amp; Jordan case study analysis", '''<p>Students analyze the three training routes in their packet:</p><ul><li>Complete the Three-Route Matrix: Contrast entry requirements, cost, earnings during training, and credential outcomes.</li><li>Evaluate the Fictional Jordan Case Study: Jordan wants to earn an income immediately, avoid college debt, and become a certified diesel technician. Which route should Jordan investigate first? Defend with 1 financial fact and 1 credential trade-off.</li><li><strong>Active Monitoring Checkpoints:</strong><br>• Lap 1 (Minute 23): Verify students accurately distinguish student Entry-Level ASE from professional ASE credentials.<br>• Lap 2 (Minute 30): Confirm students cite both an economic benefit and a limitation in their Jordan recommendation.</li></ul>''')
                    + flow("#e3ad19", "Minutes 35-43 - Independent practice: ASE and Training Route Quiz", '''<p>Students complete the 5-question retryable Canvas Practice Quiz: 'ASE and Training Route Check.'</p><ul><li>Review immediate feedback on items contrasting ASE work-experience rules and apprenticeship structures.</li></ul>''')
                    + flow("#1f617a", "Minutes 43-50 - Exit check and Week 5 folder storage", '''<p>Students record their Jordan recommendation on the exit slip and file their packet in their Week 5 folder.</p><ul><li><strong>Safe Trim:</strong> Trim whole-class case study review; fiercely protect the ASE credential boundary, 3-route matrix, Jordan defense, and Canvas Quiz completion.</li></ul>''')
                ),
            ...
            3: {
                ...
                "FLOW": (
                    flow("#5a2d91", "Minutes 0-5 - Welcome and specialty trade warm-up", '''<p>Welcome students, distribute the Three Occupations packet, and project the automotive specialty prompt.</p><ul><li>Ask students: <em>“In the automotive world, does the same technician who rebuilds a diesel semi-truck engine also straighten a bent car frame after a highway crash? Why are these distinct specialized trades?”</em></li><li>Collect 2-3 student thoughts: Different tools (hydraulic frame machines vs. heavy-duty engine hoists), different certifications (ASE Collision B-series vs. Medium/Heavy Truck T-series), different working environments.</li><li>Bridge with, <em>“Specialization drives modern transportation. Today we compare three major automotive occupations using May 2024 BLS labor data on an identical statistical basis.”</em></li></ul>''')
                    + flow("#4a9d2f", "Minutes 5-15 - Sourced labor data &amp; multi-variable career matrix modeling", '''<p>Guide students through the official BLS occupational profiles on the main display:</p><ul><li>1. <strong>Automotive Service Technician / Mechanic:</strong> May 2024 U.S. median pay: $49,670; 4% projected growth (about 70,000 annual openings). Typical entry: postsecondary nondegree award or high school + OJT. Diagnoses and repairs mechanical and electrical vehicle systems.</li><li>2. <strong>Diesel Service Technician / Mechanic:</strong> May 2024 U.S. median pay: $60,640; 2% projected growth (about 26,500 annual openings). Typical entry: high school + OJT or postsecondary certificate. Maintains heavy trucks, buses, construction equipment, and diesel powerplants.</li><li>3. <strong>Automotive Body &amp; Collision Repairer:</strong> May 2024 U.S. median pay: $51,680; 2% projected growth (about 16,000 annual openings combined with glass repairers). Typical entry: high school + OJT or certificate. Straightens structural frames, replaces welded panels, refinishes paint.</li><li>Highlight the Data Standard: All salaries are May 2024 national medians; none represent DFW entry-level or master technician pay.</li></ul>''')
                    + flow("#1f617a", "Minutes 15-35 - Independent three-career comparative analysis sprint", '''<p>Students complete the 3-Career Comparative Matrix in their packet:</p><ul><li>Document Daily Work Tasks: Record 2 distinct, realistic daily duties for each trade.</li><li>Record Labor Market Data: Log May 2024 U.S. median annual wage, projected 10-year growth percentage, and annual openings with complete statistical attribution.</li><li>Document Training Requirements &amp; Physical Demands: Record typical education, ASE specialty test series, and workplace physical constraints.</li><li><strong>Active Monitoring Checkpoints:</strong><br>• Lap 1 (Minute 22): Verify students write complete statistical labels: 'May 2024 U.S. Median Wage' (not local starting pay).<br>• Lap 2 (Minute 30): Check that students differentiate daily tasks (e.g., frame realignment vs. diesel emissions diagnosis).</li></ul>''')
                    + flow("#e3ad19", "Minutes 35-43 - The Tradeoff Recommendation &amp; local inquiry question", '''<p>Students author an evidence-based recommendation for a student deciding between diesel and collision repair:</p><ul><li>Cite 1 sourced pay fact and 1 working condition trade-off.</li><li>Draft ONE question to ask an Irving ISD CTE counselor about local automotive course offerings.</li></ul>''')
                    + flow("#1f617a", "Minutes 43-50 - Exit check and Week 5 folder storage", '''<p>Students record their recommendation on an exit slip and store their matrix in their Week 5 folder.</p><ul><li><strong>Safe Trim:</strong> Shorten class discussion; fiercely protect the complete 3-career matrix, BLS data labels, trade-off recommendation, and folder retention.</li></ul>''')
                ),
            ...
            4: {
                ...
                "ALERT": "<strong>Use the FYF workbook and the right current source for the right job.</strong> FYF supplies the student-facing program names. The current district page confirms the broader offering and campuses. The current coursebook, counselor, or CTE program confirms enrollment logistics.",
                ...
                "FLOW": (
                    flow("#5a2d91", "Minutes 0-5 - Welcome and high school to career transition warm-up", '''<p>Welcome students, seat them with devices or the Route Decision guide, and project the Irving CTE prompt.</p><ul><li>Ask students: <em>“If you decide in eighth grade that you want to be an automotive or diesel technician, does that mean you have to wait until you are 20 years old and graduate from college before you can touch a professional scan tool or work on a real engine?”</em></li><li>Collect 2-3 student thoughts: Irving ISD high schools offer direct career training during grades 9-12!</li><li>Bridge with, <em>“Irving ISD provides incredible automotive pathway opportunities. Today we audit local high school CTE options across our four high schools, examine Tarrant County College programs, and evaluate real-world training decisions.”</em></li></ul>''')
                    + flow("#4a9d2f", "Minutes 5-15 - Irving ISD automotive pathways &amp; TCC postsecondary modeling", '''<p>Guide students through the district and college reference data on the main display:</p><ul><li>Irving ISD High School Automotive Offerings (FYF pp. 168-169 &amp; Coursebook):<br>• <strong>Automotive Technology:</strong> Available across Irving high schools (including Nimitz, Irving, MacArthur, and Cardwell). Covers steering, brakes, electrical, engine diagnostics.<br>• <strong>Collision Repair:</strong> Specialized metal shaping, frame alignment, and refinishing labs.<br>• <strong>Diesel &amp; Heavy Equipment Technology:</strong> Commercial transport, hydraulics, and heavy machinery systems.</li><li>Postsecondary Spotlight - Tarrant County College (TCC) Example:<br>• <strong>General Service Technician Award:</strong> 12 college credit hours, ~$888 estimated 2026-27 in-county tuition (excluding books/supplies). Fast credential for quick entry.<br>• <strong>Automotive Service Technology AAS Degree:</strong> 60 credit hours, ~$4,440 estimated in-county tuition. Comprehensive 2-year college degree leading toward master technician status.</li><li>Caution: Tuition rates apply to in-county residents and exclude tools/materials; always verify current rates with a college advisor.</li></ul>''')
                    + flow("#1f617a", "Minutes 15-35 - Route decision analysis sprint &amp; Morgan case study", '''<p>Students analyze the postsecondary options in their packet:</p><ul><li>Compare High School CTE, TCC Fast-Track Certificate, TCC AAS Degree, and Registered Apprenticeship.</li><li>Solve the Fictional Morgan Case Study: Morgan wants to become an ASE-certified master technician at a dealership and wants college credits that can count toward a future management degree. Which route should Morgan pursue, and what initial action must Morgan take in 9th grade?</li><li>Draft ONE formal verification question to bring to a high school endorsement planning session.</li><li><strong>Active Monitoring Checkpoints:</strong><br>• Lap 1 (Minute 23): Verify students record accurate TCC tuition estimates with 'in-county tuition only' qualifiers.<br>• Lap 2 (Minute 30): Confirm students cite both college credit transferability and ASE exam preparation in the Morgan case.</li></ul>''')
                    + flow("#e3ad19", "Minutes 35-43 - Independent practice: What Does This Source Prove? Quiz", '''<p>Students complete the 5-question Canvas Practice Quiz: 'What Does This Source Prove?'</p><ul><li>Assess understanding of source limitations, tuition exclusions, and program prerequisites.</li></ul>''')
                    + flow("#1f617a", "Minutes 43-50 - Exit check and Week 5 folder storage", '''<p>Students record their counselor verification question on an exit slip and store their packet in their Week 5 folder.</p><ul><li><strong>Safe Trim:</strong> Trim whole-class case review; fiercely protect the local Irving pathway table, TCC tuition boundaries, Morgan defense, and Canvas Quiz completion.</li></ul>''')
                ),
                "MONITOR": '<ul><li><strong>CFU at minute 10:</strong> students sort one FYF workbook program name, one current-campus fact, and one unresolved logistics question. If fewer than four of five sampled responses separate them, model the Dani non-example.</li><li><strong>Lap 1, minutes 17-24:</strong> check that missing schedule, transportation, eligibility, and credit details read <strong>not confirmed</strong>, not guessed.</li><li><strong>Lap 2, minutes 30-37:</strong> look for two facts tied to Dani’s low-cost, hands-on, and possible-credit priorities. Prompt: “Which priority does this fact answer?”</li><li><strong>Pivot:</strong> if one-third guarantee admission or credit, pause and have students underline the exact source language before revising.</li><li><strong>Trim:</strong> omit live-site navigation and the full six-row logistics audit. Protect the individual Dani recommendation and exact authorized-source question.</li></ul>',
                ...
                "SUPPORT": "<p>Keep the FYF workbook images, word bank, and full frame visible. Chunk by route. The fallback gives multi-sentence reasoning a full-width block.</p>",
                "FALLBACK": "<p>The embedded FYF workbook pages and two-page fallback are complete when sites fail. Do not print the fallback by default. No private-school search is required. At minute 45, students submit the Quiz or place the fallback in the tray; unresolved work returns to the same Quiz.</p>",
            },
            5: {
                "TITLE": "Automotive Evidence Brief",
                ...
                "FLOW": (
                    flow("#5a2d91", "Minutes 0-5 - Welcome and automotive evidence synthesis warm-up", '''<p>Welcome students, return their Days 1-4 evidence packets, and project the Minor 3 prompt.</p><ul><li>Ask students: <em>“If a collision shop manager tells an insurance adjuster, 'This car needs $8,000 of repairs because my gut tells me it's broken,' will the insurance company approve the payment? What does the adjuster demand before paying a single dollar?”</em></li><li>Collect 2-3 student thoughts: Line-item repair estimates, photographic evidence, diagnostic scanner readouts, OEM procedure sheets.</li><li>Bridge with, <em>“Today is Minor 3: The Automotive Evidence Brief! You will synthesize your Crash Crew inspection evidence, ASE credential rules, BLS labor data, and training route evaluations into a 4-page executive brief.”</em></li></ul>''')
                    + flow("#4a9d2f", "Minutes 5-13 - Deconstructing the 16-point Minor 3 rubric &amp; writing sections", '''<p>Display the 16-Point Minor 3 Rubric and review the four required evidence sections:</p><ul><li>Section 1: <strong>Visible Damage &amp; Diagnostic Teardown (4 pts):</strong> Describes 4 visible damage points, 3 diagnostic questions, and explains the ADAS sensor calibration challenge.</li><li>Section 2: <strong>ASE Credentials &amp; Work-Experience Rules (4 pts):</strong> Explains the exact distinction between student Entry-Level and professional ASE certification, including the 2-year work experience rule.</li><li>Section 3: <strong>Three-Career Labor Data Comparison (4 pts):</strong> Compares Automotive, Diesel, and Collision repairers using May 2024 BLS medians and full statistical labels.</li><li>Section 4: <strong>Training Route Recommendation &amp; Verification (4 pts):</strong> Recommends a viable training route (OJT, Apprenticeship, or College) citing cost/benefit trade-offs and includes a verified counselor question.</li><li>Review the 16-point rubric scoring bands (Masters 15-16, Meets 13-14, Approaches 12, Needs Improvement 10-11).</li></ul>''')
                    + flow("#1f617a", "Minutes 13-38 - Independent Minor 3 Evidence Brief authoring sprint", '''<p>Students synthesize their evidence into the 4-Page Evidence Brief (Canvas Assignment or paper):</p><ul><li>Chunk 1 (Minutes 13-20): Section 1 - Crash Crew Evidence &amp; ADAS Sensor Recalibration.</li><li>Chunk 2 (Minutes 20-27): Section 2 - ASE Credential Boundaries &amp; Experience Invariants.</li><li>Chunk 3 (Minutes 27-33): Section 3 - Three-Career BLS Salary &amp; Outlook Comparison.</li><li>Chunk 4 (Minutes 33-38): Section 4 - Training Pathway Recommendation &amp; Counselor Question.</li><li><strong>Active Monitoring Checkpoints:</strong><br>• Lap 1 (Minute 19): Verify students cite exact May 2024 BLS figures with complete national median labels.<br>• Lap 2 (Minute 31): Confirm students distinguish student Entry-Level ASE from professional master credentials.</li></ul>''')
                    ...
                    + flow("#1f617a", "Minutes 44-50 - Submit Minor 3 and 4SW Week 5 wrap-up", '''<p>Students submit their completed Evidence Brief in Canvas or hand in paper packets.</p><ul><li>Congratulate students on mastering Automotive Systems &amp; Evidence-Based Planning!</li><li><strong>Safe Trim:</strong> Eliminate student presentations; fiercely protect all four evidence sections, rubric self-audit, and private submission.</li></ul>''')
                ),
