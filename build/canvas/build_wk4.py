...
async def main():
    ...
    async with httpx.AsyncClient(headers={"Authorization":f"Bearer {token}"},timeout=120) as c:
        ...
        files["X_SKILLS"]=await find_file(c,"about-me.pdf")
        uploads={}; folders={}
        ...
        teacher_data={
          1:{
            "TITLE":"IT Support Careers and Interest Connections",
            "SUBTITLE":"50 minutes - TEKS d(1)(C), d(2)(A)",
            "ALERT":"<strong>No Xello completion is required today.</strong> H&amp;L is optional exploration; the fixed career cards and individual check carry the complete learning evidence.",
            "PREP":f'<ul><li>For every two students, print one <a href="/courses/{COURSE_ID}/files/{files["CARDS"]["id"]}/preview">IT Support Career Cards</a> packet. Print one <a href="/courses/{COURSE_ID}/files/{files["D1"]["id"]}/preview">career/interest check</a> per student.</li><li>Open FYF pp. 36 and 38. Do not print the workbook pages unless an accommodation requires it.</li><li>If offering H&amp;L after the fixed evidence, verify the live pathway and Hat titles. No rating, favorite, or profile edit is required.</li></ul>',
            ...
            "EVIDENCE":"<p>Required evidence is the two-career comparison and interest-to-task connection on the Day 1 check. H&amp;L navigation, favorites, ratings, and profile state are not graded.</p>",
            "FLOW":flow("#5a2d91","Technology-help warm-up - 5 minutes","Name the problem, helper, and diagnostic action.")+flow("#4a9d2f","Four-role evidence comparison - 35 minutes","Mark all four cards, compare two roles, and use an accurate task and preparation fact.")+flow("#e3ad19","Career-interest evidence - 10 minutes","Choose one role, connect a current interest to a specific duty, and submit the check."),
            "TRIM":"<p>Move every student to the individual check at minute 40. Trim optional H&amp;L browsing and the whole-class share first; do not trim the fixed career evidence or written connection. Use the last minute to collect checks.</p>",
            "MONITOR":"<p><strong>Lap 1 target:</strong> students mark a task, preparation, and skill rather than three tasks. <strong>Lap 2 target:</strong> preparation language keeps qualifiers such as “common,” “may,” and “some employers.” If several students turn the card into a guarantee, pause and reproject the exact preparation sentence. Help Desk covers first-line tickets and escalation; Desktop Support emphasizes setup and repair; Systems Administration carries wider system responsibility.</p>",
            ...
            "FALLBACK":"<p>The career cards replace H&amp;L completely. Students complete the reflection with a current interest they can name now. An absent student completes the same cards and check; no profile edit or platform catch-up is required.</p>"},
          2:{
