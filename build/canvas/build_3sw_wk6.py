...
async def main():
    ...
    async with httpx.AsyncClient(headers={"Authorization": f"Bearer {token}"}, timeout=120) as client:
        ...
        teacher = {
            ...
            5: {"TITLE": "Build, Test, and Revise a Personal Budget", "SUBTITLE": "50 minutes · TEKS d(3)(I), d(5)(D)", "ALERT": "<strong>Use the fixed Dallas County scenario.</strong> Protect the first budget, revised budget, percentage check, revenue distinction, and decision reflection. No Xello task or screenshot is required.", "PREP": f'<ul><li>Post {file_link(files["COST"]["id"], "the dated cost guide")}, {file_link(files["BUDGET"]["id"], "the budget plan")}, and {file_link(files["RUBRIC"]["id"], "the recovery rubric")}.</li><li>Print one budget plan per assigned paper student and supply one cost guide and calculator per pair.</li><li>Ask students to open Entry 3 of the CCE Six-Weeks Evidence Log. Do not collect it.</li></ul>', "EVIDENCE": "<p>Balanced first and revised budgets, percentage calculation, revenue distinction, and decision reflection. The 16-point portfolio is recovery or replacement evidence only; it is not a third automatic Major.</p>", "FLOW": flow("#5a2d91", "Source labels · 5", "Place, household, date, measure.") + flow("#4a9d2f", "First budget · 15", "Enter categories and total the initial plan.") + flow("#1f617a", "Revise and test · 15", "Lifestyle choice, revised total, percentage check.") + flow("#e3ad19", "Explain · 10", "Tradeoff, flexible expense, revenue distinction.") + flow("#606c76", "Submit and Entry 3 · 5", "Submit once; keep the log student-owned."), "MONITOR": "<p>Lap 1 checks the four source labels and first total. Lap 2 checks a revised total of $3,450 or less plus the percentage calculation and revenue/personal-income distinction. At minute 40, every student should have a decision reflection and one fact to verify. Trim whole-group sharing before any budget reasoning or the five-minute submission window.</p>", "RESOURCES": '<p><a href="https://livingwage.mit.edu/counties/48113">MIT Dallas County source</a> · <a href="https://www.dallascollege.edu/research/reports/living-wages-community-college/">Dallas College 2026 brief</a></p>', "SUPPORT": "<p>Use calculator, read-aloud, chunked table, speech-to-text, or audio. The print packet gives separate cells for calculations and full-width lines for each explanation.</p>", "FALLBACK": "<p>The fixed cost guide and paper or Canvas budget plan are the complete routes. H&amp;L salary is not required.</p>"},
        }
