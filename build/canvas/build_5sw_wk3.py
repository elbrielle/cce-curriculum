...
STUDENT_WORKSHEET_COPY_URLS = {
    (1, 'the three-page construction career packet'): "https://docs.google.com/document/d/1Hx54IFo_voA5UYZ7TwThfpOJc2PStZ9ZzvngrEOpjOQ/copy",
    (2, 'the four-page routes and organizations packet'): "https://docs.google.com/document/d/1TWnZ48J8SD1UQ6LgXrFW27X0Y8XeasAPBK5h-QhGVkY/copy",
    (3, 'the four-page labor classification packet'): "https://docs.google.com/document/d/1zk5HVB03SWqOlDziZDEJDB77wMUo9XtfbOmocjQfWB0/copy",
    (4, 'the shared five-page evidence report'): "https://docs.google.com/document/d/1IBhmft8gxt7K4t4vOTlfM3k7insLKbt0NmfOYvBoClo/copy",
    (5, 'the shared five-page evidence report'): "https://docs.google.com/document/d/1IBhmft8gxt7K4t4vOTlfM3k7insLKbt0NmfOYvBoClo/copy",
}
    ...
    async with httpx.AsyncClient(headers={"Authorization": f"Bearer {token}"}, timeout=120) as client:
        ...
        student = {
            ...
            4: {
                ...
                "TODAY": "<ul><li>inspect five images;</li><li>record visible clues;</li><li>state a possible concern without diagnosing;</li><li>name the next qualified role.</li></ul>",
        ...
        teacher = {
            1: {
                ...
                "FLOW": (
                    flow("#315f4c", "Minutes 0-5 - Welcome and skilled trades value warm-up", '''<p>Welcome students to Week 3 of 5SW (Construction Careers) and project the skilled trades prompt.</p><ul><li>Ask students: <em>“When a high-rise hospital or residential neighborhood is built, why can't a single contractor do all the work? What is the difference in daily work between a carpenter framing exterior walls, an electrician wiring a three-phase breaker box, and a general construction manager directing the entire site?”</em></li><li>Collect 2-3 student thoughts: Specialization, distinct safety codes, licensing, and trade tools!</li><li>Bridge with, <em>“The construction sector represents hundreds of specialized career paths. Today we examine four core construction occupations, explore MacArthur High School's School of ACE Construction pathway, and complete our Career Preparation Evidence Card.”</em></li></ul>''')
                    + flow("#4c8b38", "Minutes 5-15 - Sourced labor data, MacArthur ACE pathway &amp; career cards", '''<p>Guide students through official BLS occupational profiles and local pathways on the main display:</p><ul><li>1. <strong>Electrician:</strong> May 2024 U.S. median pay: $61,590; 11% projected growth (high demand). Typical entry: 4-5 year Registered Apprenticeship + state journeyman license.</li><li>2. <strong>Carpenter:</strong> May 2024 U.S. median pay: $56,100; 1% projected growth. Typical entry: Apprenticeship or long-term on-the-job training (OJT).</li><li>3. <strong>Construction Manager:</strong> May 2024 U.S. median pay: $104,900; 8% projected growth. Typical entry: Bachelor's degree in construction management or engineering.</li><li>4. <strong>Construction Laborer:</strong> May 2024 U.S. median pay: $43,800; 4% projected growth. Typical entry: Short-term on-the-job training; entry portal to skilled trades.</li><li>Local CTE Connection: Review MacArthur High School's Construction sequence: Principles of Construction &rarr; Construction I &rarr; Construction II &rarr; Practicum in Construction, with Revit Architecture credentialing and TSA competitions.</li><li>Model Evidence Card Entries: Separate observable daily duties from formal licensing and preparation requirements.</li></ul>''')
                    + flow("#8a4f2b", "Minutes 15-35 - Construction career evidence mapping sprint", '''<p>Students analyze the four construction career cards in their guide (or Canvas):</p><ul><li>Record Work Duties, Educational Requirements, May 2024 U.S. Medians, and Growth Rates for all 4 careers.</li><li>Document Licensing &amp; Safety Boundaries: Identify which trade requires a state-issued license (Electrician - TDLR Journeyman) vs. OJT.</li><li>Evaluate Irving ISD High School Pathway: Identify the course prerequisites for entering Practicum in Construction at MacArthur.</li><li><strong>Active Monitoring Checkpoints:</strong><br>• Lap 1 (Minute 22): Ensure students write complete BLS statistical labels: 'May 2024 U.S. Median Wage.'<br>• Lap 2 (Minute 30): Confirm students distinguish between college-degree management roles and apprenticeship-based skilled trades.</li></ul>''')
                    + flow("#d39b22", "Minutes 35-43 - Personal trade reflection &amp; elbow partner check", '''<p>Elbow partners compare their career cards for accuracy:</p><ul><li>Students record which trade they would personally shadow for a week and explain one technical tool or skill they want to learn.</li></ul>''')
                    + flow("#315f4c", "Minutes 43-50 - Exit check and Week 3 evidence folder storage", '''<p>Students submit their private Canvas response and store their career card in their Week 3 folder.</p><ul><li><strong>Safe Trim:</strong> Shorten partner discussion; fiercely protect the 4 career profiles, TDLR licensing note, MacArthur pathway sequence, and private exit.</li></ul>''')
                ),
            ...
            2: {
                ...
                "FLOW": (
                    flow("#315f4c", "Minutes 0-5 - Welcome and earn-while-you-learn warm-up", '''<p>Welcome students, seat them with devices or the 3-page reference guide, and project the postsecondary debt prompt.</p><ul><li>Ask students: <em>“What is the difference between taking out $40,000 in student loans to attend a 4-year university versus entering a federally Registered Apprenticeship where an employer pays your tuition and pays you a living wage while you train?”</em></li><li>Collect 2-3 student thoughts: Debt-free career entry, guaranteed wage increases as skills grow, and industry-recognized credentials!</li><li>Bridge with, <em>“Postsecondary education includes multiple high-value routes. Today we compare a DOL Registered Apprenticeship with a Dallas College Construction Technology program, and distinguish four types of industry organizations.”</em></li></ul>''')
                    + flow("#4c8b38", "Minutes 5-15 - Apprenticeship vs. college &amp; four organization types", '''<p>Deconstruct Postsecondary Routes and Industry Organizations on the screen:</p><ul><li>1. <strong>U.S. Dept. of Labor (DOL) Registered Apprenticeship:</strong> 4-5 years, 8,000 hours of paid on-the-job training + 576 hours of classroom instruction. Zero tuition debt; earn a nationally recognized Journeyworker credential.</li><li>2. <strong>Dallas College Construction Technology (AAS / Certificate):</strong> 60-credit Associate of Applied Science or 1-year Level 1 Certificate. Classroom labs, college credits, financial aid eligible; prepares students for supervisory or estimator roles.</li><li>3. <strong>Four Industry Organization Types:</strong><br>• <strong>Labor Union (e.g., IBEW):</strong> Collective bargaining, worker benefits, joint apprenticeship training trusts (JATC).<br>• <strong>Trade Association (e.g., NAHB, AGC):</strong> Contractor and employer network, advocacy, business standards.<br>• <strong>Student Organization - CTSO (e.g., TSA, SkillsUSA):</strong> School-based leadership, skill contests.<br>• <strong>Government Regulatory Body (e.g., OSHA, TDLR):</strong> Workplace safety laws, state licensing.</li></ul>''')
                    + flow("#8a4f2b", "Minutes 15-35 - Route comparison &amp; organization audit sprint", '''<p>Students analyze the two postsecondary pathways and four organization cards:</p><ul><li>Part 1: Document 3 Step-by-Step Application Steps for a Registered Apprenticeship (Age 18, HS diploma/GED, algebra proficiency, aptitude test, interview).</li><li>Part 2: Document 3 Step-by-Step Enrollment Steps for Dallas College (ApplyTexas, high school transcript, TSIA2 placement, financial aid/FAFSA).</li><li>Part 3: Classify IBEW, NAHB, TSA, and OSHA into their correct organization types and describe one specific career benefit of each.</li><li><strong>Active Monitoring Checkpoints:</strong><br>• Lap 1 (Minute 22): Check that students identify algebra and age requirements for apprenticeship entry.<br>• Lap 2 (Minute 30): Verify students distinguish OSHA (government safety regulation) from a union or trade club.</li></ul>''')
                    + flow("#d39b22", "Minutes 35-43 - Marcus scenario recommendation", '''<p>Students evaluate the fictional Marcus case study:</p><ul><li>Marcus wants to become a master electrician, wants zero college debt, and wants to buy a work truck within three years. Which pathway should Marcus choose? Defend citing 2 concrete facts from today's evidence.</li></ul>''')
                    + flow("#315f4c", "Minutes 43-50 - Submit Day 2 Evidence and wrap-up", '''<p>Students submit their completed route comparison in Canvas or file paper packets.</p><ul><li><strong>Safe Trim:</strong> Shorten Marcus scenario review; fiercely protect both application sequences, the 4-organization classification, and private submission.</li></ul>''')
                ),
            ...
            3: {
                ...
                "FLOW": (
                    flow("#315f4c", "Minutes 0-5 - Welcome and labor classification rules warm-up", '''<p>Welcome students, seat them with devices or the 3-page reference guide, and project the labor classification prompt.</p><ul><li>Ask students: <em>“When economists and career counselors label an occupation 'high-wage' or 'high-demand,' what exact numbers are they using to make that claim? Can a career be high-demand if national growth is only 2%, or does that require specific data?”</em></li><li>Collect 2-3 student thoughts: You need clear mathematical benchmarks: above median wage ($49,500) and above average job growth (3.1%)!</li><li>Bridge with, <em>“Today is Minor 3: Construction Labor-Evidence Classification! We apply our transparent 3-factor classification rule to four construction careers using official May 2024 BLS labor data.”</em></li></ul>''')
                    + flow("#4c8b38", "Minutes 5-15 - Sourced BLS labor benchmarks &amp; Minor 3 rubric", '''<p>Display the Course Classification Benchmarks on the main screen:</p><ul><li>1. <strong>National Median Wage Benchmark:</strong> $49,500 (May 2024 all-occupations U.S. median). Above $49,500 = High-Wage.</li><li>2. <strong>National Job Growth Benchmark:</strong> 3.1% (2024-34 all-occupations projected growth). Above 3.1% = High-Demand.</li><li>3. <strong>High-Skill Benchmark:</strong> Requires formal apprenticeship, postsecondary certificate/degree, or state license/credential.</li><li>Deconstruct the 4 Scored Careers:<br>• <strong>Construction Manager:</strong> Median: $104,900 (High-Wage), Growth: 8% (High-Demand), Bachelor's Degree (High-Skill) &rarr; Triple Qualified.<br>• <strong>Electrician:</strong> Median: $61,590 (High-Wage), Growth: 11% (High-Demand), 4-5 yr Apprenticeship/License (High-Skill) &rarr; Triple Qualified.<br>• <strong>Carpenter:</strong> Median: $56,100 (High-Wage), Growth: 1% (Below benchmark), Apprenticeship/OJT (High-Skill) &rarr; High-Wage &amp; High-Skill.<br>• <strong>Construction Laborer:</strong> Median: $43,800 (Below benchmark), Growth: 4% (High-Demand), Short OJT &rarr; High-Demand.</li><li>Deconstruct the 16-Point Minor 3 Rubric across the four evidence sections.</li></ul>''')
                    + flow("#8a4f2b", "Minutes 15-37 - Independent Minor 3 Classification sprint", '''<p>Students complete their Minor 3 Assessment in Canvas (or 3-page packet):</p><ul><li>Section 1: Record May 2024 BLS medians and 2024-34 growth rates with explicit statistical source labels.</li><li>Section 2: Apply the 3-Factor Classification Matrix (Skill, Wage, Demand) to all four construction occupations.</li><li>Section 3: Analyze the Annual Openings Limitation: Explain why annual openings (which include retirements/job transfers) do not prove a local shortage by themselves.</li><li>Section 4: Author an Evidence-Based Career Recommendation for a student seeking high-wage, high-demand skilled trade employment.</li><li><strong>Active Monitoring Checkpoints:</strong><br>• Lap 1 (Minute 22): Verify students apply the $49,500 and 3.1% thresholds accurately.<br>• Lap 2 (Minute 31): Confirm students explain why Carpenter is high-wage but not high-demand under national projections.</li></ul>''')
                    + flow("#d39b22", "Minutes 37-45 - Rubric self-score and targeted revision", '''<p>Students self-evaluate their Minor 3 submission against the 16-point rubric:</p><ul><li>Self-score each section and execute a 2-minute revision to elevate the evidence in their lowest-scoring part.</li><li>Teacher provides targeted writing support to students with accommodations.</li></ul>''')
                    + flow("#315f4c", "Minutes 45-50 - Submit Minor 3 in Canvas", '''<p>Students submit their completed Minor 3 in Canvas or hand in paper packets.</p><ul><li>Congratulate students on completing Minor 3!</li><li><strong>Safe Trim:</strong> Skip whole-class debrief; fiercely protect all 4 classification rows, annual openings analysis, rubric self-audit, and private submission.</li></ul>''')
                ),
            ...
            4: {
                ...
                "FLOW": (
                    flow("#315f4c", "Minutes 0-5 - Welcome and building inspection observation warm-up", '''<p>Welcome students, seat them with devices or observation packets, and project the visual evidence prompt.</p><ul><li>Ask students: <em>“If a home inspector photographs a large water stain on an acoustic ceiling tile, does that photograph prove that the roof is leaking, or could the stain be caused by an overflowing upstairs bathtub, condensation from an uninsulated AC duct, or a leaking plumbing pipe?”</em></li><li>Collect 2-3 student thoughts: The photograph proves only that moisture contacted the tile; determining the cause requires diagnostic inspection!</li><li>Bridge with, <em>“Professional inspection begins with objective visual evidence. Today we examine five photographic problem cases and one thermal infrared scan on FYF p. 178, adhering strictly to our 4-part evidence structure.”</em></li></ul>''')
                    + flow("#4c8b38", "Minutes 5-13 - The 4-Part Evidence Protocol &amp; thermal camera boundaries", '''<p>Display the 4-Part Objective Documentation Protocol on the screen:</p><ul><li>1. <strong>I Observe:</strong> Describe ONLY visible physical facts (e.g., 'cracked concrete mortar line measuring 0.5 cm wide'). Never use emotional or speculative language.</li><li>2. <strong>This Could Indicate:</strong> State one plausible hypothesis (e.g., 'foundation settlement or expansive soil movement').</li><li>3. <strong>Evidence Limit:</strong> Explicitly state what the photograph CANNOT prove (e.g., 'this photo does not prove whether the crack is active, historical, or structurally dangerous').</li><li>4. <strong>Next Qualified Role:</strong> Identify the licensed specialist required to evaluate the issue (e.g., 'Licensed Structural Engineer' or 'Master Plumber').</li><li>Analyze FYF p. 178 Thermal Imaging: Thermal cameras detect surface temperature differentials, not 'see through walls' or detect moisture directly. Hot/cold spots must be corroborated by physical moisture meters.</li></ul>''')
                    + flow("#8a4f2b", "Minutes 13-38 - Five Problem Images &amp; Thermal Scan analysis sprint", '''<p>Students analyze the 5 photographic exhibits and thermal comparison on FYF p. 178:</p><ul><li>Image 1: Exterior foundation stair-step masonry crack &rarr; Observe, hypothesis, limit, structural engineer.</li><li>Image 2: Attic blown insulation with gap around can light &rarr; Observe, heat loss hypothesis, limit, insulation contractor.</li><li>Image 3: Double-tapped circuit breaker inside electrical panel &rarr; Observe, fire hazard hypothesis, limit, licensed master electrician.</li><li>Image 4: Corroded copper P-trap beneath commercial sink &rarr; Observe, pinhole leak hypothesis, limit, licensed plumber.</li><li>Image 5: Flashing gap where roof meets chimney brick &rarr; Observe, water intrusion hypothesis, limit, licensed roofing contractor.</li><li>FYF p. 178 Thermal Image: Document temperature gradient and state the physical corroboration requirement.</li><li><strong>Active Monitoring Checkpoints:</strong><br>• Lap 1 (Minute 21): Check that 'I Observe' contains zero diagnostic guesses (e.g., no 'broken pipe'—only 'water pool on concrete').<br>• Lap 2 (Minute 32): Confirm students identify licensed trade specialists for every finding.</li></ul>''')
                    + flow("#d39b22", "Minutes 38-45 - Collaborative evidence cross-check", '''<p>Partners cross-check their 5 findings against the objective evidence standard:</p><ul><li>Check that every image includes an explicit statement of what the image cannot prove.</li></ul>''')
                    + flow("#315f4c", "Minutes 45-50 - Day 4 evidence storage &amp; briefing preparation", '''<p>Students save their digital observation drafts or file packets in their Week 3 folder.</p><ul><li><strong>Safe Trim:</strong> Shorten partner cross-check; fiercely protect all 5 photographic analyses, thermal limit statement, and folder retention.</li></ul>''')
                ),
            ...
            5: {
                ...
                "FLOW": (
                    flow("#315f4c", "Minutes 0-5 - Welcome and technical communication warm-up", '''<p>Welcome students, seat them with their Day 4 observation records, and project the technical briefing prompt.</p><ul><li>Ask students: <em>“Why must an inspector or construction manager speak with extreme precision when briefing a property owner or general contractor? What happens if you exaggerate a small cosmetic crack into a 'structural collapse,' or minimize a dangerous electrical hazard as 'minor'?”</em></li><li>Collect 2-3 student thoughts: Misinformation leads to panic, unnecessary repair costs, or catastrophic electrical fires and lawsuits!</li><li>Bridge with, <em>“Technical professionals build trust through rigorous, objective communication. Today we polish our 5-finding inspection report and deliver our 30-45 second professional oral/AAC briefing using appropriate technology!”</em></li></ul>''')
                    + flow("#4c8b38", "Minutes 5-12 - Polishing the written report &amp; the 30-45s briefing structure", '''<p>Display the Professional Briefing Architecture on the screen:</p><ul><li>The 30-45 Second Structured Briefing Protocol (TEKS d(4)(C)):<br>1. <strong>Professional Introduction (5s):</strong> State your inspector role and identify the property location/finding.<br>2. <strong>Observable Fact (10s):</strong> State the objective visual evidence without exaggeration.<br>3. <strong>Potential Hazard &amp; Evidence Boundary (15s):</strong> Explain what the evidence indicates and what remains unverified.<br>4. <strong>Recommended Action &amp; Specialist Handoff (10s):</strong> Name the exact licensed professional who must perform diagnostic testing.</li><li>Equal Technology Presentation Modes: (1) In-person partner briefing, (2) Private Canvas audio/video recording, or (3) Speech-generating AAC device playback.</li></ul>''')
                    + flow("#8a4f2b", "Minutes 12-30 - Finalizing the 5-finding inspection report", '''<p>Students finalize their formal written inspection report on their worksheet (or Canvas):</p><ul><li>Review and polish all 5 findings: Ensure professional technical terminology and complete 4-part structure.</li><li>Incorporate the Thermal Camera Corroboration Statement.</li><li>Author the Executive Summary: Summarize the top 2 safety priorities requiring immediate contractor inspection.</li><li><strong>Active Monitoring Checkpoints:</strong><br>• Lap 1 (Minute 18): Verify executive summary highlights genuine safety hazards (e.g., electrical panel) over cosmetic issues.<br>• Lap 2 (Minute 26): Assist students preparing their 30-45 second spoken, recorded, or AAC script.</li></ul>''')
                    + flow("#d39b22", "Minutes 30-43 - Professional evidence briefing delivery (TEKS d(4)(C))", '''<p>Students deliver their 30-45 second professional briefings:</p><ul><li>Paired Briefings: Partner A briefs Partner B on Finding 3 (Electrical Panel) or Finding 1 (Foundation). Partner B acts as property owner, checks timing, and signs off on the briefing rubric. Roles swap.</li><li>Private Recording Option: Students utilizing digital recording or AAC devices record their 30-45 second brief directly into Canvas.</li></ul>''')
                    + flow("#315f4c", "Minutes 43-50 - Submit Formative Report &amp; Week 3 wrap-up", '''<p>Students submit their completed Evidence Report and Briefing verification in Canvas or hand in paper packets.</p><ul><li>Congratulate students on mastering construction trade evidence and professional communication!</li><li><strong>Safe Trim:</strong> Protect the written 5-finding report, executive summary, and 30-45s briefing sign-off; trim general debrief.</li></ul>''')
                ),
