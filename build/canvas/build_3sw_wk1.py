...
STUDENT_WORKSHEET_COPY_URLS = {
    (2, 'the Veterinary Career Comparison'): "https://docs.google.com/document/d/1EdW39WmFQ_K-TLCoeUVkXmTHw8LcsFWxRSZNhqc2-44/copy",
    (3, 'Veterinary Triage Evidence Record'): "https://docs.google.com/document/d/1890U0KdLFADq_P9Q5sW-ABirH8MWVpCMWzkMC9t5J8w/copy",
    (4, 'the private Transferable Skills Reflection'): "https://docs.google.com/document/d/1tV1chKD4oRBl797WsU8E0q8hskPTDACcQ8xRd3R1BCM/copy",
    (5, 'the Veterinary Pathway Recommendation'): "https://docs.google.com/document/d/1Y8rLXz38JTvTYZ5e2WZh_7h7yucd92qfG9v-_KylkUg/copy",
}
    ...
    async with httpx.AsyncClient(headers={"Authorization": f"Bearer {token}"}, timeout=120) as client:
        ...
        student = {
            1: {
                ...
                "READY": f'<p>Open your <em>Find Your Future</em> workbook to p. 87 and {file_link(files["CAREERS"]["id"], "the Veterinary Career Evidence Guide")}.</p>',
            ...
            3: {
                ...
                "FALLBACK": f'<p>All four activity pages are embedded. If the workbook is unavailable or you need a more structured layout, use the optional {student_copy_link(3, "Veterinary Triage Evidence Record")}. A private written response replaces discussion.</p>',
            },
            4: {
        ...
        teacher = {
            1: {
                ...
                "FLOW": (
                    flow("#5a2d91", "Minutes 0-5 - Welcome and veterinary roles warm-up", '''<p>Welcome students to the Third Six Weeks (Agriculture, Food, and Natural Resources) and project the veterinary team launch prompt.</p><ul><li>Ask students: <em>“When an injured animal arrives at a veterinary clinic, who are all the different workers involved in that animal's care, and what specific tasks does each person handle?”</em></li><li>Collect 2-3 student thoughts. Guide students beyond 'just the doctor' to recognize the full veterinary clinical team: veterinary assistants, veterinary technicians, and veterinarians.</li><li>Bridge with, <em>“Animal healthcare requires specialized teamwork. Today we explore three distinct veterinary roles, analyze their required credentials, and select one role to investigate using labor market data.”</em></li></ul>''')
                    + flow("#4a9d2f", "Minutes 5-12 - FYF animal care and agriculture overview (p. 87)", '''<p>Direct students to FYF p. 87 and display the Animal Care &amp; Agriculture Career Cluster.</p><ul><li>Highlight the broad spectrum of occupations from clinical veterinary medicine to livestock management, animal breeding, and research laboratory care.</li><li>Emphasize that clinical skills build upon biological sciences, precise measurement, physical stamina, and careful observation.</li></ul>''')
                    + flow("#1f617a", "Minutes 12-26 - Reading fixed career evidence cards in chunks", '''<p>Distribute or project the Veterinary Career Evidence Guide and lead a structured two-chunk reading protocol:</p><ul><li><strong>Chunk 1 (Daily Duties &amp; Clinical Scopes - 7 min):</strong><br>• <em>Veterinary Assistant:</em> Sanitizes cages and surgical suites, restrains animals during examinations, monitors post-op feeding, prepares basic equipment under direct supervision.<br>• <em>Veterinary Technician:</em> Conducts clinical laboratory tests (bloodwork, urinalysis), takes and processes X-rays, administers prescribed medications and vaccines, monitors vital signs under anesthesia.<br>• <em>Veterinarian:</em> Examines patients, diagnoses medical illnesses, performs advanced surgical procedures, prescribes pharmaceuticals, advises clients on medical care.</li><li><strong>Chunk 2 (Education &amp; Sourced Labor Data - 7 min):</strong><br>• Highlight the strict credential gradient: High school diploma/on-the-job training (Assistant), Associate of Applied Science degree + VTNE credential (Technician), Doctor of Veterinary Medicine (DVM) degree + state licensure (Veterinarian).<br>• Enforce source integrity: Emphasize May 2024 U.S. median annual pay ($36,440 vs. $43,740 vs. $119,100).</li><li><strong>Active Monitoring Checkpoints:</strong><br>• Lap 1 (Minute 20): Check that students distinguish between technician laboratory duties and assistant sanitation/restraint duties.</li></ul>''')
                    + flow("#e3ad19", "Minutes 26-42 - Authoring the chosen-role response", '''<p>Students select ONE veterinary role that aligns best with their career interests and complete their Day 1 Evidence Sheet:</p><ul><li>1. State the chosen role clearly.</li><li>2. Cite ONE authentic daily clinical duty directly from the evidence card.</li><li>3. Document ONE exact educational preparation or licensing requirement.</li><li>4. Incorporate the May 2024 U.S. median salary with full statistical labels.</li><li><strong>Active Monitoring Checkpoints:</strong><br>• Lap 2 (Minute 34): Verify students keep the complete source label (May 2024, U.S., median) attached to every salary figure.</li></ul>''')
                    + flow("#4a9d2f", "Minutes 42-46 - Structured partner evidence check", '''<p>Students turn to an assigned elbow partner for a quick 4-minute evidence audit.</p><ul><li>Partner A reads their task and preparation statement aloud.</li><li>Partner B points directly to the exact line in the Veterinary Career Evidence Guide that verifies Partner A's cited facts (do not choose roles for each other).</li><li>Reverse roles after 2 minutes.</li></ul>''')
                    + flow("#1f617a", "Minutes 46-50 - Submit evidence and workspace reset", '''<p>Collect Day 1 sheets or verify digital entries in Canvas.</p><ul><li><strong>Safe Trim:</strong> Skip optional H&amp;L browsing and reduce partner check to a 1-fact verification; protect the chosen-role written response and reset.</li></ul>''')
                ),
            ...
            2: {
                ...
                "FLOW": (
                    flow("#5a2d91", "Minutes 0-5 - Welcome and career decision factors warm-up", '''<p>Welcome students, seat them with their Day 1 Evidence Guide, and project the decision ranking prompt.</p><ul><li>Ask students: <em>“Imagine a student loves working with animals but wants to begin earning an income within two years of high school graduation without taking on college debt. Which career factor matters most in this decision: starting wage, total years of school, or daily hands-on contact? Why?”</em></li><li>Hear 2-3 student perspectives. Frame the lesson: <em>“Every career path involves trade-offs. Today we construct a comprehensive 3-role comparison chart and recommend a pathway for fictional students based on labor facts.”</em></li></ul>''')
                    + flow("#4a9d2f", "Minutes 5-13 - Modeling statistical measures and preparation benchmarks", '''<p>Project the 6-row Veterinary Comparison Table and model the Veterinary Assistant column:</p><ul><li>Dissect the four critical labor market metrics:<br>1. <strong>May 2024 U.S. Median Pay:</strong> $36,440 (half earn more, half earn less; not starting pay).<br>2. <strong>Projected 2024-34 Growth:</strong> 19% (much faster than average).<br>3. <strong>Annual Projected Openings:</strong> ~19,800 openings per year.<br>4. <strong>Typical Preparation:</strong> High school diploma or equivalent + short-term on-the-job training.</li><li>Highlight the key concept: Fastest percentage growth does not always mean the highest raw number of openings.</li></ul>''')
                    + flow("#1f617a", "Minutes 13-35 - Independent three-role comparative data analysis", '''<p>Students complete all six comparison rows for Veterinary Technician and Veterinarian using the Evidence Guide:</p><ul><li>Verify accurate transcription: Vet Tech ($43,740 median, 19% growth, 14,800 openings, 2-year Associate Degree) vs. Veterinarian ($119,100 median, 19% growth, 4,500 openings, 4-year undergraduate + 4-year DVM degree).</li><li><strong>Active Monitoring Checkpoints:</strong><br>• Lap 1 (Minute 22): Check that students do NOT write 'DFW pay' or 'starting pay'—ensure labels say 'May 2024 U.S. median.'<br>• Lap 2 (Minute 30): Check annual openings—ensure students notice Veterinary Assistant actually has more annual openings than Veterinarian despite lower pay.</li></ul>''')
                    + flow("#e3ad19", "Minutes 35-46 - Fictional student pathway recommendation (Scenario A/B)", '''<p>Direct students to the fictional student scenarios on the Comparison Sheet:</p><ul><li><strong>Scenario A (Marcus):</strong> Needs to enter the workforce quickly with minimal tuition debt, prefers hands-on animal care and clinical teamwork.<br><strong>Scenario B (Elena):</strong> Excels in advanced biological sciences, is willing to invest 8 years in postsecondary education, and aims to lead surgical procedures and diagnostic clinics.</li><li>Students choose ONE scenario and draft a formal recommendation citing TWO accurate labor facts and ONE realistic trade-off (e.g., lower long-term earning ceiling vs. significant tuition debt and competitive veterinary school admission rates).</li></ul>''')
                    + flow("#1f617a", "Minutes 46-50 - Submit comparison and workspace reset", '''<p>Collect completed comparison sheets or verify Canvas submissions.</p><ul><li><strong>Safe Trim:</strong> Shorten peer verification checks; fiercely protect the 6-row data table, scenario recommendation with two facts and trade-off, and the five-minute reset.</li></ul>''')
                ),
            ...
            4: {
                ...
                "FLOW": (
                    flow("#5a2d91", "Minutes 0-5 - Welcome and transferable skills warm-up", '''<p>Welcome students and project the skills transfer launch prompt.</p><ul><li>Ask students: <em>“What does it mean when a skill is described as 'transferable'? Name ONE skill you use in school every week that a veterinary worker uses every single day on the job.”</em></li><li>Collect 2-3 student examples. Introduce the 5-Skill Bank: Observation, Communication, Problem Solving, Teamwork, and Organization.</li><li>Bridge with, <em>“While medical equipment is unique to clinics, the core cognitive and social powerskills that drive veterinary medicine are the exact same skills that drive technology, business, and aviation.”</em></li></ul>''')
                    + flow("#4a9d2f", "Minutes 5-23 - Connecting five core skills to veterinary tasks", '''<p>Display the Veterinary Task-to-Skill Evidence Matrix and analyze authentic clinical examples:</p><ul><li>1. <strong>Observation:</strong> Monitoring subtle post-surgical breathing patterns in recovering canines.</li><li>2. <strong>Communication:</strong> Explaining complex medication dosages and post-op care clearly and calmly to an anxious pet owner.</li><li>3. <strong>Problem Solving:</strong> Calibrating specialized IV drip rates when an animal exhibits dehydration.</li><li>4. <strong>Teamwork:</strong> Synchronizing surgical tool handoffs between the veterinary technician and lead surgeon during emergency procedures.</li><li>5. <strong>Organization:</strong> Logging surgical anesthesia charts and pharmaceutical inventories with zero documentation errors.</li><li>Model one complete transfer row: Show how <em>“Observation”</em> looks in veterinary anesthesia vs. how it looks for a Quality Assurance Software Tester.</li></ul>''')
                    + flow("#1f617a", "Minutes 23-43 - Independent two-career skill comparison", '''<p>Students select ONE transferable skill from the bank and author their private Transferable Skills Reflection:</p><ul><li>1. <strong>Define the Skill:</strong> Articulate what the skill means in observable behavioral terms.</li><li>2. <strong>Veterinary Work Application:</strong> Describe a concrete veterinary task where this skill is essential to patient survival or clinic safety.</li><li>3. <strong>Second Career Application:</strong> Select a completely different career (e.g., Construction Manager, Cybersecurity Analyst, Commercial Pilot) and describe how the exact same skill is applied.</li><li>4. <strong>Contrast &amp; Invariant:</strong> Explain what changes between the two jobs (tools, environment) and what core human thinking process remains identical.</li><li><strong>Active Monitoring Checkpoints:</strong><br>• Lap 1 (Minute 30): Check second-career selections; ensure students describe concrete WORK ACTIONS, not just restate job titles.</li></ul>''')
                    + flow("#e3ad19", "Minutes 43-47 - Private synthesis and middle school action DOL", '''<p>Students answer the closing application prompt:</p><ul><li>Identify ONE concrete action a middle school student can take this semester in their classes, clubs, or home responsibilities to strengthen this specific transferable skill.</li><li>Emphasize: Work is private and reflective; do not require public sharing of personal ratings.</li></ul>''')
                    + flow("#1f617a", "Minutes 47-50 - Submit reflection and workspace reset", '''<p>Verify Canvas reflection submission or collect paper reflection sheets.</p><ul><li><strong>Safe Trim:</strong> Provide pre-written veterinary task exemplars for students needing support; fiercely protect the two-career transfer comparison and personal growth action.</li></ul>''')
                ),
        ...
        teacher[3] = {
            ...
            "FLOW": (
                flow("#5a2d91", "Minutes 0-5 - Welcome and observation vs. diagnosis warm-up", '''<p>Welcome students and project the clinical ethics launch prompt.</p><ul><li>Ask, <em>“What is the essential difference between recording an objective medical observation and making a formal veterinary diagnosis? Give ONE concrete example of each.”</em></li><li>Collect 2-3 responses: Objective observation = <em>“The animal's heart rate is 150 bpm and gums are pale.”</em> Formal diagnosis = <em>“The animal has gastric dilatation-volvulus (bloat).”</em></li><li>Establish the professional role boundary: <strong>Veterinary technicians and triage teams record objective vital signs and prioritize urgent cases; only licensed veterinarians diagnose medical conditions and prescribe treatments.</strong></li></ul>''')
                + flow("#4a9d2f", "Minutes 5-13 - Reading patient clinical intake charts (Leo &amp; Barnaby)", '''<p>Open FYF pp. 96-97 and review the two patient intake profiles:</p><ul><li><strong>Leo (Reptile - Bearded Dragon):</strong> Dull, opaque skin patches, cloudy eyes, lethargic movement, normal body temperature for species.</li><li><strong>Barnaby (Canine - Great Dane):</strong> Pacing and anxiety, swollen and rigid abdomen, repeated unproductive retching, heart rate of 150 bpm, weak femoral pulse.</li><li>Remind students: Do NOT guess what disease they have; look closely at physical symptoms and distress levels.</li></ul>''')
                + flow("#1f617a", "Minutes 13-23 - Species vital-sign reference check (FYF p. 98)", '''<p>Direct students to the physiological reference table on FYF p. 98.</p><ul><li>Students compare Leo and Barnaby against their species-specific normal ranges:</li><li>Canine normal resting heart rate: 60-140 bpm (large breed normal is typically 60-100 bpm; Barnaby's 150 bpm is tachycardia).</li><li>Canine abdomen: Soft, non-painful on palpation (Barnaby is distended and acutely painful).</li><li>Reptile skin/eye condition: Cloudy eyes and patchy dull skin match normal periodic ecdysis (shedding).</li><li><strong>Active Monitoring Checkpoints:</strong><br>• Lap 1 (Minute 18): Intervene if students judge priority by animal size or scary appearance rather than physiological vital signs.</li></ul>''')
                + flow("#e3ad19", "Minutes 23-41 - Authoring the Triage Priority Decision (FYF p. 99)", '''<p>Students independently complete the clinical triage documentation on FYF p. 99:</p><ul><li>1. Document vital sign observations for both Leo and Barnaby.</li><li>2. Declare the first-priority emergency patient: <strong>Barnaby</strong>.</li><li>3. Defend the decision using at least TWO objective physiological anomalies (unproductive retching, acute distended abdomen, tachycardic heart rate 150, weak pulse).</li><li>4. Explain why Leo, while abnormal in appearance, is non-emergent (symptoms align with natural shedding).</li><li>5. Name the veterinary technician's work product: <strong>Patient Intake and Triage Assessment Record</strong>.</li><li><strong>Active Monitoring Checkpoints:</strong><br>• Lap 2 (Minute 33): Check that students cite exact numbers and symptoms, not vague phrases like 'he looks sicker.'</li></ul>''')
                + flow("#4a9d2f", "Minutes 41-46 - Practice check and formative quiz review", '''<p>Students open the retryable Canvas Veterinary Triage Quiz (or complete the structured paper check).</p><ul><li>Review formative feedback on questions 1-4. Address any confusion regarding species-specific vital ranges.</li></ul>''')
                + flow("#1f617a", "Minutes 46-50 - Submit triage report and workspace reset", '''<p>Confirm completion of FYF p. 99 and collect student work.</p><ul><li><strong>Safe Trim:</strong> If network issues occur, move the online practice quiz to an asynchronous warmup; fiercely protect the FYF p. 99 triage defense and role boundary.</li></ul>''')
            ),
        ...
        teacher[5] = {
            ...
            "FLOW": (
                flow("#5a2d91", "Minutes 0-5 - Welcome and fact vs. opportunity warm-up", '''<p>Welcome students, seat them with FYF pp. 100-101, and project the pathway claims prompt.</p><ul><li>Project three statements:<br>1. <em>“Nimitz High School offers an Animal Science pathway.”</em> (Fact)<br>2. <em>“Enrolling in high school Animal Science allows students to prepare for a Certified Veterinary Assistant (CVA) exam.”</em> (Opportunity)<br>3. <em>“Taking high school veterinary courses guarantees admission into Texas A&amp;M College of Veterinary Medicine.”</em> (False Guarantee)</li><li>Guide students to distinguish between verified school facts, legitimate educational opportunities, and unrealistic false guarantees.</li></ul>''')
                + flow("#4a9d2f", "Minutes 5-14 - Irving ISD Animal Science pathway evidence (FYF pp. 100-101)", '''<p>Read FYF pp. 100-101 closely and identify district CTE programming:</p><ul><li>Program Name: <strong>Animal Science</strong> (emphasize: do not rename or invent CTE titles).</li><li>High School Campus: Nimitz High School (home of the district veterinary science training facilities).</li><li>Credential Opportunity: Certified Veterinary Assistant (CVA) Level 1 credential upon completion of coursework and clinical hours.</li><li>Co-curricular Organization: FFA (Future Farmers of America) for leadership development, livestock projects, and veterinary science competitions.</li></ul>''')
                + flow("#1f617a", "Minutes 14-36 - Constructing the formal Veterinary Pathway Recommendation", '''<p>Students construct their 16-point Minor Evidence Packet (Pathway Recommendation):</p><ul><li>Section 1: <strong>Target Career &amp; Daily Role:</strong> Name the veterinary occupation and cite one primary clinical task.</li><li>Section 2: <strong>Labor Market Evidence:</strong> Record the May 2024 U.S. median salary and 2024-34 growth rate with full source attribution.</li><li>Section 3: <strong>High School CTE Foundation:</strong> Cite the Animal Science program at Nimitz High School and one concrete opportunity (e.g., CVA certification or FFA participation).</li><li>Section 4: <strong>Postsecondary Educational Transition:</strong> Specify the exact postsecondary requirement (e.g., 2-year AAS degree for Vet Tech or 4-year undergraduate degree + 4-year DVM for Veterinarian).</li><li>Section 5: <strong>Immediate Middle School Action Step:</strong> Formulate ONE realistic, controllable 8th-grade action (e.g., focusing on 8th-grade science grades, exploring high school endorsement options, volunteering at a local animal shelter).</li><li><strong>Active Monitoring Checkpoints:</strong><br>• Lap 1 (Minute 22): Check high school CTE program name—ensure students write 'Animal Science' exactly.<br>• Lap 2 (Minute 30): Verify sequence—middle school action &rarr; high school CTE &rarr; postsecondary credential.</li></ul>''')
                + flow("#e3ad19", "Minutes 36-46 - Four-criterion rubric self-audit and revision", '''<p>Students self-score their recommendation using the 16-point rubric across four criteria (4 pts each):</p><ul><li>1. Career &amp; Labor Evidence Accuracy.</li><li>2. Local High School Pathway Grounding (Animal Science at Nimitz).</li><li>3. Postsecondary Educational Alignment.</li><li>4. Sequential Feasibility &amp; Immediate Middle School Next Step.</li><li>Students revise any section scoring below 4 before final submission.</li></ul>''')
                + flow("#1f617a", "Minutes 46-50 - Submit Minor and workspace reset", '''<p>Collect completed two-page pathway recommendation packets or confirm Canvas submissions.</p><ul><li>Congratulate students on completing Week 1 of Agriculture, Food, and Natural Resources!</li><li><strong>Safe Trim:</strong> Conduct a focused teacher conference on a single rubric criterion instead of full oral shares; fiercely protect the 5-part pathway recommendation and rubric self-audit.</li></ul>''')
            ),
