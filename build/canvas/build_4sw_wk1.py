...
async def main():
    ...
    async with httpx.AsyncClient(headers={"Authorization": f"Bearer {token}"}, timeout=120) as client:
        ...
        teacher = {
            ...
            3: {"TITLE":"Xello Save Quick Sims","SUBTITLE":"50 minutes · TEKS d(5)(D)","ALERT":"<strong>Required Grade 7 task:</strong> protect Save quick sims. A completed sim contains a career, education, and at least one expense. Paper supports learning but does not count as completion.","PREP":f'<ul><li><strong>Devices:</strong> one per student. Test ClassLink &gt; Xello &gt; Home &gt; The Real Game in a demo account.</li><li>Open the Completion Standards report to <strong>Save quick sims</strong>. The task has no prerequisite.</li><li>Post {file_link(files["DEEP"]["id"], "the two-page Quick Sim Decision Record")} for the debrief and no-device learning support. Print only for the assigned paper route.</li><li>Prepare a private list for complete, incomplete, access issue, and absent. Do not collect screenshots or publish students&#39; financial choices.</li></ul>',"MODEL":'<p><strong>Three-action model:</strong> add a career, add education, and add at least one expense. Ask, “What changed after the education choice? What changed after the expense?” A valid tradeoff names both a benefit and a cost.</p>',"EVIDENCE":"<p>Verify one saved Quick sim in the Completion Standards report and check one short career-education-expense tradeoff explanation. Formative; the explanation feeds the Day 5 Blueprint.</p>","FLOW":flow("#5a2d91","Warm-up and launch · 5","Predict which choice will change a monthly plan most, then open The Real Game.")+flow("#4a9d2f","Three required actions · 10","Add career, education, and at least one expense.")+flow("#1f617a","Build and test the plan · 25","Add realistic living choices, inspect the effect, and avoid racing through extra sims.")+flow("#e3ad19","Save and explain · 5","Save the Quick sim and write one benefit-and-cost tradeoff.")+flow("#1f617a","Report check and close · 5","Verify completion or record supervised recovery; exit the sim and return the device."),"MONITOR":"<p><strong>Minute 8:</strong> every student is in The Real Game or has a named access barrier. <strong>Minute 18:</strong> each sim includes career, education, and one expense. <strong>Minute 35:</strong> students can name the choice that changed the plan most. <strong>Minute 45:</strong> the sim is saved and the tradeoff sentence is complete. If Xello fails, use the fixed Jordan scenario for learning and schedule the required save in supervised recovery. Do not count paper as completion.</p>","RESOURCES":'<p><a href="https://help.xello.world/en-us/content/Knowledge-Base/Xello-6-12/The-Real-Game/Students-TRG.htm">Xello: How students work with The Real Game</a> · <a href="https://help.xello.world/en-us/content/Knowledge-Base/Xello-6-12/Completion-Standards/List-of-Tasks.htm">Xello Completion Standards task list</a></p>',"SUPPORT":"<p>Use the three-action checklist, read one choice at a time, oral rehearsal, and the bilingual point-of-use word bank. A peer may point but does not control another account.</p>","FALLBACK":"<p>The fixed Jordan scenario carries the learning when Xello is unavailable. It does not create platform completion. Record the barrier and schedule a supervised Xello recovery window.</p>"},
