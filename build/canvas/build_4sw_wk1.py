...
async def require_major_assignment(client, description):
    ...
    if float(found.get("points_possible") or 0) != 100:
        raise RuntimeError(
            f"Refusing to modify {BLUEPRINT_TITLE!r}: expected 100 points, found {found.get('points_possible')}"
        )
    ...
    if not group or group.get("name") != "Major Assessments (60%)":
        raise RuntimeError(
            f"Refusing to modify {BLUEPRINT_TITLE!r}: expected Major Assessments (60%) group"
        )
    return await api(
        client,
        "PUT",
...
async def main():
    ...
    async with httpx.AsyncClient(headers={"Authorization": f"Bearer {token}"}, timeout=120) as client:
        ...
        blueprint = await require_major_assignment(client, blueprint_description)
        ...
        contracts = {
            ...
            5: {"TOPIC": "Career Assessment", "OBJECTIVE": "Students will synthesize self, career, and pathway evidence into a current plan with a backup and next action.", "TEKS": "d(1)(A), d(8)(A), d(8)(B)", "DOL": "Mid-Year Career Blueprint.", "I_CAN": "use self, career, and pathway evidence to make a current plan with a backup and next action.", "SHOW": "submit one private Mid-Year Career Blueprint and revise it with the student scoring guide."},
        }

        student = {
            1: {"TITLE":"Mid-Year Profile Audit","PURPOSE":"Use current evidence to examine how your career thinking has changed or stayed the same.","TODAY":"<ul><li>review one earlier result or idea;</li><li>collect three current pieces of evidence;</li><li>defend one conclusion.</li></ul>","READY":f'<p>Open {file_link(files["AUDIT"]["id"], "the Mid-Year Profile Audit")}. You may also use a notebook, H&amp;L, Xello, or an earlier portfolio item. A private screenshot is not required.</p>',"LANGUAGE":'<div style="border-left:5px solid #1f617a;background:#f2f8fb;padding:14px 18px;margin:18px 0"><p><strong>Word bank:</strong> evidence = a specific result, choice, task, or experience · pattern = what repeats · supports = agrees with · complicates = adds another side.</p><p><strong>Use this frame:</strong> My earlier result said ___. Current evidence shows ___ and ___. This supports, complicates, or changes the result because ___.</p></div>',"STEPS":step(1,"Choose the earlier result","<p>Record one earlier assessment result, work value, Building Block, career idea, or clearly labeled current baseline.</p>")+step(2,"Collect three pieces of evidence","<p>Use specific activities, choices, feedback, or profile results from different sources.</p>")+step(3,"Analyze the pattern","<p>Decide whether the evidence supports, complicates, or changes the earlier result. Explain why.</p>"),"EXIT":"<p>What is one conclusion you can defend now, and what evidence supports it?</p>","DONE":"<ul><li>one baseline;</li><li>three specific pieces of evidence;</li><li>one pattern;</li><li>one defensible conclusion.</li></ul>","SUPPORT":"<p>evidence = evidencia · earlier = anterior · current = actual · pattern = patrón. Use the complete frame above and speak your explanation before writing.</p>","FALLBACK":"<p>The PDF is the complete independent route. If earlier evidence is missing, use today's self-evidence inventory and label it as your baseline.</p>"},
        ...
        teacher = {
            ...
            2: {"TITLE":"Career Iceberg and Goal","SUBTITLE":"50 minutes · TEKS d(1)(A), d(8)(A)","ALERT":"<strong>Workbook first.</strong> FYF pp. 6-8 and 283-284 are the normal route. Canvas annotation and the enlarged CCE packet replace the workbook when needed; students do not complete both.","PREP":f'<ul><li>Ask students to bring the FYF workbook.</li><li>Project the licensed model.</li><li>Keep {file_link(files["ICEBERG"]["id"], "the enlarged support route")} and unpublished annotation ready without printing them for everyone.</li></ul>',"EVIDENCE":"<p>Three visible items, eight hidden items across categories, two self-evidence links, one requirement, and one research question. Formative.</p>","FLOW":flow("#5a2d91","Warm-up · 5","What work does success hide?")+flow("#4a9d2f","Model · 10","FYF pp. 6-7: visible versus hidden evidence.")+flow("#1f617a","Build · 18","FYF p. 8: label the iceberg.")+flow("#e3ad19","Goal · 12","FYF pp. 283-284: use Day 1 evidence and one question.")+flow("#1f617a","Exit · 5","Explain one changed perception."),"MONITOR":"<p>At minute 10 of building, require at least one skill, tool, training step, responsibility, challenge, and support. Accept uncertainty. Do not force a permanent career commitment.</p>","RESOURCES":"<p>FYF pp. 6-8 and 283-284 carry the core task. Canvas DocViewer annotation is an optional practice interaction and absence route.</p>","SUPPORT":"<p>Use the point-of-use category list, typed labels, oral description, or enlarged packet. Drawing skill is not scored.</p>","FALLBACK":"<p>If the workbook or annotation is unavailable, use upload, text, media, or paper. The Student Guide contains the model and full directions.</p>"},
            3: {"TITLE":"Career Deep Dive","SUBTITLE":"50 minutes · TEKS d(8)(B)","ALERT":"<strong>Workbook first.</strong> FYF pp. 285-286 carry the task. Students add source, date, place, and measure beside the pay field or in a notebook. The CCE guide is the enlarged no-workbook route.","PREP":f'<ul><li>Ask students to open FYF pp. 285-286.</li><li>Test sources and prepare one dated career card.</li><li>Keep {file_link(files["DEEP"]["id"], "the enlarged source guide")} available without printing it for everyone.</li></ul>',"EVIDENCE":"<p>Tasks, work condition, preparation, license or certification when applicable, fully labeled salary and outlook, source, and first step. Formative.</p>","FLOW":flow("#5a2d91","Warm-up · 5","Label place, year, measure.")+flow("#4a9d2f","Source model · 10","Read one evidence card.")+flow("#1f617a","Deep dive · 25","FYF pp. 285-286: research and record.")+flow("#e3ad19","Evidence check · 5","Repair one incomplete claim.")+flow("#1f617a","Exit · 5","Plan from one requirement."),"MONITOR":"<p>Reject unlabeled numbers, not student preferences. A full response distinguishes a common route from a universal requirement. Students may use FYF, H&amp;L, or Xello evidence as printed, then add the visible source labels.</p>","RESOURCES":'<p>FYF and district-licensed Xello or H&amp;L are the first evidence sources. <a href="https://www.bls.gov/ooh/">BLS Occupational Outlook Handbook</a> is a national cross-check. Keep competing measures separate.</p>',"SUPPORT":"<p>Read one source field at a time, pre-highlight labels, and offer the fixed card or enlarged guide. Students may rehearse the exit response aloud.</p>","FALLBACK":"<p>The dated career card plus enlarged guide is the complete no-login and no-workbook route.</p>"},
            4: {"TITLE":"Irving Pathway and CTSO Decision","SUBTITLE":"50 minutes · TEKS d(3)(F), d(8)(A)","ALERT":"<strong>Private digital route by default.</strong> The four-page packet is the paper, enlarged, or independent route. Do not print both routes for every student.","PREP":f'<ul><li>Open the private unpublished Pathway and CTSO Assignment.</li><li>Test the current Irving CTE hub, 2026-27 course descriptions, and TEA CTSO page.</li><li>Keep {file_link(files["PATHWAY"]["id"], "the paper or enlarged route")} and dated pathway cards ready.</li></ul>',"EVIDENCE":"<p>Two or three current options, source labels, evidence-based comparison, one CTSO benefit, and one verification question. Formative and ungraded.</p>","FLOW":flow("#5a2d91","Warm-up · 5","Facts and people needed before choosing.")+flow("#4a9d2f","Current source route · 12","Program names, locations, course information.")+flow("#1f617a","Compare · 18","Two or three options using fit and evidence.")+flow("#e3ad19","CTSO connection · 10","One specific preparation benefit.")+flow("#1f617a","Exit · 5","Choice, fact, question, benefit."),"MONITOR":"<p>Accept “not yet confirmed.” Do not collapse a program, certification, course, and career into one label. Full d(3)(F) evidence explains a preparation benefit, not merely the CTSO name.</p>","RESOURCES":'<p><a href="https://www.irvingisd.net/departments-services/career-and-technical-education-cte/high-school-cte">Irving ISD High School CTE</a> · <a href="https://www.irvingisd.net/departments-services/curriculum-and-instruction/middle-school-and-high-school-course-descriptions">2026-27 course descriptions</a> · <a href="https://tea.texas.gov/student-readiness-and-high-school/college-career-and-military-prep/career-and-technical-education/career-and-technical-education-student-organizations">TEA CTSOs</a></p>',"SUPPORT":"<p>Compare two options with all evidence fields when reduced quantity is documented. Use the complete point-of-use frame, text-to-speech, or the paper route.</p>","FALLBACK":"<p>If live sites fail, use dated cards and mark facts for later verification. No vendor unit or platform state is load-bearing.</p>"},
            5: {"TITLE":"Mid-Year Career Blueprint","SUBTITLE":"50 minutes · TEKS d(1)(A), d(8)(A), d(8)(B)","ALERT":"<strong>Major 1 is already mapped.</strong> The Assignment stays unpublished, is worth 100 points, and remains in Major Assessments (60%) so each teacher can publish it after cloning.","PREP":f'<ul><li>Post {file_link(files["BLUEPRINT"]["id"], "the three-page Blueprint")} and {file_link(files["RUBRIC"]["id"], "the student scoring guide")}.</li><li>Open the private unpublished Assignment.</li><li>Have missing-artifact fallback evidence ready.</li></ul>',"EVIDENCE":"<p>Submit the Blueprint only. It synthesizes self, career, pathway, backup, trade-off, and next action evidence. Major 1, scored with the 16-point rubric and converted to 100 gradebook points.</p>","FLOW":flow("#5a2d91","Warm-up · 5","Revision versus quitting.")+flow("#4a9d2f","Career thinker · 8","Notice, choose, act, revise.")+flow("#1f617a","Blueprint · 22","Complete the six evidence jobs.")+flow("#e3ad19","Review · 10","Self, teacher, label-only partner, or audio route.")+flow("#1f617a","Submit · 5","Private exit sentence and submission."),"MONITOR":"<p>Use the associated Canvas rubric: 15-16 Masters, 13-14 Meets, 12 Approaches, 10-11 Needs Improvement; below 10 follows campus policy. Score evidence and reasoning, not grammar, art, accent, or submission mode unless meaning is unclear.</p>","RESOURCES":"<p>FYF p. 22 frames career planning as evidence, action, and revision. Days 1-4 provide source material; they are not separate required Major uploads.</p>","SUPPORT":"<p>Use numbered sentence jobs, speech-to-text, teacher scribe, or media recording. The printable has full-width writing space matched to the requested response.</p>","FALLBACK":"<p>A missing earlier artifact does not force a restart. Use the evidence already visible in the Blueprint. Canvas failure means paper or later upload without penalty.</p>"},
        }
        ...
        for day in range(1, 6):
            ...
            if day == 4:
                await upsert_item(client, module["id"], "Assignment", pathway_practice["id"], PATHWAY_TITLE)
        ...
        print(json.dumps({
            ...
            "pathway_practice":{"id":pathway_practice["id"],"published":pathway_practice.get("published"),"submission_types":pathway_practice.get("submission_types"),"grading_type":pathway_practice.get("grading_type")},
            "blueprint":{"id":blueprint["id"],"published":blueprint.get("published"),"submission_types":blueprint.get("submission_types"),"grading_type":blueprint.get("grading_type"),"points_possible":blueprint.get("points_possible"),"assignment_group_id":blueprint.get("assignment_group_id")},
