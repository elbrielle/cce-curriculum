...
async def main():
    ...
    async with httpx.AsyncClient(headers={"Authorization":f"Bearer {token}"},timeout=120) as c:
        ...
        teacher_data={
          ...
          4:{"TITLE":"Strengthen Cybersecurity Career Evidence","SUBTITLE":"50 minutes - TEKS d(1)(D)","ALERT":"<strong>No profile action is required today.</strong> Reuse the Day 1 route guide as the single response home. H&amp;L and live web exploration are optional; the fixed guide and FYF pages carry the complete evidence route.","PREP":f'<ul><li>Return or reopen each student’s <a href="/courses/{COURSE_ID}/files/{files["ROUTE"]["id"]}/preview">Cybersecurity Career Route Guide</a>.</li><li>Open FYF pp. 36-38 and project the source labels: May 2024 U.S. median, 2024-34 projection, typical preparation, and possible route.</li><li>If offering CyberSeek or H&amp;L after the fixed evidence is open, preflight the student-filtered route and record the date. No favorite, rating, or profile edit is required.</li></ul>',"EVIDENCE":"<p>Formative evidence is the revised route guide: two accurately labeled dated facts, one source limitation, a defensible interested/unsure/not-interested judgment, one visible revision, and one next step.</p>","FLOW":flow("#5a2d91","Stronger-evidence warm-up - 5 minutes","Compare an unsupported opinion with a fact, limitation, and reasoned judgment.")+flow("#4a9d2f","District career context - 10 minutes","Review FYF pp. 36-38 and name one program or experience, one kind of work, and one unanswered question.")+flow("#1f617a","Strengthen the route guide - 20 minutes","Label two dated facts, name one limitation, and revise the career judgment.")+flow("#e3ad19","Partner evidence conference - 10 minutes","Reader and Evidence Checker switch roles; every student makes one visible revision.")+flow("#1f617a","Private next step - 5 minutes","Record one course, program, question, or source to investigate next."),"MONITOR":"<p>Every number keeps its measure and date. The $124,910 figure is a May 2024 U.S. median, not starting or Irving pay; 29% is projected 2024-34 growth, not a job guarantee. Accept interested, unsure, or not interested when the judgment uses evidence. Ask, “What does this source not tell us?” rather than pushing students toward a preferred answer.</p>","SUPPORT":"<p>Place this word bank beside the response: <strong>median, projected, typical, limitation, judgment, route</strong>. Students highlight the two facts first, rehearse orally, use speech-to-text or text-to-speech, or plan bilingually. Frame: <em>“The source says ___. This matters because ___. It does not tell me ___.”</em></p>","FALLBACK":"<p>The fixed route guide and FYF pages are the normal complete route. An absent student completes the same evidence jobs and private next step. No profile edit, favorite, or platform catch-up is required.</p>"},
