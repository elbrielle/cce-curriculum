...
async def main():
    ...
    async with httpx.AsyncClient(headers={"Authorization":f"Bearer {token}"},timeout=120) as c:
        ...
        glances={
          ...
          3:{"WORKBOOK":"FYF pp. 34-35","PLATFORM":"Canva or Adobe Express optional; paper is equal","NOTEBOOK":"None","SLIDES":"No separate deck; project the workbook scenario and completed model","SCAFFOLDS":"Bootcamp model, plan, oral planning, and audience choice bank","EXIT_EVIDENCE":"Bootcamp plan and flyer prototype for the capstone packet"},
          ...
          5:{"WORKBOOK":"No new FYF page; return the Week 0 Career Journey reflection","PLATFORM":"Canva or Adobe Express optional; paper is equal","NOTEBOOK":"None; the student-owned Evidence Log receives a brief transfer","SLIDES":"No separate deck; project the two transition prompts and rubric","SCAFFOLDS":"Career Journey Update, bilingual support, rubric, and two-shape menu","EXIT_EVIDENCE":"Four-piece Major 2 capstone packet with two transition actions"}}
        pages={}
        for day in range(1,6):
