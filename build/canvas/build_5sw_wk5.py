...
STUDENT_GOOGLE_COPY_URLS = {
    1: "https://docs.google.com/document/d/1GEVC3SNv2NK_alrHhNHAq6pyb0RuVYnAVvvKhxx8g2I/copy",
    2: "https://docs.google.com/document/d/1OgO4BNxNukEJ_s5TXXj_GW_5FN_I4XB9SeR5Sv9Xs0c/copy",
    3: "https://docs.google.com/document/d/1MGAhYS25fyoKGAXIyeRu-YSTx-ltJ1IlzAzdPyI3tl4/copy",
    4: "https://docs.google.com/document/d/1C4C2BIoDTzCp1bq7JP8sqOaLjx6vHxAevJRlGZMf85U/copy",
    5: "https://docs.google.com/document/d/10EZ_0K5hhOkluyMdng0opjEKvNmgQuGCPjhPE0tRb-U/copy",
}
...
STUDENT_WORKSHEET_COPY_URLS = {
    (1, 'the three-page Salary Source and Lifestyle Target packet'): "https://docs.google.com/document/d/1FryYeRNk8YsHya2o7R5VTerTNiEft0Y57AY6dXuxir4/copy",
    (2, 'the four-page Dallas County budget packet'): "https://docs.google.com/document/d/1IoS3AfM48mr0xBH4s0-kCiQ40DjZDxpyFw26Vfh9VdM/copy",
    (3, 'the two-page Location Cost Comparison packet'): "https://docs.google.com/document/d/1QZj2wmSKtgLl_3Gau6zxtqnubHG8pjfRTtvOWwKdu5M/copy",
    (4, 'the three-page Paying for Education and Training guide'): "https://docs.google.com/document/d/1hOUQEFA_YLU9jMwFGEGx9WFgEU7CgAiFqRb-LTb7rp8/copy",
    (5, 'the four-page portfolio'): "https://docs.google.com/document/d/1p-_SGUo2bproM_MIlQuGsH3RwqfEjc27roZQl3OwNSY/copy",
}
...
def student_content(files, visuals, urls):
    ...
    rung_media = (
        ...
        '<div style="border-left:5px solid #d39b22;background:#fff8e7;padding:12px 16px;margin:14px 0"><strong>Optional:</strong> open your <em>Find Your Future</em> workbook to pp. 285-286 (Rung 3) if you already filled them in. <strong>Source-label repair:</strong> the workbook page is a reminder of prior career work, not current salary proof. Use the fixed BLS card as the common scored evidence. A separately labeled Xello local cross-check is optional and does not create a completion task.</div>'
...
def teacher_content(files):
    ...
    return {
        1: {
            ...
            "ALERT": "<strong>Keep the source label attached.</strong> Median, starting, range, local, and national are different measures. The fixed BLS card is the common source; Xello is an optional labeled local cross-check, not a completion task.",
            ...
            "FLOW": (
                flow(c, "Minutes 0-5 - Welcome and age-25 lifestyle envisioning warm-up", '''<p>Welcome students to Week 5 of 5SW (Financial Literacy &amp; Personal Budgeting) and project the age-25 lifestyle prompt.</p><ul><li>Ask students: <em>“Picture an ordinary Tuesday in your life at age 25. Where do you wake up? What kind of transportation do you take to work? When your alarm goes off, what job are you heading to, and what does it actually cost each month to support that lifestyle?”</em></li><li>Collect 2-3 student thoughts: Renting an apartment, buying groceries, paying car insurance, and having emergency savings!</li><li>Bridge with, <em>“Financial freedom is not about guessing—it is about planning. Today we launch our financial planning unit by connecting career wages to lifestyle choices using rigorous, source-labeled labor data.”</em></li></ul>''')
                + flow("#4c8b38", "Minutes 5-15 - Sourced labor data &amp; 5-part statistical labels", '''<p>Deconstruct the 5 Mandatory Components of a Valid Labor Statistic on the screen:</p><ul><li>1. <strong>Occupation:</strong> Exact job title (e.g., Electrician, Civil Engineer).</li><li>2. <strong>Geography:</strong> National (U.S.) vs. State (Texas) vs. Metropolitan Area (Dallas-Fort Worth-Arlington).</li><li>3. <strong>Measure:</strong> Median annual wage (the 50th percentile) vs. starting pay (10th percentile) vs. average.</li><li>4. <strong>Source:</strong> Official reporting agency (e.g., U.S. Bureau of Labor Statistics).</li><li>5. <strong>Date / Access Year:</strong> May 2024 data release.</li><li>Exemplar vs. Non-Example Modeling: Demonstrate why saying <em>“Electricians start at $62,350 in Dallas”</em> is false (it confuses national median with local starting pay), while <em>“BLS reports a May 2024 U.S. median of $62,350 for Electricians”</em> is statistically true and defensible.</li></ul>''')
                + flow("#8a4f2b", "Minutes 15-33 - Fictional lifestyle target mapping sprint", '''<p>Students author their fictional Age-25 Lifestyle Target in their guide (or Canvas):</p><ul><li>Select one target occupation from our CCE career dataset and document its 5-part BLS statistical profile.</li><li>Define Fictional Lifestyle Choices: Housing arrangement (independent 1-bedroom apartment vs. shared roommate lease), transportation (reliable used vehicle with insurance vs. public transit DART pass), food, utilities, and entertainment.</li><li>Document Three Budgetary Priorities: Rank which 3 financial goals they will protect first (e.g., Priority 1: $300 Emergency Savings, Priority 2: Fixed Rent, Priority 3: Education/Debt Repayment).</li><li><strong>Active Monitoring Checkpoints:</strong><br>• Lap 1 (Minute 22): Verify all 5 statistical labels are attached to the career salary.<br>• Lap 2 (Minute 29): Confirm lifestyle scenarios are fictional planning models; redirect any personal family disclosures.</li></ul>''')
                + flow("#d39b22", "Minutes 33-45 - BLS labor trend analysis &amp; source limitation", '''<p>Students analyze the 10-year projected outlook for their selected career:</p><ul><li>Interpret National Growth: Record 2024-34 projected growth percentage and annual replacement openings.</li><li>Formulate One Source Limitation: Explain why a national median wage does not guarantee a local entry-level salary in Dallas County.</li><li>Elbow partners verify each other's 5-part source labels.</li></ul>''')
                + flow(c, "Minutes 45-50 - Day 1 submission and folder storage", '''<p>Students submit their completed lifestyle target in Canvas or file paper packets.</p><ul><li><strong>Safe Trim:</strong> Shorten partner audit; fiercely protect the 5-part statistical label, 3 priorities, national trend, and private submission.</li></ul>''')
            ),
        ...
        2: {
            ...
            "FLOW": (
                flow(c, "Minutes 0-5 - Welcome and fixed vs. variable expenses warm-up", '''<p>Welcome students, seat them with devices or the 4-page budget packet, and project the monthly expense prompt.</p><ul><li>Ask students: <em>“What is the difference between a fixed expense that you must pay every single month on the exact same date—like apartment rent—and a variable expense that changes based on your daily choices—like eating out with friends or streaming subscriptions?”</em></li><li>Collect 2-3 student thoughts: Fixed costs are contractual obligations; variable costs are flexible wants!</li><li>Bridge with, <em>“Budgeting is about giving every dollar a specific job. Today we build a realistic Dallas County monthly budget using a supplied fictional income of $4,200 and MIT living wage benchmark data.”</em></li></ul>''')
                + flow("#4c8b38", "Minutes 5-15 - MIT Dallas County benchmark &amp; zero-based budget modeling", '''<p>Display the Dallas County MIT Living Wage Benchmark and Budget Architecture on the screen:</p><ul><li>1. <strong>MIT Benchmark (Dallas County, 1 Adult / 0 Children, updated Feb 15, 2026):</strong> Required annual basic cost before taxes = $48,489 ($4,041/month); after taxes = $41,399 ($3,450/month).</li><li>2. <strong>Supplied Fictional Scenario:</strong> Gross monthly income = $4,200.</li><li>3. <strong>The 50/30/20 Budgeting Rule of Thumb:</strong><br>• <strong>50% Needs (Basic Costs):</strong> Housing, utilities, groceries, transportation, health insurance.<br>• <strong>20% Financial Goals / Savings:</strong> Emergency emergency cushion, retirement, debt reduction.<br>• <strong>30% Flexible Wants:</strong> Dining out, entertainment, recreation, personal spending.</li><li>Model Zero-Based Balancing: Income ($4,200) - Total Expenses = Balance ($0 Surplus/Shortage). A shortage is not a failure; it is mathematical evidence that spending must be adjusted!</li></ul>''')
                + flow("#8a4f2b", "Minutes 15-37 - Building the Dallas County monthly budget sprint", '''<p>Students build and balance their fictional monthly budget in their guide (or Canvas):</p><ul><li>Calculate Line-Item Allocations: Enter monthly costs across Housing ($1,250), Food/Groceries ($420), Transportation/Auto ($650), Health Care ($280), Emergency Savings ($300), Long-Term Savings ($200), and Flexible Wants ($300).</li><li>Sum Total Monthly Expenses and calculate the Initial Net Balance (Income - Expenses).</li><li><strong>The Unexpected Shock Event (Minute 27):</strong> Project the real-world economic event: <em>“Monthly income drops by $300 due to reduced overtime hours! Your new monthly income is $3,900.”</em></li><li>Execute Budget Revision: Protect emergency savings ($300), identify two variable want categories to trim, and recalculate a balanced $0 baseline.</li><li><strong>Active Monitoring Checkpoints:</strong><br>• Lap 1 (Minute 22): Ensure students balance arithmetic accurately using calculators.<br>• Lap 2 (Minute 32): Verify students protect essential savings and trim flexible wants during the revision.</li></ul>''')
                + flow("#d39b22", "Minutes 37-45 - Budget audit &amp; reflection", '''<p>Students evaluate their budget resilience:</p><ul><li>Elbow partners audit each other's arithmetic: Did the revision achieve a balanced $0 balance?</li><li>Record one personal takeaway on how emergency funds protect against sudden income drops.</li></ul>''')
                + flow(c, "Minutes 45-50 - Submit Dallas Budget and wrap-up", '''<p>Students submit their completed budget in Canvas or hand in paper packets.</p><ul><li><strong>Safe Trim:</strong> Shorten partner audit; fiercely protect initial budget table, $300 shock revision, balanced math, and private submission.</li></ul>''')
            ),
        ...
        3: {
            ...
            "FLOW": (
                flow(c, "Minutes 0-7 - Welcome and geographical purchasing power warm-up", '''<p>Welcome students, seat them with devices or the 2-page location packet, and project the relocation prompt.</p><ul><li>Ask students: <em>“If a tech company offers you a salary of $70,000 in Dallas, Texas, and another company offers you the exact same $70,000 in San Francisco, California or New York City, are those two offers actually equal? Where will your paycheck buy a better quality of life?”</em></li><li>Collect 2-3 student thoughts: Living costs, rent, and state income taxes differ drastically across cities!</li><li>Bridge with, <em>“A salary number is only meaningful when compared to local living expenses. Today we evaluate Jordan's $70,000 job offer across three distinct U.S. metropolitan regions using official MIT benchmark targets.”</em></li></ul>''')
                + flow("#4c8b38", "Minutes 7-13 - MIT three-location cost benchmarks &amp; gap calculation modeling", '''<p>Display the Controlled Location Dataset (1 Adult / 0 Children, updated Feb 15, 2026) on the screen:</p><ul><li>1. <strong>Tulsa, Oklahoma / McAllen, Texas:</strong> Annual Living Wage Target = $44,165.</li><li>2. <strong>Dallas County, Texas:</strong> Annual Living Wage Target = $48,489.</li><li>3. <strong>Los Angeles County, California:</strong> Annual Living Wage Target = $60,161.</li><li>4. <strong>New York County (Manhattan), New York:</strong> Annual Living Wage Target = $79,469.</li><li>Model the Mathematical Gap Calculation: Offer Amount - Living Cost Target = Purchasing Power Surplus/Deficit.<br>• Dallas: $70,000 - $48,489 = +$21,511 Surplus.<br>• Manhattan: $70,000 - $79,469 = -$9,469 Shortfall!</li><li>Identify Nonfinancial Relocation Factors: Proximity to family/support systems, climate, transit access, state income tax, and community connection.</li></ul>''')
                + flow("#8a4f2b", "Minutes 13-31 - Three-location comparative calculation sprint", '''<p>Students analyze Jordan's $70,000 offer across three chosen markets in their packet (or Canvas):</p><ul><li>Step 1: Calculate the exact dollar surplus or deficit for Jordan in Dallas County plus two comparison cities (e.g., Tulsa vs. Los Angeles).</li><li>Step 2: Compare Living Cost Disparities: Calculate the difference in housing and transportation targets between the lowest and highest cost regions.</li><li>Step 3: Synthesize Two Nonfinancial Factors: Describe how support networks, commute times, or career advancement opportunities influence a relocation decision.</li><li><strong>Active Monitoring Checkpoints:</strong><br>• Lap 1 (Minute 20): Check that students use official annual targets rather than multiplying hourly rates by 2,080.<br>• Lap 2 (Minute 27): Confirm students correctly label surpluses (+) and shortfalls (-).</li></ul>''')
                + flow("#d39b22", "Minutes 31-45 - Jordan relocation recommendation &amp; unresolved question", '''<p>Students formulate an evidence-based recommendation for Jordan:</p><ul><li>Author a 3-sentence relocation recommendation: Which city should Jordan choose? Justify using the calculated surplus and one nonfinancial factor.</li><li>Identify One Unanswered Question Jordan must investigate before signing a lease (e.g., local state income tax rates, public transit reliability).</li></ul>''')
                + flow(c, "Minutes 45-50 - Submit Location Comparison and wrap-up", '''<p>Students submit their completed comparison in Canvas or file paper packets.</p><ul><li><strong>Safe Trim:</strong> Shorten partner check; fiercely protect the 3 mathematical gap calculations, Jordan recommendation, and private submission.</li></ul>''')
            ),
        ...
        4: {
            ...
            "FLOW": (
                flow(c, "Minutes 0-5 - Welcome and postsecondary funding myths warm-up", '''<p>Welcome students, seat them with devices or the 3-page guide, and project the college funding prompt.</p><ul><li>Ask students: <em>“Many middle schoolers believe you have to be either a straight-A genius with a full scholarship or take on $50,000 in student loans to get postsecondary training. Is that true? What other methods exist to pay for technical credentials and college degrees?”</em></li><li>Collect 2-3 student thoughts: Financial aid grants, work-study programs, employer tuition reimbursement, and paid Registered Apprenticeships!</li><li>Bridge with, <em>“Navigating postsecondary funding requires knowing the difference between money you earn, money you are given, and money you must repay. Today we deconstruct seven funding pathways and debunk critical financial aid myths.”</em></li></ul>''')
                + flow("#4c8b38", "Minutes 5-15 - Seven funding methods &amp; Texas Grade 12 FAFSA requirement", '''<p>Deconstruct the 7 Primary Postsecondary Funding Pathways on the main screen:</p><ul><li>1. <strong>Grants (e.g., Federal Pell Grant, Texas Public Education Grant):</strong> Need-based gift aid; does NOT have to be repaid.</li><li>2. <strong>Scholarships:</strong> Merit-, talent-, or community-based aid; does NOT have to be repaid.</li><li>3. <strong>Federal Work-Study:</strong> Part-time campus job that helps students earn wages while enrolled.</li><li>4. <strong>Federal Direct Student Loans:</strong> Borrowed money that MUST be repaid with interest; subsidized vs. unsubsidized.</li><li>5. <strong>Employer Tuition Assistance / Benefits:</strong> Company pays all or part of tuition for related coursework.</li><li>6. <strong>Personal &amp; Family Savings (e.g., 529 College Savings Plan):</strong> Pre-funded savings invested over time.</li><li>7. <strong>Registered Apprenticeship:</strong> Industry sponsors pay 100% of training while paying you a full-time wage!</li><li>Texas State Policy Rule: Texas law requires high school seniors to submit a FAFSA, complete a TASFA (for eligible non-citizens), or submit a signed opt-out form to graduate.</li><li>Strict Privacy Rule: Students do NOT create financial aid accounts or disclose personal family finances in class.</li></ul>''')
                + flow("#8a4f2b", "Minutes 15-26 - Two fictional funding scenarios sprint", '''<p>Students analyze the funding scenarios for fictional students Taylor and Jordan:</p><ul><li>Case 1 (Taylor - 4-Year University Path): Taylor wants to study Architecture. Identify the two gift-aid methods Taylor must prioritize before considering loans, and name one eligibility condition to verify.</li><li>Case 2 (Jordan - Skilled Trade Path): Jordan wants to become an Electrician. Compare an apprenticeship sponsorship with a technical college certificate and identify the debt-free advantage.</li><li><strong>Active Monitoring Checkpoints:</strong><br>• Lap 1 (Minute 20): Ensure students separate gift aid (grants/scholarships) from debt (loans).<br>• Lap 2 (Minute 24): Confirm students identify verifying sponsor terms for apprenticeships.</li></ul>''')
                + flow("#d39b22", "Minutes 26-40 - Claim repair sequence &amp; 5-question retryable Canvas quiz", '''<p>Students repair 3 common financial aid misconceptions and take the practice check:</p><ul><li>Claim Repair 1: Correct <em>“FAFSA is a student loan that everyone has to pay back”</em> &rarr; FAFSA is the free federal application that determines eligibility for grants, work-study, AND loans.</li><li>Claim Repair 2: Correct <em>“Apprenticeships cost the same as a 4-year private university.”</em></li><li>Claim Repair 3: Correct <em>“You must disclose your parents' bank accounts in 8th grade CCR class.”</em></li><li>Canvas Practice Check: Complete the 5-question retryable quiz; read immediate feedback and achieve 100%.</li></ul>''')
                + flow(c, "Minutes 40-50 - Day 4 wrap-up and evidence storage", '''<p>Students submit their completed packet in Canvas or file in collection trays.</p><ul><li><strong>Safe Trim:</strong> Limit quiz attempts to 2; fiercely protect the 7-method classification, Taylor/Jordan cases, claim repairs, and private submission.</li></ul>''')
            ),
        ...
        5: {
            ...
            "MODEL": '<div style="border:1px solid #bdd6cb;border-radius:8px;background:#f2f8f5;padding:12px 16px"><p><strong>Complete model strip:</strong> “I currently recommend Civil Engineer. The May 2024 U.S. median is $99,590, and a bachelor\'s degree is the typical entry preparation. The tradeoff is the time and cost of that education. $99,590 - $48,489 = $51,101 above the screening target. That is not take-home pay and does not prove a local opening or fit. In my fictional $4,200 monthly plan, I would keep emergency savings and reduce wants by $100 until I verify local pay and education cost.”</p><p><strong>Non-example:</strong> mix one optional local range with two national medians, choose the largest number, and attach Days 1-4 again.</p></div>',
            "FLOW": (
                flow(c, "Minutes 0-6 - Welcome and financial portfolio overview warm-up", '''<p>Welcome students, seat them with devices and calculators (or the 4-page landscape portfolio), and project the career portfolio prompt.</p><ul><li>Ask students: <em>“When comparing potential future careers, why is it dangerous to look only at the salary figure on social media without considering the required postsecondary education debt and local cost of living?”</em></li><li>Collect 2-3 student thoughts: A $90,000 career that requires $100,000 in student loans and high living costs might leave you with less monthly savings than a $60,000 apprenticeship career with zero debt!</li><li>Bridge with, <em>“Today is Major 2: Personal Budget and Career Evidence Portfolio! We compare three distinct career paths on an identical May 2024 BLS evidence basis, screen each against our Dallas County living cost target, and finalize our personal monthly financial plan.”</em></li></ul>''')
                + flow("#4c8b38", "Minutes 6-22 - Three-career same-basis evidence sprint", '''<p>Students record and verify the 3 standardized CCE occupations in their portfolio (or Canvas):</p><ul><li>1. <strong>Architect:</strong> May 2024 U.S. median pay: $93,310; 8% projected growth; Bachelor's degree (5-year B.Arch) + NCARB AXP/ARE.</li><li>2. <strong>Civil Engineer:</strong> May 2024 U.S. median pay: $99,590; 5% projected growth; Bachelor's degree (BSCE) + FE/PE license boundary.</li><li>3. <strong>Electrician:</strong> May 2024 U.S. median pay: $61,590; 11% projected growth; 4-5 year Apprenticeship + TDLR Journeyman license.</li><li>Ensure Same Evidence Basis: All 3 careers must use May 2024 U.S. BLS median annual wages and 2024-34 national projections.</li><li><strong>Active Monitoring Checkpoints:</strong><br>• Lap 1 (Minute 12): Check that students use consistent national median wages across all three profiles.<br>• Lap 2 (Minute 18): Confirm students record the required postsecondary education and credential boundary for each role.</li></ul>''')
                + flow("#8a4f2b", "Minutes 22-30 - Evidence-based recommendation &amp; personal tradeoff", '''<p>Students author their primary career recommendation and evaluate tradeoffs:</p><ul><li>Select one career to recommend for their age-25 plan. Support the choice with at least TWO concrete facts from today's evidence (salary, job growth, or training route).</li><li>Acknowledge ONE Substantive Tradeoff: Identify a real challenge of this choice (e.g., 5 years of university tuition for architecture, or physical toll and outdoor job-site conditions for electrical work).</li></ul>''')
                + flow("#d39b22", "Minutes 30-43 - Salary-minus-target screening &amp; budget revision", '''<p>Students execute the financial screening calculation against the Dallas County target:</p><ul><li>Screening Subtraction: Annual BLS Median Wage - Dallas County Target ($48,489) = Screening Difference.<br>• Architect: $93,310 - $48,489 = +$44,821<br>• Civil Engineer: $99,590 - $48,489 = +$51,101<br>• Electrician: $61,590 - $48,489 = +$13,101</li><li>Evidence Boundary Note: Document that this difference is a gross planning benchmark, NOT actual take-home pay!</li><li>Fictional $4,200 Monthly Budget Revision: Record one final adjustment to their Day 2 monthly budget to support their chosen career preparation.</li><li>Rubric Self-Audit: Self-score against the 16-point Major 2 rubric.</li></ul>''')
                + flow(c, "Minutes 43-50 - Submit Major 2 and 5SW Week 5 wrap-up", '''<p>Students submit their completed Major 2 portfolio in Canvas or hand in paper packets.</p><ul><li>Congratulate students on completing Major 2 and mastering financial literacy!</li><li><strong>Safe Trim:</strong> Skip general debrief; fiercely protect all 3 career profiles, tradeoff analysis, screening calculations, rubric self-check, and private submission.</li></ul>''')
            ),
            "MONITOR": "<ul><li><strong>Minute 8:</strong> all three career records use the fixed BLS geography, date, and wage measure.</li><li><strong>Minute 22:</strong> three careers, salaries, preparation facts, and evidence limits are present.</li><li><strong>Minute 32:</strong> recommendation includes two exact facts and an honest tradeoff; the highest salary is not required.</li><li><strong>Minute 42:</strong> three salary-minus-target calculations, revised monthly result, correction, and remaining limit are visible. Students behind use the fixed evidence and labeled bullets; do not cut a rubric criterion.</li><li><strong>Trim/recovery:</strong> cut warm-up sharing and decorative formatting. Protect every rubric job, the final self-check, private submission, and calculator/device return. If incomplete at minute 47, save the same portfolio and schedule recovery; do not add homework or resubmit Days 1-4.</li><li>Fixed May 2024 U.S. medians: Architects $96,690; Civil Engineers $99,590; Electricians $62,350. Dallas annual before-tax target: $48,489. Expected differences: $48,201; $51,101; $13,861.</li></ul>",
