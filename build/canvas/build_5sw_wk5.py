...
DAY_TITLES = {
    ...
    5: "MAJOR DRAFT: Personal Budget and Career Evidence Portfolio",
}
...
def student_content(files, visuals, urls):
    ...
    return {
        ...
        5: {"TITLE":"Personal Budget and Career Evidence Portfolio","PURPOSE":"Compare three careers on one salary basis and revise a budget decision using accurate labels and your current priorities.","TODAY":"<ul><li>compare three careers;</li><li>publish the math;</li><li>connect evidence to lifestyle priorities;</li><li>audit and revise before private submission.</li></ul>","READY":f'<p>Open {link(files["PORTFOLIO"]["id"], "the six-page portfolio")}, {link(files["RUBRIC"]["id"], "the two-page rubric")}, and your Days 1–4 work.</p>',"MEDIA":"","STEPS":step(1,"Use one salary basis","<p>Use exact Xello labels for all three careers only when they are comparable. Otherwise use the fixed May 2024 U.S. BLS medians in the packet.</p>")+step(2,"Compare all three","<p>For each career record source/date/geography/measure, preparation, evidence, personal fit, and one limitation.</p>")+step(3,"Publish the math","<p>Show annual salary minus annual before-tax target. Then explain why a positive number does not prove affordability or fit.</p>")+step(4,"Audit and submit privately",f'<p>Use <a href="{urls[5]}">the private portfolio Assignment</a>. Revise the weakest rubric criterion before submitting by upload, text, media, or paper.</p>'),"EXIT":"<p>Name one repaired source label, one budget revision, and one unsupported claim you removed.</p>","DONE":"<ul><li>three comparable career records;</li><li>visible calculations;</li><li>priority-based decision;</li><li>source limitation;</li><li>self-audit and revision;</li><li>private submission.</li></ul>","SUPPORT":"<p>comparable = comparable · preparation = preparación · annual target = meta anual · evidence limitation = límite de evidencia · revise = revisar.</p>","FALLBACK":"<p>The fixed three-career evidence is complete. Missing prior work has a packet fallback. No public discussion, Xello screenshot, family budget, or H&amp;L favorite is required.</p>"},
    }
...
def teacher_content(files):
    ...
    return {
        ...
        5:{"TITLE":"Personal Budget and Career Evidence Portfolio","SUBTITLE":"50 minutes · TEKS d(5)(D), d(5)(E)","ALERT":"<strong>Major draft only.</strong> Keep unpublished and ungraded until the six-weeks assessment count and 40/60 groups are verified. Career preference and family finances are not scored.","PREP":f'<ul><li>Post {link(files["PORTFOLIO"]["id"], "the six-page portfolio")}, {link(files["RUBRIC"]["id"], "the rubric")}, and private Assignment.</li><li>Keep the fixed three-career fallback visible.</li><li>Have calculators available.</li></ul>',"EVIDENCE":"<p>Three comparable career records, visible calculations, priority-based decision, source limitation, self-audit, and revision. Major draft.</p>","FLOW":flow(c,"Warm-up · 5","Comparable evidence gate.")+flow("#4c8b38","Career records · 18","Three careers, same basis.")+flow("#8a4f2b","Math · 10","Salary minus annual target.")+flow("#d39b22","Decide/revise · 12","Priorities, limit, audit.")+flow(c,"Submit · 5","Private equivalent routes."),"MONITOR":"<p>Fixed May 2024 U.S. medians: Architects $96,690; Civil Engineers $99,590; Electricians $62,350. Dallas annual before-tax target: $48,489. Expected differences: $48,201; $51,101; $13,861. A positive difference is not take-home pay and does not prove affordability, job availability, fit, or starting salary. Score four criteria at 0–4: budget math/interpretation, source/measure accuracy, three-career comparison, and financial decision/revision.</p>","RESOURCES":'<p><a href="https://www.bls.gov/ooh/architecture-and-engineering/architects.htm">BLS Architects</a> · <a href="https://www.bls.gov/ooh/architecture-and-engineering/civil-engineers.htm">BLS Civil Engineers</a> · <a href="https://www.bls.gov/ooh/construction-and-extraction/electricians.htm">BLS Electricians</a> · <a href="https://livingwage.mit.edu/counties/48113">MIT Dallas County</a>.</p>',"SUPPORT":"<p>Each career has a full landscape page; calculations have dedicated rows; the final decision and revision each have full-width lines. Accept upload, text, media, dictation, or paper.</p>","FALLBACK":"<p>Use fixed career evidence when Xello is unavailable or labels are not comparable. No public Discussion, private profile screenshot, family budget, or H&amp;L favorite is required.</p>"},
    }
