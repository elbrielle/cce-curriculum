...
STUDENT_GOOGLE_COPY_URLS = {
    1: "https://docs.google.com/document/d/1rmIeqpPzwTRUJvJKAxeH0fqDMDP1PRM_1ESnNx3koDE/copy",
    2: "https://docs.google.com/document/d/1yq1erunMJwOVAyypSL7gQnLfEFv9qkrkS1y87YOEZZE/copy",
    3: "https://docs.google.com/document/d/1-okNQxhIQFERj4xI7ImKgPu7euyHUKPJpb3ydVuBALA/copy",
    4: "https://docs.google.com/document/d/18St15Ndab3OZFlJUhOOoyfd21E7pQW7jaBIyBgZfD5Y/copy",
    5: "https://docs.google.com/document/d/1Y6GFiN78tbPo076JbHb9u9JfMUml9ZEdHA66jl-6NL8/copy",
}
...
STUDENT_WORKSHEET_COPY_URLS = {
    (1, 'the two-page audience-test companion'): "https://docs.google.com/document/d/1oQDEvYpHKEYLU8kmJVTPhPvnrHz2yUpyCNjlBTG3Bdg/copy",
    (2, 'the two-page revision and changing-conditions companion'): "https://docs.google.com/document/d/1x3yn05MkwtZI0YzA6VdsilJp4n2r8G6irL16sNSvyRM/copy",
    (3, 'the two-page opportunity and revision companion'): "https://docs.google.com/document/d/1Au5ddUqTToRE1D07tOk-M_JVyGkVq_2SsCfuIZD2T_A/copy",
    (4, 'the two-page evidence-decision companion'): "https://docs.google.com/document/d/1yHrnWYmk_-vPT4Pe0-i0e2kcmGjoNLpquBPc8btGcj4/copy",
    (5, 'the four-page Marketing Evidence Brief'): "https://docs.google.com/document/d/1NVZtbE3qSfOR-nrCkJ65wIBguJ9i59tq7Vw3EHHb57U/copy",
}
...
QUESTIONS = [
    ...
    ("Q5 - platform boundary", "What counts as the required evidence this week?", "The private Canvas or paper reasoning and revision; H&L, eDynamic, Canva, and Adobe Express are optional supports.", ["Two H&L favorites", "A supplemental platform completion screen", "A public social-media post"], "Correct. Standards evidence is reasoning and revision, not a platform click.", "No public post or supplemental platform completion is required."),
]
...
def student_content(files, visuals, urls):
    ...
    media = lambda pairs: '<h3 style="color:#9a4d19;border-bottom:3px solid #efc5aa">Workbook pages</h3>' + ''.join(prior.image_tag(visuals[key]["id"], alt) for key, alt in pairs)
    minor_panel = (
...
def teacher_content(files):
    ...
    fallback = '<p>FYF is the default student work surface on Days 1-4. Locked workbook images plus the companion form the complete no-workbook route; students do not complete both routes twice. H&amp;L, eDynamic 4.1, Canva, Adobe Express, a public Discussion, real posting/sale/contact/payment, personal data, testimonials, tracking, and copied marks are not required. No Xello lesson is assigned in this week.</p>'
    return {
        1: {"TITLE": "Click Factor", "SUBTITLE": "50 minutes · FYF pp. 225-227 and 230", "ALERT": "<strong>Truth and privacy boundary:</strong> claims must use supplied evidence. Use only the fictional audience; do not collect, track, or target real student/minor data.", "PREP": f'<ul><li><strong>Default:</strong> one FYF workbook and device per student, one projector, zero prints. Post {link(files["CLICK"]["id"], "the two-page companion")} and private annotation route.</li><li><strong>Paper:</strong> one front-and-back companion per student, pencils/markers, and one collection tray. Students use either Canvas or paper, not both.</li><li><strong>Grouping:</strong> pairs compare CTAs and run the three-second test; each student completes and submits one response route. Teacher conference or self-test is equal.</li></ul>', "EVIDENCE": "<p>Check FYF drafts and ad in place. Collect only one individual audience-message chain, truth/access check, test, visible revision, and career/work-product connection.</p>", "MODEL": '<div style="border:1px solid #efc5aa;border-radius:8px;padding:12px 16px;background:#fff8f3"><p><strong>Model:</strong> Busy students need a quick way to compare the weekly snack-box mix. CTA: “Compare this week\'s sweet-and-salty mix.” Three-second test: the viewer saw “compare” but missed “weekly.” Revision: “Compare this week\'s snack-box mix.” Career: a marketing specialist records the tested copy and result.</p><p><strong>Non-example:</strong> “Only two boxes left—guaranteed favorite!” No supplied fact supports scarcity or a guarantee.</p></div>', "FLOW": (
            flow(color, "Minutes 0-6 - Welcome and ethical marketing vs. clickbait warm-up", '''<p>Welcome students to Week 3 of 6SW (Business, Marketing &amp; Finance Cluster) and project the digital advertising prompt.</p><ul><li>Ask students: <em>“When scrolling online, how do you tell the difference between an ethical, informative advertisement and manipulative clickbait? Why do professional marketing specialists rely on verifiable product facts, transparent calls-to-action (CTAs), and audience trust rather than exaggerated false promises or fabricated urgency?”</em></li><li>Collect 2-3 student thoughts: Clickbait tricks you with fake countdowns and false claims; ethical marketing solves real customer problems!</li><li>Bridge with, <em>“Marketing is about connecting genuine human needs to verified products and services. Today we analyze FYF pp. 225-227 and 230, master the anatomy of a Call to Action (CTA), create an ethical digital ad mock-up, and conduct a 3-second comprehension test.”</em></li></ul>''')
            + flow("#4c8b38", "Minutes 6-15 - CTA anatomy, visual hierarchy &amp; ethical ad modeling", '''<p>Deconstruct the 4 Core Elements of an Ethical Advertisement on the screen:</p><ul><li>1. <strong>Audience &amp; Problem:</strong> Clearly identify the target audience (e.g., busy middle school students) and their specific need.</li><li>2. <strong>Supplied Product Facts:</strong> Describe the product using ONLY verified, supplied attributes (no invented claims of 'world's best' or fake scarcity like 'only 2 left!').</li><li>3. <strong>Call to Action (CTA):</strong> An active, unambiguous directive verb + specific task (e.g., <em>“Compare this week's snack-box mix”</em> vs. vague <em>“Click here”</em>).</li><li>4. <strong>Visual Hierarchy &amp; Accessibility:</strong> High-contrast text, clear focal point, and readable typography for all viewers.</li><li>Model the Snack-Box Exemplar: Show how audience need &rarr; verified fact &rarr; clear CTA creates an effective, privacy-safe ad.</li></ul>''')
            + flow("#155d7a", "Minutes 15-32 - FYF ad mock-up creation sprint (FYF pp. 225-227 &amp; 230)", '''<p>Students construct their digital ad mock-up in FYF (or companion):</p><ul><li>Select one supplied product scenario and identify target customer pain points.</li><li>Draft 2 Alternative CTA Variations: Compare a direct action verb vs. an exploratory question.</li><li>Design Ad Layout: Incorporate headline, product visual, verified description, and high-contrast CTA button.</li><li>Career Connection: Explain how a Market Research Analyst uses ad performance data to refine customer messaging.</li><li><strong>Active Monitoring Checkpoints:</strong><br>• Lap 1 (Minute 22): Check that CTAs use action verbs and avoid manipulative fake urgency.<br>• Lap 2 (Minute 28): Confirm students include accessibility features (e.g., color contrast, readable text size).</li></ul>''')
            + flow("#d39b22", "Minutes 32-42 - Three-second comprehension test &amp; ad copy revision", '''<p>Elbow partners conduct the 3-second comprehension test:</p><ul><li>Partner views the ad for 3 seconds: 'What is the product and what action does the ad ask you to take?'</li><li>Record One Evidence-Based Copy Revision: Modify headline or CTA wording based on what the partner noticed or missed.</li></ul>''')
            + flow(color, "Minutes 42-50 - Submit Day 1 Companion and wrap-up", '''<p>Students submit their completed companion in Canvas or place paper copies in the collection tray.</p><ul><li><strong>Safe Trim:</strong> Skip decorative coloring; fiercely protect ad anatomy, factual accuracy, 3-second test revision, and private exit.</li></ul>''')
        ), "MONITOR": "<ul><li><strong>Minute 12:</strong> each student can point to one supplied fact and one clear action. If one-third invents urgency, pause and repair the model claim.</li><li><strong>Minute 30:</strong> every ad has an audience, accurate description, CTA, hierarchy, and access cue.</li><li><strong>Minute 42:</strong> before/after wording responds to test evidence, not decoration preference.</li><li><strong>Trim/recovery:</strong> supply the second sample CTA and cut optional polish/share-out. Protect one FYF ad, individual test/revision, career link, submission, and cleanup. Save the same companion for recovery.</li></ul>", "RESOURCES": sources, "SUPPORT": support, "FALLBACK": fallback},
        2: {"TITLE": "Written Communication and Changing Conditions", "SUBTITLE": "50 minutes · FYF pp. 147-148 + private companion + practice Quiz", "ALERT": "<strong>Fictional message:</strong> no real account, name, location, handle, photo, contact information, student data, or audience tracking. The Quiz is feedback after the private response, not the DOL.", "PREP": f'<ul><li><strong>Default:</strong> one FYF workbook and device per student, one projector, zero prints. Post {link(files["CHANGE"]["id"], "the two-page companion")}, private annotation route, and retryable Quiz.</li><li><strong>Paper:</strong> one front-and-back companion per student, pencils, one collection tray, and a five-question check only for a Canvas outage.</li><li>Students respond individually. A brief turn-and-talk may compare conditions without sharing personal social-media use.</li></ul>', "EVIDENCE": "<p>Collect one private FYF-message revision/conditions companion. Quiz feedback repairs labels but does not replace or duplicate the written evidence.</p>", "MODEL": '<div style="border:1px solid #efc5aa;border-radius:8px;padding:12px 16px;background:#fff8f3"><p><strong>Before:</strong> “We need books! #help.” <strong>After:</strong> “The fictional Little Library has room for about 20 gently used children\'s books. Use the classroom drop-off route.” The revision adds status, truthful action, and a private route.</p><p><strong>Conditions model:</strong> A 20% budget cut may reduce campaign spending and make result measurement more important. Accessible mobile content and privacy expectations require workers to check readable design, consent, accuracy, and human review. Preparation: practice data analysis and accessible message design. <strong>Limit:</strong> the BLS figure is a May 2024 U.S. median, not DFW starting pay.</p></div>', "FLOW": (
            flow(color, "Minutes 0-6 - Welcome and communication in changing markets warm-up", '''<p>Welcome students, seat them with FYF workbooks (pp. 147-148) or companions, and project the changing conditions prompt.</p><ul><li>Ask students: <em>“When societal habits or economic conditions shift dramatically—such as the rise of digital reading apps or family budget inflation—how must organizations change the way they communicate with the public? Why is vague messaging like ‘We need books! #help’ ineffective during a crisis?”</em></li><li>Collect 2-3 student thoughts: People need exact numbers, clear instructions, and privacy protection to take action!</li><li>Bridge with, <em>“Professional communicators adapt their messaging to shifting societal needs and economic realities under TEKS d(5)(C). Today we analyze the Little Free Library campaign, rewrite a vague announcement into an actionable notice, and evaluate BLS market research labor benchmarks.”</em></li></ul>''')
            + flow("#4c8b38", "Minutes 6-16 - Fictional community campaign modeling &amp; economic sensitivity", '''<p>Display Contrasting Campaign Notices and TEKS d(5)(C) Dimensions on the screen:</p><ul><li>1. <strong>The Vague Non-Example:</strong> <em>“We need books! #help.”</em> (Lacks quantities, drop-off location, target age group, and safety guidelines).</li><li>2. <strong>The Professional Exemplar:</strong> <em>“The fictional Little Free Library has room for about 20 gently used children's picture books. Please use the designated classroom drop-off bin during school hours.”</em> (Clear inventory limit, specific item requested, physical route defined, privacy protected).</li><li>3. <strong>Changing Economic &amp; Societal Conditions (TEKS d(5)(C)):</strong><br>• <strong>Economic Dimension:</strong> Inflation and municipal budget cuts reduce advertising budgets, making precise return-on-investment (ROI) tracking essential.<br>• <strong>Societal / Technological Dimension:</strong> Increased mobile smartphone use and digital privacy expectations require mobile-accessible designs and explicit data-consent practices.</li><li>4. <strong>Sourced BLS Benchmark for Market Research Analysts:</strong> May 2024 U.S. median annual wage = $74,680; 2024-34 projected growth = 8% (much faster than average); ~94,800 annual openings nationwide.</li></ul>''')
            + flow("#155d7a", "Minutes 16-32 - Message revision &amp; changing conditions analysis sprint", '''<p>Students complete their analysis on the companion (or Canvas):</p><ul><li>Part 1: Draft Professional Little Free Library Notice: Incorporate exact inventory capacity, drop-off route, and safety boundaries.</li><li>Part 2: Execute One Visible Revision: Edit wording to improve conciseness and accessibility.</li><li>Part 3: Analyze Changing Conditions: Complete the matrix detailing how 1 economic factor and 1 societal/technology shift alter the day-to-day work of marketing professionals.</li><li>Part 4: Document BLS Benchmarks: Record complete statistical labels for Market Research Analysts.</li><li><strong>Active Monitoring Checkpoints:</strong><br>• Lap 1 (Minute 22): Verify students rewrite the notice with specific logistical details.<br>• Lap 2 (Minute 28): Check that students distinguish economic factors (budgets/inflation) from societal factors (mobile tech/privacy).</li></ul>''')
            + flow("#d39b22", "Minutes 32-45 - Partner message review &amp; retryable practice Quiz", '''<p>Students cross-check their analysis and complete the 5-question retryable practice check:</p><ul><li>Elbow partners check: 'Does the notice protect student privacy and avoid collecting real personal data?'</li><li>Students launch the retryable Canvas Quiz, check conceptual understanding of economic vs. societal factors, and repair incorrect labels.</li></ul>''')
            + flow(color, "Minutes 45-50 - Submit Day 2 Companion and wrap-up", '''<p>Students submit their completed companion in Canvas and close workbooks.</p><ul><li><strong>Safe Trim:</strong> Defer multiple Quiz retries; fiercely protect the rewritten notice, economic/societal matrix, BLS labels, and private submission.</li></ul>''')
        ), "MONITOR": "<ul><li><strong>Minute 14:</strong> messages include status, truthful action, and no identifying data. If one-third copies the vague prompt, project the before/after model.</li><li><strong>Minute 32:</strong> students label $76,950 as May 2024 U.S. median, 7% as 2024-34 growth, and about 87,200 as annual openings; never substitute the 63,000 numeric employment change.</li><li><strong>Minute 43:</strong> economic effect concerns spending/budget/demand/hiring; societal/technology effect concerns behavior/tools/access/privacy/human review.</li><li><strong>Trim/recovery:</strong> defer Quiz retries and sharing. Protect the revision, two distinct effects, preparation, private submission, and cleanup.</li></ul>", "RESOURCES": sources, "SUPPORT": support, "FALLBACK": fallback},
        3: {"TITLE": "Expert Edge", "SUBTITLE": "50 minutes · FYF pp. 222-224", "ALERT": "<strong>Classroom plan only:</strong> no sale, payment, booking, contact, account, client data, public promotion, income promise, or copied identity.", "PREP": f'<ul><li><strong>Default:</strong> one FYF workbook and device per student, one projector, zero prints. Post {link(files["EXPERT"]["id"], "the two-page companion")} and private annotation route.</li><li><strong>Paper:</strong> one front-and-back companion per student, pencils/markers, and one collection tray.</li><li><strong>Grouping:</strong> individual plan; partner, teacher conference, or self-check for feedback. Oral pitch and logo polish are optional.</li></ul>', "EVIDENCE": "<p>Check the FYF service plan in place. Collect only one individual opportunity chain, responsibility/risk/control, private test, visible revision, and career/work-product connection.</p>", "MODEL": '<div style="border:1px solid #efc5aa;border-radius:8px;padding:12px 16px;background:#fff8f3"><p><strong>Model:</strong> Skill: organizing digital photos. Need: a family wants a clear album plan. Deliverable: a labeled-folder plan and album outline. Fictional price: $8 per planning outline—not an income promise. Responsibility: describe what is included. Risk: private photos could be exposed. Control: use fictional filenames only and never collect files. Test note: the limit was unclear. Revision: add “planning outline only; no photo upload.” Career: a marketing specialist tests the service description.</p><p><strong>Non-example:</strong> “I like photos, so I have a business.” A hobby alone is not a need, deliverable, or bounded opportunity.</p></div>', "FLOW": (
            flow(color, "Minutes 0-6 - Welcome and entrepreneurship opportunities vs. hobbies warm-up", '''<p>Welcome students, seat them with FYF workbooks (pp. 222-224) or companions, and project the entrepreneurship prompt.</p><ul><li>Ask students: <em>“If someone says, ‘I love playing video games, so I'm an entrepreneur,’ what is missing from that statement? What transforms a personal hobby or interest into a viable business enterprise under TEKS d(3)(I)?”</em></li><li>Collect 2-3 student thoughts: A business requires a customer need, a defined deliverable, pricing structure, and legal liability management!</li><li>Bridge with, <em>“Entrepreneurship is about identifying market opportunities, taking calculated risks, and delivering structured value to clients. Today we complete FYF pp. 222-224 ('Expert Edge'), design a specialized consulting business plan, and analyze business owner responsibilities.”</em></li></ul>''')
            + flow("#4c8b38", "Minutes 6-17 - Service business anatomy, pricing units &amp; risk controls", '''<p>Display the Entrepreneurial Business Framework on the main screen:</p><ul><li>1. <strong>Target Audience &amp; Unmet Need:</strong> Identify a specific client problem (e.g., busy families overwhelmed by disorganized digital photo collections across multiple phones).</li><li>2. <strong>Defined Deliverable:</strong> A concrete, bounded work product (e.g., a structured digital folder taxonomy and printed album design template; NOT touching private personal files).</li><li>3. <strong>Fictional Pricing Unit:</strong> Price per unit (e.g., $8 per organizational blueprint; classroom exercise only, not an income guarantee!).</li><li>4. <strong>Owner Responsibility vs. Business Risk vs. Control Mechanism:</strong><br>• <strong>Owner Responsibility:</strong> Clearly communicate project scope and complete deliverables on time.<br>• <strong>Business Risk:</strong> Client privacy concerns or corrupted data files.<br>• <strong>Control Mechanism:</strong> Work with dummy sample files only; provide written data privacy guarantee; never request passwords or personal uploads.</li></ul>''')
            + flow("#155d7a", "Minutes 17-34 - FYF Expert Edge consulting plan sprint (FYF pp. 222-224)", '''<p>Students author their consulting business plan in FYF and companion:</p><ul><li>Document Skill/Interest, Target Client Persona, and Client Problem.</li><li>Define Concrete Deliverable and Fictional Pricing Structure.</li><li>Detail Owner Responsibilities, Potential Business Risks, and Specific Control Mechanisms.</li><li>Draft Original Brand Name and Mission Statement (classroom mock-up; no trademark copying!).</li><li><strong>Active Monitoring Checkpoints:</strong><br>• Lap 1 (Minute 23): Verify plans define a specific deliverable rather than vague 'consulting.'<br>• Lap 2 (Minute 29): Ensure students separate business risk from control mechanisms.</li></ul>''')
            + flow("#d39b22", "Minutes 34-45 - Partner business audit &amp; scope revision", '''<p>Elbow partners conduct a peer risk audit:</p><ul><li>Partner reviews: 'Is the service scope clearly bounded? Does the control mechanism adequately protect both the client and the business owner?'</li><li>Execute One Concrete Revision: Refine service description to prevent scope creep or clarify boundaries.</li></ul>''')
            + flow(color, "Minutes 45-50 - Submit Day 3 Companion and wrap-up", '''<p>Students submit their completed companion in Canvas or file paper packets.</p><ul><li><strong>Safe Trim:</strong> Skip oral pitches and logo polish; fiercely protect the opportunity chain, deliverable definition, responsibility/risk/control matrix, and private submission.</li></ul>''')
        ), "MONITOR": "<ul><li><strong>Minute 12:</strong> students can name audience + need + deliverable. If one-third starts with logo only, reproject the model chain.</li><li><strong>Minute 29:</strong> the fictional price includes a unit and no income promise; responsibility, risk, and control are distinct.</li><li><strong>Minute 42:</strong> feedback produces one visible clarity or safety revision.</li><li><strong>Trim/recovery:</strong> cut logo polish and oral pitch. Protect opportunity reasoning, responsibility/risk/control, revision, career link, submission, and cleanup.</li></ul>", "RESOURCES": sources, "SUPPORT": support, "FALLBACK": fallback},
        4: {"TITLE": "Family Fun Pass", "SUBTITLE": "50 minutes · FYF p. 229, then p. 228", "ALERT": "<strong>Fictional workbook data:</strong> use the supplied group-level scenario only. Do not survey students, collect personal preference data, track behavior, or claim universal age-group patterns.", "PREP": f'<ul><li><strong>Default:</strong> one FYF workbook and device per student, one projector, zero prints. Post {link(files["FAMILY"]["id"], "the two-page landscape companion")} and private annotation route.</li><li><strong>Paper:</strong> one two-page landscape packet per student and one collection tray.</li><li>Students decide individually after one pair evidence-sort. No live survey, site, account, public pitch, or open-web research.</li></ul>', "EVIDENCE": "<p>Check the FYF pitch in place. Collect only one individual goal, two numbers and one quote/pattern, decision rule, limitation, next test/result, and career connection.</p>", "MODEL": '<div style="border:1px solid #efc5aa;border-radius:8px;padding:12px 16px;background:#fff8f3"><p><strong>Model:</strong> Goal: sales. Strategy: Influencer. Evidence: 1,450 past sales, very high engagement, and the focus-group quote about trusted recommendations. Conflict: Social had more clicks. Decision rule: for a sales goal, past sales matter more than clicks. Limit: a past campaign does not predict the next one. Test: run a small fictional A/B comparison and measure completed sign-ups. Career: a market research analyst reports the test result.</p><p><strong>Non-example:</strong> “Influencer is best because I like it.” Preference is not a decision rule.</p></div>', "FLOW": (
            flow(color, "Minutes 0-6 - Welcome and data-driven marketing decisions warm-up", '''<p>Welcome students, seat them with FYF workbooks (pp. 228-230) or companions, and project the marketing metrics prompt.</p><ul><li>Ask students: <em>“If an entertainment venue has a choice between a social media campaign that generated 50,000 video views or a direct community partnership that generated 1,500 ticket sales, which campaign was more successful? Why must a marketing director establish their business goal BEFORE choosing which metric matters most?”</em></li><li>Collect 2-3 student thoughts: Views don't pay bills if people don't buy tickets; the campaign goal determines which numbers count!</li><li>Bridge with, <em>“Data-driven marketing requires aligning specific metrics to organizational objectives. Today we complete the 'Family Fun Pass' case study on FYF pp. 228-230, analyze conflicting marketing evidence, and defend an evidence-based promotional strategy.”</em></li></ul>''')
            + flow("#4c8b38", "Minutes 6-15 - Campaign metrics, conflicting evidence &amp; decision rules", '''<p>Display the Family Fun Pass Marketing Dataset on the screen:</p><ul><li>1. <strong>The Strategic Business Goal:</strong> Maximize paid season pass sales for a local community family entertainment venue.</li><li>2. <strong>Three Promotional Channels Evaluated:</strong><br>• <strong>Strategy A (Social Media Ad Blitz):</strong> Highest click-through rate (3,200 clicks), 450 actual pass sales, $1,200 cost.<br>• <strong>Strategy B (Influencer / Brand Ambassador):</strong> 1,450 pass sales, highest conversion rate, focus-group quotes praising authentic trusted recommendations.<br>• <strong>Strategy C (Direct Mail &amp; Community Fairs):</strong> High local family awareness, 850 pass sales, highest production/postage costs.</li><li>3. <strong>Synthesizing Conflicting Data:</strong> Social media had the most raw digital clicks, but Influencer marketing produced more than 3x the actual paid sales!</li><li>4. <strong>Formulating an Evidence-Based Decision Rule:</strong> When the strategic objective is revenue/sales, direct conversions outweigh top-of-funnel clicks.</li><li>5. <strong>Limitation &amp; Next Test:</strong> Past campaign data does not guarantee next season's results; recommend running a small-scale A/B pilot test.</li></ul>''')
            + flow("#155d7a", "Minutes 15-32 - Family Fun Pass data analysis sprint (FYF pp. 228-230)", '''<p>Students analyze the data in FYF and complete their 2-page landscape companion:</p><ul><li>Section 1: Define the Primary Goal and Compare All 3 Strategies across clicks, conversions, and costs.</li><li>Section 2: Synthesize Evidence Stack: Cite at least TWO exact numbers and ONE qualitative focus-group pattern.</li><li>Section 3: Author Decision Rule: Defend why the chosen strategy aligns best to the primary goal despite competing metrics.</li><li>Section 4: Acknowledge Data Limitations: Formulate one follow-up A/B test to measure customer retention.</li><li><strong>Active Monitoring Checkpoints:</strong><br>• Lap 1 (Minute 22): Verify students cite exact data points from the workbook.<br>• Lap 2 (Minute 28): Check that students articulate a clear decision rule that addresses conflicting data.</li></ul>''')
            + flow("#d39b22", "Minutes 32-45 - Partner strategy defense &amp; limitation check", '''<p>Elbow partners debate their chosen marketing strategies:</p><ul><li>Partners challenge: 'Why didn't you pick Social Media since it had more clicks?'</li><li>Students defend their choice using their mathematical conversion evidence and decision rule.</li></ul>''')
            + flow(color, "Minutes 45-50 - Submit Day 4 Companion and wrap-up", '''<p>Students submit their completed companion in Canvas or hand in paper packets.</p><ul><li><strong>Safe Trim:</strong> Provide Strategy C cost data as a given; fiercely protect the strategic goal, 3-point evidence stack, decision rule, limitation, and private submission.</li></ul>''')
        ), "MONITOR": "<ul><li><strong>Minute 12:</strong> every student names a goal before a strategy. If one-third picks by preference, project the sales-goal model.</li><li><strong>Minute 29:</strong> the evidence stack has two exact numbers and one quote/pattern with meanings.</li><li><strong>Minute 43:</strong> conflict, decision rule, limitation, next test, and exact result are visible.</li><li><strong>Trim/recovery:</strong> supply the third-strategy comparison and cut sharing. Protect goal, three-point evidence, limit/test, career link, submission, and cleanup.</li></ul>", "RESOURCES": sources, "SUPPORT": support, "FALLBACK": fallback},
        5: {"TITLE": "Ethical Marketing Evidence Brief", "SUBTITLE": "50 minutes · Minor 3", "ALERT": "<strong>Minor 3:</strong> one private four-page brief plus the visible 16-point self-score and revision. Earlier work is reference evidence, not another upload.", "PREP": f'<ul><li><strong>Default:</strong> one device per student, one projector, zero prints. Post {link(files["BRIEF"]["id"], "the four-page brief")}, {link(files["RUBRIC"]["id"], "the two-page rubric")}, and private Minor 3 Assignment.</li><li><strong>Paper:</strong> one four-page brief and one two-page rubric per student, stapled as one set, plus one collection tray.</li><li>Students work individually. Prior work may be referenced; missing work uses the fixed recap/model rather than four replacement packets.</li></ul>', "EVIDENCE": "<p>Collect one brief and rubric/self-score with audience/communication, entrepreneurship, data decision, career/changing conditions, and one visible evidence revision.</p>", "MODEL": '<div style="border:1px solid #efc5aa;border-radius:8px;padding:12px 16px;background:#fff8f3"><p><strong>Complete model strip:</strong> A market research analyst studies audience response and reports results. For busy students, “Compare this week\'s snack-box mix” uses a supplied fact and collects no personal data; a three-second test led me to add “this week.” My fictional photo-organizing opportunity provides a labeled-folder plan only; the owner explains scope and uses fictional filenames to control privacy risk. For the Family Fun Pass sales goal, Influencer is supported by 1,450 sales, very high engagement, and the trusted-recommendation quote, but past data cannot guarantee the next result, so I would measure completed sign-ups in a small fictional test. Economic budget pressure may reduce campaign spending; accessibility/privacy/tool changes require data analysis, accessible design, and human review. I would practice those skills and verify live program details.</p><p><strong>Non-example:</strong> “Marketing fits because social media is fun and the salary is $76,950.” Preference and an unlabeled median do not complete the evidence jobs.</p></div>', "FLOW": (
            flow(color, "Minutes 0-7 - Welcome and marketing synthesis architecture warm-up", '''<p>Welcome students, seat them with their Week 3 companions or fixed recap models, and project the Minor 3 prompt.</p><ul><li>Ask students: <em>“Across this week, we explored ad CTAs, community messaging during economic changes, entrepreneurship, and campaign data analysis. How do all four of these competencies connect in the daily work of professional market research analysts and marketing managers?”</em></li><li>Collect 2-3 student thoughts: They use research to find customer needs, write truthful messages, manage business risk, and make data-driven decisions!</li><li>Bridge with, <em>“Today is Minor 3: Ethical Marketing Evidence Brief! We synthesize our findings across all 4 domains into a professional 4-page evidence brief scored against our 16-point rubric.”</em></li></ul>''')
            + flow("#4c8b38", "Minutes 7-15 - Minor 3 brief structure &amp; 16-point rubric deconstruction", '''<p>Display the 4 Core Brief Sections on the main screen:</p><ul><li>1. <strong>Audience &amp; Ethical Communication:</strong> Target customer persona, truthful CTA with zero fake scarcity, and 3-second test revision.</li><li>2. <strong>Entrepreneurial Opportunity &amp; Risk:</strong> Skill-to-need mapping, concrete deliverable, fictional pricing unit, and owner responsibility vs. risk control.</li><li>3. <strong>Data Decision &amp; Changing Conditions:</strong> Goal alignment, 3-point evidence stack (2 numbers + 1 quote), decision rule, follow-up test, and economic vs. societal shifts (TEKS d(5)(C)).</li><li>4. <strong>Career Connection &amp; Next Action:</strong> Sourced BLS labor benchmarks for Market Research Analysts ($74,680 median, 8% growth) and high school CTE alignment at MacArthur High School.</li><li>Review the 16-Point Rubric across all 4 criteria: Masters, Meets, Approaches, Needs Improvement.</li></ul>''')
            + flow("#155d7a", "Minutes 15-34 - Independent Minor 3 Evidence Brief assembly sprint", '''<p>Students author their 4-page Minor 3 Evidence Brief in Canvas (or stapled paper set):</p><ul><li>Complete Sections 1-4 using evidence from Days 1-4 (or the fixed model strip).</li><li>Ensure all quantitative figures include full source and date labels.</li><li>Author evidence-based conclusions and personal career reflections.</li><li><strong>Active Monitoring Checkpoints:</strong><br>• Lap 1 (Minute 22): Verify students document complete statistical labels for BLS data.<br>• Lap 2 (Minute 29): Confirm all 4 rubric jobs are fully addressed with concrete evidence.</li></ul>''')
            + flow("#d39b22", "Minutes 34-44 - Rubric self-score &amp; visible evidence repair", '''<p>Students evaluate their brief against the 16-point rubric:</p><ul><li>Self-Score honestly across all 4 criteria.</li><li>Execute a 2-minute visible revision: Elevate the evidence in their lowest-scoring section by adding specific data or clarifying a boundary.</li></ul>''')
            + flow(color, "Minutes 44-50 - Submit Minor 3 Brief and wrap-up", '''<p>Students submit their completed Minor 3 brief in Canvas or hand in paper packets.</p><ul><li>Congratulate students on completing Minor 3 with rigorous, evidence-based marketing scholarship!</li><li><strong>Safe Trim:</strong> Accept labeled bullets; fiercely protect all 4 rubric criteria, self-score, visible revision, and private submission.</li></ul>''')
