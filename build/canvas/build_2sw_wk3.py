...
async def main():
  ...
  <p><a href="/courses/{COURSE_ID}/files/{files['RUBRIC']['id']}/preview">Open the 16-point scoring guide</a>.</p>
        ...
        td={
          ...
          5:{"TITLE":"Build a Nursing Career Evidence Map","SUBTITLE":"50 minutes · TEKS d(1)(C)","ALERT":"<strong>Use one evidence basis.</strong> Students compare the fixed nursing careers with the year, geography, and measure attached to every pay figure. No saved-career prerequisite, profile screenshot, or platform completion is required.","PREP":f'<ul><li>Open the fixed Nursing Career Route Guide and one completed comparison model.</li><li><strong>Default grouping:</strong> individual evidence map with one brief partner rehearsal.</li><li>Provide one <a href="/courses/{COURSE_ID}/files/{files["REFLECTION"]["id"]}/preview">Nursing Career Evidence Map</a> per student as paper or digital annotation. Do not print a second packet.</li></ul>',"EVIDENCE":"<p>Collect one individual map comparing at least three nursing careers, one supported current-fit statement, and one exact fact to verify next. Do not grade H&amp;L or eDynamic clicks.</p>","FLOW":flow("#5a2d91","Career and missing fact · 5 minutes","Name one career worth exploring and one fact still needed.")+flow("#4a9d2f","Audit three careers · 20 minutes","Record responsibility, preparation, work condition, and source-labeled pay.")+flow("#1f617a","Compare and decide · 20 minutes","Use Week 0 or career-task evidence to support one current fit and one next question.")+flow("#e3ad19","Collect and close · 5 minutes","Submit the evidence map and name the source label that mattered most."),"MONITOR":"<p><strong>Minute 10:</strong> target = three career names and one responsibility for each. <strong>Minute 25:</strong> target = preparation, work condition, and source-labeled pay entered for all three. <strong>Minute 40:</strong> target = current-fit claim plus one exact next fact. <strong>Safe trim:</strong> provide the completed nursing-assistant row and require two additional rows; protect the supported current-fit statement and question to verify.</p>","SUPPORT":"<p>Highlight the same four evidence fields on each career row. Keep compare/comparar, responsibility/responsabilidad, preparation/preparación, and work condition/condición de trabajo visible. Allow oral rehearsal before the final statement.</p>","FALLBACK":"<p>Use the fixed guide and the paper or Canvas response home your teacher assigned. An absent student completes the same comparison.</p>"}}
        contracts={
