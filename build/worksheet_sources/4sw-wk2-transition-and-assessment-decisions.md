---
title: High School Transition and Assessment Decisions
slug: 4sw-wk2-transition-and-assessment-decisions
kind: worksheet
...
Foundation plan plus an endorsement: ______ credits
...
One fact I need a counselor to verify for my own graduation plan:

[[lines: 2]]

## 2. My current pathway connection

Current career or pathway direction: ___________________________________________

Possible endorsement: _______________________________________________________

Why this connection makes sense based on my evidence:
...
## 4. Analyze two scenarios

**Scenario A:** A student wants to earn college credit in high school and later apply to a four-year university.
...
## 5. My current decision

One assessment or result I should learn more about: ______________________________

It may affect my plan because:

[[lines: 3]]

The source or person I will use to verify the requirement:

[[lines: 2]]

## Done when

- [ ] I recorded the current graduation framework.
- [ ] I connected one pathway to a possible endorsement without treating it as final.
- [ ] I explained what different assessments affect.
- [ ] I analyzed two scenarios.
- [ ] I named one fact to verify with a current source or counselor.
