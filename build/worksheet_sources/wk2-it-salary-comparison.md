---
title: IT Salary Comparison Worksheet
slug: wk2-it-salary-comparison
kind: worksheet
...
The **H&L DFW Salary** row comes from your Day 2 notebook notes. The other rows come from the BLS page for that career. Fill in every box.

| Field | Career 1 | Career 2 | Career 3 |
|---|---|---|---|
| **Career Name** | | | |
| **H&L DFW Salary** (the range in the app) | | | |
