...
agenda(S(3), {
  ...
  steps: [
    ...
    "Open Hats & Ladders from ClassLink and finish Jumpstart Your Profile",
...
await guidedScreen(S(8), { kicker: KICKER, title: "Step 3 · Open Hats & Ladders", screen: "The Hats & Ladders home after ClassLink signs you in", action: "Open ClassLink.\nSelect Hats & Ladders.\nCheck that the name at the top is yours.", done: "Your name is at the top and the yellow Profile Climbs card is on the screen.", image: assets.dashboard, alt: "Hats and Ladders home showing the yellow Profile Climbs card after ClassLink sign-in", callout: "OPEN" });
...
recap(S(12), {
  ...
  steps: [
    "ClassLink → Hats & Ladders → check your name → open Profile Climbs.",
...
const notes = [
  { time: "0:00-0:01", move: "Day divider while students check out assigned devices. Before class: test ClassLink → Hats & Ladders → Profile Climbs → Jumpstart and Discover Your Core; distribute the Day 2 response page.", student: "Check out the device and sit.", lookFor: "Devices out; Day 2 page open.", pivot: "Show for seconds only.", recovery: RECOVERY_HL, sources: [SRC_AVID, SRC_LESSON] },
