...
setParagraphs(5, reflectionBody, [
  ...
  { text: "Minute 13: everything is open or marked pending. Do not recopy.", bold: true, spaceBefore: 14 },
]);
...
setText(8, "Reflection Questions", "Minor 1 Rubric: 12 Points");
...
setParagraphs(10, reflectionBody, [
  ...
  { text: "If one third of the class stalls, pause for one anonymous model revision.", spaceBefore: 14 },
]);
...
setText(13, "Reflection Questions", "Submit Once: Minor 1, Not a Major");
setParagraphs(13, reflectionBody, [
  { text: "Choose one route only:", bold: true },
  ...
  { text: "Minor 1, not a Major. Do not submit Day 2-3 pages or a second exit ticket.", bold: true, spaceBefore: 14 },
  { text: "Missing one result? Mark pending and finish it Friday.", spaceBefore: 10 },
]);

const notes = [
  ["Time: 0:00-0:30", "Teacher move: Open the lesson and name the purpose: today turns three saved inputs into one reflection.", "Students: Open the Climber Profile, FYF workbook, and Day 2-3 notes.", "Look-for: Students know this is reflection and submission, not another assessment.", "Support: Read the subtitle aloud and point to the three evidence sources.", "Pivot/trim/recovery: Do not cut orientation; keep it under 30 seconds.", "[Sources]", "- Jenna Hainlen, AVID Week 1.5 slide 1, cover layout; owner-authorized reuse.", "- CCE Day 4 canonical lesson, accessed 2026-08-15.", "[/Sources]"],
  ["Time: 0:30-1:00", "Teacher move: Use as the Thursday divider while students open materials.", "Students: Finish opening the required sources.", "Look-for: Profile, workbook, and notes are visible.", "Support: Point to the open-materials list in the Student Guide as needed.", "Pivot/trim/recovery: Keep this transition under 30 seconds.", "[Sources]", "- Jenna Hainlen, AVID Week 1.5 slide 16, day-divider layout.", "[/Sources]"],
  ["Time: 1:00-5:00", "Teacher move: Run the private profile warm-up, then preview the four lesson moves. Do not require public disclosure.", "Students: Privately answer what the profile knows now that it did not know on Day 2.", "Look-for: Students identify one new result or mark a result pending.", "Support: Accept a word, phrase, typed response, or oral rehearsal.", "Pivot/trim/recovery: If entry takes longer, sample no more than two voluntary answers.", "[Sources]", "- Jenna Hainlen, AVID Week 1.5 slide 17, Welcome/Get Ready/Today's Lesson choreography.", "- CCE Day 4 profile warm-up.", "[/Sources]"],
  ["Time: 5:00-9:00", "Teacher move: Preserve Jenna's retrieval move: students open existing notes before being asked to apply them. Check access, not neatness.", "Students: Open their core type, work values, Building Blocks, recommendations, and Day 2 prediction.", "Look-for: Students point to existing evidence rather than copying it into a new holding sheet.", "Support: Pair a student with the exact source location; allow pending for one unavailable result.", "Pivot/trim/recovery: If the platform is slow, use saved notebook/FYF evidence and keep moving.", "[Sources]", "- Jenna Hainlen, AVID Week 1.5 slide 9, retrieve-notes choreography and retained notebook visual; owner-authorized reuse.", "- CCE Day 4 gather-the-evidence step.", "[/Sources]"],
  ["Time: 9:00-13:00", "Teacher move: Read the five-item checklist and make one active-monitoring lap.", "Students: Point to each source and mark any missing item pending.", "Look-for: By minute 13, every student has all sources open or a visible pending mark.", "Support: Read the five labels aloud; do not require recopying.", "Pivot/trim/recovery: Record access problems for Friday rather than troubleshooting all period.", "[Sources]", "- Jenna Hainlen, AVID Week 1.5 slide 13, group reflection/action frame.", "- H&L Climber Profile outputs from Days 2-3; district-licensed, authenticated use only.", "[/Sources]"],
  ["Time: 13:00-15:00", "Teacher move: Read the complete model once. Ask students to point to the type, value, Building Block, career, and unknown.", "Students: Identify how evidence supports the career curiosity.", "Look-for: Students can distinguish a career from a cluster.", "Support: Keep the model projected and read the evidence nouns aloud.", "Pivot/trim/recovery: Protect this model; shorten student discussion instead.", "[Sources]", "- CCE Day 4 complete model.", "- Jenna Hainlen, AVID Week 1.5 slide 13, reflect-and-apply choreography.", "[/Sources]"],
  ["Time: 15:00-16:00", "Teacher move: Show the non-model and elicit the two missing pieces before revealing the fix.", "Students: Name that Health Science is a cluster and fits me is unsupported.", "Look-for: Students use career and evidence precisely.", "Support: Offer the frame: A stronger answer would name ___ and evidence from ___.", "Pivot/trim/recovery: If time is tight, state both fixes in 30 seconds.", "[Sources]", "- CCE Day 4 non-model.", "- Jenna Hainlen, AVID Week 1.5 slide 13, reflection frame.", "[/Sources]"],
  ["Time: 16:00-18:00", "Teacher move: Translate the 12-point rubric into three student checks without adding a second assignment.", "Students: Locate which section of the reflection shows each criterion.", "Look-for: Students understand uncertainty can be accurate self-awareness.", "Support: Read each heading and one example; keep the rubric available in the Student Guide.", "Pivot/trim/recovery: Protect criteria; shorten explanation to one example per heading.", "[Sources]", "- CCE Day 4 12-point student rubric.", "- Jenna Hainlen, AVID Week 1.5 slide 13, reflection frame.", "[/Sources]"],
  ["Time: 18:00-25:00", "Teacher move: Launch items 1-5. Lap 1 checks that answers match an open source rather than memory.", "Students: Complete items 1-5 from their saved evidence.", "Look-for: Exact result language and pending marks where needed.", "Support: Allow speech-to-text, dictation, or bilingual support; do not change the evidence requirement.", "Pivot/trim/recovery: Students with one missing result complete every independent item.", "[Sources]", "- CCE Day 4 work chunk, items 1-5.", "- H&L Climber Profile outputs from Days 2-3; district-licensed, authenticated use only.", "[/Sources]"],
  ["Time: 25:00-33:00", "Teacher move: Launch item 6 and make Lap 2. If one third stalls, annotate one anonymous example once.", "Students: Name one career and connect it to at least two pieces of evidence.", "Look-for: A career, two evidence-based sentences, and one remaining question.", "Support: Keep the complete sentence frame visible; accept oral rehearsal before writing.", "Pivot/trim/recovery: Do not repeat the explanation desk by desk; pause once for a whole-group repair.", "[Sources]", "- CCE Day 4 item 6 criteria and complete model.", "- Jenna Hainlen, AVID Week 1.5 slide 13, reflect-and-apply choreography.", "[/Sources]"],
  ["Time: 33:00-40:00", "Teacher move: Launch items 7-8 and make Lap 3. State the privacy routes aloud.", "Students: Record one surprise/question and three support roles or people.", "Look-for: Three supports; roles, initials, trusted people, or fictional roles all count.", "Support: Never require full names or public disclosure of relationships.", "Pivot/trim/recovery: If time is short, protect item 8 and let item 7 be one sentence.", "[Sources]", "- Find Your Future p. 22, Building a Career Community; district-licensed, authenticated use only.", "- CCE Day 4 privacy rule.", "[/Sources]"],
  ["Time: 40:00-46:00", "Teacher move: Ask students to use the rubric and make one visible revision. Verify change, not neatness.", "Students: Self-check and revise one response.", "Look-for: Added evidence, clearer sentence, corrected career/cluster label, or named unknown.", "Support: Speech-to-text, dictation to an adult, bilingual support, or oral rehearsal may support the writing.", "Pivot/trim/recovery: Protect one revision even if only three minutes remain.", "[Sources]", "- CCE Day 4 self-check and revise step.", "- Jenna Hainlen, AVID Week 1.5 slide 13, reflection choreography.", "[/Sources]"],
  ["Time: 46:00-50:00", "Teacher move: Verify one approved route and repeat the exact grading language: Minor 1, not a Major. Store it for later retrieval.", "Students: Upload one file, use exact labels 1-8 in text, or hand in one labeled paper.", "Look-for: One submission only; no duplicate notebook page or exit ticket.", "Support: A student missing one result marks pending and uses Friday catch-up before scoring.", "Pivot/trim/recovery: Protect submission confirmation. Cut any whole-group share.", "[Sources]", "- CCE Day 4 Demonstration of Learning and submission routes.", "- Jenna Hainlen, AVID Week 1.5 slide 13, reflection/close frame.", "[/Sources]"],
];
...
const finalInspect = await presentation.inspect({ kind: "slide,textbox,image,notes", maxChars: 500_000 });
