...
const notes = [
  { time: "Before class", move: "Open this deck, the Day 3 Student Guide, and the private response page. Test ClassLink → Hats & Ladders → Profile Climbs → Discover Your Work Values. Set FYF pp. 9-11 at each seat, one workbook per student.", student: "None yet.", lookFor: "One workbook per student; the six-value list visible without another packet.", pivot: "If H&L is down before class, plan the provisional-value move now and protect Friday catch-up.", recovery: RECOVERY_HL, sources: [SRC_LESSON, SRC_AVID] },
