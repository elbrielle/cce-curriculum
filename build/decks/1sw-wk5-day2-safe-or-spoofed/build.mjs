...
const hqimSource =
  "District-licensed Find Your Future workbook; Find Your Future, pp. 24-25, Safe or Spoofed?; authenticated Canvas use only.";
const climberSource =
  "District-licensed Climber Notes; Hats & Ladders, Climber Notes: Safe or Spoofed?, slides 2-8; authenticated Canvas use only.";
const climberEmailSources = {
  1: "District-licensed Climber Notes; Hats & Ladders, Climber Notes: Safe or Spoofed?, slide 2, Email #1; authenticated Canvas use only.",
  2: "District-licensed Climber Notes; Hats & Ladders, Climber Notes: Safe or Spoofed?, slide 3, Email #2; authenticated Canvas use only.",
  3: "District-licensed Climber Notes; Hats & Ladders, Climber Notes: Safe or Spoofed?, slide 4, Email #3; authenticated Canvas use only.",
  4: "District-licensed Climber Notes; Hats & Ladders, Climber Notes: Safe or Spoofed?, slide 5, Email #4; authenticated Canvas use only.",
  5: "District-licensed Climber Notes; Hats & Ladders, Climber Notes: Safe or Spoofed?, slide 6, Email #5; authenticated Canvas use only.",
  6: "District-licensed Climber Notes; Hats & Ladders, Climber Notes: Safe or Spoofed?, slide 7, Email #6; authenticated Canvas use only.",
  7: "District-licensed Climber Notes; Hats & Ladders, Climber Notes: Safe or Spoofed?, slide 8, Email #7; authenticated Canvas use only.",
};
const cisaSource =
...
const speakerNotes = [
  notes({time:"30 seconds",teacher:"Open the lesson and name the Topic. Do not teach the red flags yet.",students:"Open FYF pp. 24-25; students use p. 25 for the seven decisions.",monitor:"Materials are open before the bellringer begins.",support:"Read the subtitle aloud; point to the three verbs.",trim:"Do not cut this orientation slide.",sources:[lessonSource]}),
  ...
  notes({time:"30 seconds",teacher:"Preview the four lesson moves and check that every student has the response surface.",students:"Open FYF p. 25.",monitor:"No student is waiting for a live email account.",support:"Point to each verb as it is read.",trim:"Keep the four-step preview under 30 seconds.",sources:[lessonSource]}),
  ...
  notes({time:"1.5 minutes",teacher:"Model the Inspect-Decide-Respond routine. Keep the decision labels Safe-looking and Spoofed.",students:"Practice the complete response frame once.",monitor:"Every answer includes evidence and a safe action.",support:"Keep the frame projected during the first model.",trim:"If behind, read only the three verbs and the frame.",sources:[lessonSource]}),
  ...
  notes({time:"5 minutes",teacher:"Use FYF p. 25 discussion prompts and check each student’s margin integrity sentence. Collect only an assigned alternate checklist.",students:"Explain the hardest call and safe action orally; write the integrity sentence in the workbook margin.",monitor:"One visible clue, one independent route, and one honest/protective behavior appear.",support:"Read stems aloud; accept speech-to-text or teacher-recorded oral response when assigned.",trim:"Protected DOL; do not cut.",sources:[lessonSource]}),
  notes({time:"1 minute",teacher:"Run the final check and state the absence/catch-up route. Collect only the assigned evidence surface.",students:"Confirm all seven decisions and the margin sentence, then close the workbook.",monitor:"No one submits a live phishing message or extra worksheet.",support:"Direct absent students to FYF p. 25 and the seven Canvas images; the checklist is only an alternate writing surface.",trim:"Keep the completion check even in a shortened period.",sources:[lessonSource]}),
...
async function renderHtmlSlides() {
  ...
  const browser = await chromium.launch({ headless: true, executablePath: process.env.CCE_CHROMIUM_PATH || undefined });
