...
<body class="{page_class}">
  ...
  <footer class="site-footer">
    <div class="shell footer-grid">
      <div><h2>Public planning mirror</h2><p>This site makes the course structure and public resources easy to review. Canvas remains the classroom delivery environment for authenticated lessons, assignments, and licensed source material.</p></div>
      <div><h2>Built from one source</h2><p>Pages are generated from the tracked curriculum, not maintained as a second hand-edited copy. <a href="https://github.com/elbrielle/cce-curriculum">View the source on GitHub</a>.</p></div>
    </div>
  </footer>
...
def home_page(pages: dict[Path, Page]) -> str:
    ...
    <section class="hero"><div class="shell hero-grid">
      <div><p class="eyebrow">Irving ISD · Grade 7 · TEKS §127.2</p><h1>Build a career story from real evidence.</h1><p class="hero-copy">A 36-week Career and College Explorations course grounded in Hats & Ladders and <em>Find Your Future</em>, with Xello and technology used when they add a specific job.</p><div class="actions"><a class="button primary" href="{rel_url(current, Path('curriculum/index.html'))}">Browse all 36 weeks</a><a class="button secondary" href="{rel_url(current, launch.output)}">Open the launch week</a><a class="button tertiary" href="{rel_url(current, Path('resources/scope-and-sequence/index.html'))}">Read the scope & sequence</a></div></div>
      <div class="hero-compass" aria-label="36 weeks, six connected career chapters"><span class="route-line" aria-hidden="true"></span><strong>36</strong><p>weeks that move from self-discovery to a communicated career plan.</p></div>
    </div></section>
    <section class="section"><div class="shell"><div class="section-heading"><div><p class="eyebrow">The year at a glance</p><h2>Six chapters, one evidence trail</h2></div><p>Students revisit what they know about themselves, compare career evidence, test routes, and revise their next step. The sequence grows; it does not restart every Monday.</p></div><div class="chapter-list">{chapter_bands}</div></div></section>
    <section class="section launch-section"><div class="shell"><div class="section-heading"><div><p class="eyebrow">Start here</p><h2>Onboard the tools without losing the curriculum</h2></div><p>The first CCE week establishes a notebook route, then protects the H&L/FYF self-discovery spine and the required Xello access check.</p></div><div class="launch-rail">{launch_cards}</div></div></section>
    <section class="section"><div class="shell"><div class="section-heading"><div><p class="eyebrow">One job per tool</p><h2>A source hierarchy teachers can explain</h2></div><p>Students should not copy the same answer into four places. Each platform or artifact owns a distinct part of the learning.</p></div><div class="source-roles"><article class="source-role"><h3>H&L + Find Your Future</h3><p>The core career curriculum: personality, work values, career evidence, pathways, and the yearlong planning spine.</p></article><article class="source-role"><h3>Canvas</h3><p>Daily Teacher and Student Guides, private assignments, locked source files, and recovery routes.</p></article><article class="source-role"><h3>Xello + technology</h3><p>Named extensions and tools used only when they complete a specific course job.</p></article></div></div></section>
    """
...
def about_page() -> str:
    ...
    body = '''<header class="page-hero shell"><p class="eyebrow">How this mirror works</p><h1>Public enough to review. Private where it matters.</h1><p class="page-summary">The curriculum is built in code and delivered through Canvas, with a generated public mirror for planning and transparency.</p></header><div class="shell"><article class="prose"><h2>Canvas is the classroom</h2><p>Teacher and Student Guides, assignments, authenticated platform links, and licensed source files remain in Canvas. The teacher controls publication.</p><h2>GitHub preserves the plan</h2><p>The public site is generated from tracked curriculum Markdown and public-safe resources. It is not a second hand-edited course. A build manifest records every page and copied file.</p><h2>Licensed sources stay protected</h2><p>Hats & Ladders, <em>Find Your Future</em>, Xello, Climber Notes, and private AVID source files are used inside their allowed instructional boundary. They are never copied into the public build.</p><h2>Teacher craft stays visible</h2><p>The course uses teacher-created routines and source materials when they fit. Adaptations are made for a named Grade 7, CCE, access, or timing need, with provenance documented instead of quietly replacing the source with generic material.</p></article></div>'''
    return page_shell(current, "About this mirror", "How the CCE public mirror, Canvas course, and source boundaries work.", body, "page-about")
