# Day 1: Transportation Cluster and Survey Design
...
Students list three people whose work supports a commercial flight or city transportation trip. Invite roles passengers may not see: dispatcher, aircraft mechanic, route planner, baggage handler, air traffic controller, transportation analyst, or maintenance worker.
...
Read the cluster definition and the fictional Transportation Needs Analyst scenario. Students record:

- one movement problem;
- one career that could study or solve it; and
- one kind of evidence that career would need.
...
The packet includes one model of each type. Students adapt the structure but do not copy all ten questions from a model.

Monitor for three common defects:

1. a question pushes the respondent toward one answer;
2. answer choices leave out a likely response or overlap; or
3. a question asks for private information the analyst does not need.
...
- A strong multiple-choice item asks one clear question and includes mutually distinct choices plus “other/not sure” when needed.
