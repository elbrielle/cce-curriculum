...
Students use current Texas and Irving ISD planning sources to build a counseling-ready four-year course-plan draft, compare AP and dual-credit options, investigate multiple preparation routes after high school, set one SMART experience goal, and write an individual high school and career plan that can be revised as requirements change.
...
**Success Criteria:** I will know I am successful when my plan uses current sources, shows a four-year course sequence and one prerequisite chain, keeps three possible preparation routes open, compares an advanced or college-credit option, includes a backup, and names actions I can take before and during Grade 9.
...
- [BLS Occupational Outlook Handbook](https://www.bls.gov/ooh/about/ooh-faqs.htm)
- [Apprenticeship.gov Career Seekers](https://www.apprenticeship.gov/career-seekers)
- [USAGov Military Requirements](https://www.usa.gov/military-requirements)
...
- two-page Postsecondary Route Trail and College Credit Check
...
- **Preparation route:** One possible way to build the education, training, experience, or credential a career requires. A route is investigated and revised, not treated as a permanent Grade 7 choice.
...
| 3 | Postsecondary route trail and college credit | AP and dual-credit comparison, fixed-evidence route cards, overlap summary, three possible routes | two-page Route Trail and College Credit Check | Engage · Explain · Explore · Extend · Evaluate |
...
- Day 3 route trail shows whether students distinguish AP exam policy from dual-credit course completion, compare three preparation routes, and keep conditions attached to each claim.
...
- Add a fourth preparation route or one current advanced academic or technical opportunity after verifying the requirement and source date.
