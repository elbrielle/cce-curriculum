...
The workbook (p. 13-14) shares STEM statistics that motivate the activity:
- STEM jobs are projected to grow 10.4% over the next 10 years
- Only 20% of high school graduates are prepared for college-level STEM courses
- 74% of middle school girls are interested in STEM, but only 0.4% pursue it after HS
- Parents often lack STEM knowledge to help their children
...
The workbook lists example topics across the 4 STEM areas:
- **Science:** Environment, animals, biology
- **Technology:** Coding, robotics, digital safety
- **Engineering:** Designing solutions, building structures
- **Math:** Budgeting, problem solving, patterns in nature
...
The workbook (p. 15) instructs students to design a flyer for their program. The flyer must include:
- **Program name** (big, eye-catching)
- **Date and time**
- **Location**
- **What participants will do** (1-2 sentences)
- **Who it is for** (target audience)
- **A way for people to sign up** (QR code, phone number, email, or "Show up at...")
