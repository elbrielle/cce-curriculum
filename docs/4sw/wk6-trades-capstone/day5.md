# Day 5: Mid-Year Growth Reflection + Sharing Circle
...
| **5E Phases** | Engage: Warm-Up · Explore: Artifact gathering · Explain: Mid-Year Growth Reflection · Extend: Sharing circle and 5SW preview · Evaluate: Exit Ticket |
| **Deliverable** | Submitted Mid-Year Growth Reflection (the 4SW summative artifact) |
| **Materials** | Chromebooks, H&L accounts, My Career Journey reflection sheet from Week 0, the mid-year review Capstone pages (*Find Your Future* pp. 281-286), Day 2 Transferable Skills Matrix, Day 3 Jigsaw notes, printed Mid-Year Growth Reflection template (2 pages), projector |
...
- **Mid-year review pages:** Rung 1 Who You Are, Rung 2 Career Goal, and Rung 3 Career Deep Dive (FYF pp. 281-286)
- **Career iceberg** drawn during the mid-year review (FYF pp. 6-8: "The Career Iceberg")
- **Course-mapping pages:** Rung 6 Goal Setting and Rung 7 High School Plan (FYF pp. 292-296), the d(8)(C) artifact
- **This week, Day 2:** Transferable Skills Matrix
- **This week, Day 3:** Jigsaw research notes from professional associations
...
**Stop and Jot:** put Section 1 on screen, give a 4 minute box for the first draft, and post the three stems from the support list below. Read one strong sample answer aloud before the timer starts so students hear what specific sounds like, then read over shoulders while they write. If most first sentences name only a job title, pause the room and ask for one piece of evidence per sentence, a salary, a training length, or a class activity, before students move on.

**Section 2: The Most Surprising Thing I Learned This Semester (3-4 sentences)**

This is open-ended. Examples: "I never thought I would be interested in engineering, but flying the drone navigation course changed my mind." "I assumed all college pathways paid more, but I learned diesel techs make more than some teachers." "I thought a mechanic just replaced parts until I had to rank four problems and defend my order."
...
- "Communication. I ran the ATC simulation as the controller and gave clear runway commands to my team"
- "Problem solving. I changed my drone's flight path after the first run missed the gate"
- "Work ethic. I filled in an explanation for all four truck issues instead of stopping after the easy one"
