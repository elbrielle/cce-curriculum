...
Which of these actions requires membership: joining a student chapter, taking a certification test, following a federal rule, or using a professional association benefit? Students predict, then repair the answer from the cards.

## Activity 1: Four Organization Types (10 min)

- **CTSO:** school-connected student organization; SkillsUSA and TSA.
- **Professional association:** membership organization serving people in a profession; NSPE and AOPA examples.
- **Credentialing organization:** assesses or certifies knowledge/experience; ASE.
- **Government agency:** writes or enforces public rules and may issue certificates; FAA.
...
- SkillsUSA and TSA access depends on a school chapter/program.
