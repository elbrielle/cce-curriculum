...
| **Time** | 50 minutes |
| **TEKS** | d(1)(B), d(1)(C) |
| **Target** | I can separate what I can see from what a trained technician would still need to inspect. |
| **Evidence** | Individual evidence log, preliminary part questions, sequenced shop-process model, and changed-vehicle response |
| **Materials** | FYF pp. 149-152 embedded in Canvas; Crash Crew packet; projector; annotation/upload Assignment or paper |

## Before class

1. Open the three licensed Crash Crew pages in Canvas and check their smallest labels from the back of the room.
2. Post the five-page **Crash Crew Evidence and Preliminary Plan** packet and Canvas annotation activity.
...
Use the Crash Crew vehicle views. Students complete the evidence log independently:
...
Students select three visible conditions. For each, they record:
