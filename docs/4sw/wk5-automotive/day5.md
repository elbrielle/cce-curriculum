...
- **Demonstration of Learning:** Private four-part Automotive Evidence Brief with visible self-score and revision.
...
1. **Visible evidence:** one supported condition, one unsupported conclusion, and the authorized next evidence.
2. **Three-career comparison and direction:** compare all three May 2024 U.S. national medians, then choose one direction using two facts.
3. **Preparation route:** recommend a first route to investigate, with one advantage, tradeoff, and verification question.
4. **Limitation and next action:** name what the evidence cannot decide, take one action within seven days, self-score, and revise.
