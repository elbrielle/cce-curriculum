...
**Source:** FAA Drone Zone — [faa.gov/uas](https://www.faa.gov/uas)
...
1. **Pre-flight checklist** — battery charged, propellers attached, controller paired, surroundings clear
2. **Takeoff zone rules** — only takeoff inside the marked tape zone
3. **Altitude limit** — for indoor drones, no higher than 6 feet
4. **Bystander rules** — never fly directly over a person, always announce "drone up"
5. **Emergency landing procedure** — how to drop the drone safely if it goes out of control
6. **Battery safety** — never use a swollen or damaged battery, do not charge unattended
7. **End-of-flight checklist** — power off drone, return controller, log the flight
...
- **Takeoff:** Push throttle gently up
- **Hover:** Hold throttle steady at low altitude (3-4 feet)
