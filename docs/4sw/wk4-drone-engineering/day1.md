...
**The student task:** Create a blueprint for the tracking robot. The blueprint must show:
- How the robot will fly
- How it will navigate around trees
- How it will collect and send data back to researchers
- Use sketches, labels, and descriptions

**Step 1: Brainstorm with a Partner (5 min)**

Pair up. Discuss the workbook prompts (p. 121):
- Will your robot track jaguars, parrots, or tree-dwelling monkeys?
- How will your robot fly? Quadcopter rotors? Wings? Glide-and-perch?
- How will your robot navigate around trees? Cameras? Lidar? GPS?
- How will it collect data? GPS tags? Cameras? Microphones for animal sounds?
- How will it send data back? Radio? Cellular? Satellite uplink?
