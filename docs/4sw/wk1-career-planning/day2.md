# Day 2: H&L Career Plan + Iceberg Cartoon
...
Students complete three tasks in the Career Plan:

1. **Confirm RIASEC type** is still visible on their profile
2. **Add or confirm at least 3 favorited Hats** from their Day 1 top cluster
3. **Read the H&L pathway recommendations** the app generates for them
