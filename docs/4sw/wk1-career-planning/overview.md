...
|-----|-------|---------------|-------------|
| 1 | RIASEC Revisit + Favorites Audit | "Thinking About My Career Journey" self-check (Ch 16) + RIASEC vs. Favorites worksheet | Completed audit worksheet listing top 3 clusters by favorite count |
| 2 | H&L Career Plan + Iceberg | Iceberg Cartoon activity (Ch 16) + Career Plan tool deep-dive | Completed Iceberg Cartoon + Career Plan screenshot |
| 3 | Xello Quick Sims: The Real Game | Xello Real Game simulation + lifestyle vs. salary debrief | Completed Real Game decision log |
| 4 | eDynamic 8.1: Choosing a Career Path | eDynamic Unit 8.1 + Pathway Cross-Reference activity | eDynamic completion + pathway ranking sheet |
| 5 | Mid-Year Reflection + Gallery Walk | "Being a Career Thinker" reflection + dot-vote pathway gallery walk | Updated My Career Journey reflection sheet |
...
**Mid-Year Reflection (Day 5):** Students submit their updated My Career Journey reflection sheet showing growth from Week 0 to mid-year. The reflection must include: (1) RIASEC type comparison (Week 0 vs. now), (2) top 3 favorited careers with rationale, (3) selected Irving ISD pathway with the campus where it is offered, (4) one specific insight from the Iceberg Cartoon about the hidden work behind their goal. Scored on evidence of self-awareness growth (d(1)(A)), pathway selection with rationale (d(8)(A)), and connection between assessment data and career choice (d(8)(B)).

## Differentiation

### Scaffolded Learning
- Pre-printed sentence stems for the mid-year reflection: "My RIASEC type is _____. The clusters I explored most are _____. My top pathway is _____ because _____."
