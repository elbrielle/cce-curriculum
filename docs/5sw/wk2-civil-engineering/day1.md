...
1. **Watch the Engineering cluster tour video** (embedded in the H&L app). While watching, students jot down one engineering pathway that interests them.
2. **Review the Myth Busters** for Engineering (common misconceptions about who becomes an engineer).
3. **Read "Exploring the World of Engineering"** in the workbook (Ch 8, p. 120). The workbook covers five pathways: Mechanical/Aerospace Engineering, Electrical Engineering, Civil Engineering, Geospatial Engineering, and Drone Engineering.
