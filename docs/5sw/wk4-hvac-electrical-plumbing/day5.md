...
## Activity 3: Reflection and Week 5 Preview (5 min)

Whole-class reflection. Ask:

- Who now knows the difference between an architect, a civil engineer, and a construction manager? (Most should raise hands.)
- Who is considering a skilled trade career more seriously after this week?
- What is the most important thing you learned about the A&C cluster overall?

Preview next week: **Personal Finance / Budgeting**. Students will use the salary data they collected all cluster long (Architect, Civil Engineer, Construction Manager, Electrician, etc.) to build a real personal budget. For the first time, they will see if they can afford the lifestyle they want on the career salary they want.
