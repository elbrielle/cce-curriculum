...
|---|---|
| **Time** | 50 minutes |
| **Objectives** | Explore Welder career in H&L; complete the Skilled Trades Matrix with welding data; begin in-depth Jigsaw research on assigned trade |
| **TEKS** | d(2)(A), d(5)(A) |
| **Deliverable** | Completed Skilled Trades Matrix (all 4 trades) + Jigsaw research notes on assigned trade |
| **Materials** | Chromebooks, H&L accounts (Welder Hat in Manufacturing cluster), BLS Welder OOH page, Skilled Trades Matrix from Day 1, Jigsaw research template, projector |
...
## Activity 1: Welding Career Exploration (10 min)

**Source:** H&L Workbook Ch 14: Manufacturing (where Welder appears) + BLS OOH Welders
...
## Activity 2: Jigsaw Research — Deep Dive by Trade (30 min)

Assign each team one trade. Depending on class size, use 4-6 teams of 3-5 students each. If more than 4 teams, duplicate trades.
...
- **Support:** Provide a pre-curated list of 3 BLS and 2 H&L resources per trade. Students do not have to hunt for sources; they synthesize from the curated list.
- **Extension:** Research how welding robots are changing the trade. Which welding jobs are being automated, and which still require human welders? What makes those jobs "irreplaceable"?
- **ELL:** Bilingual Jigsaw research template. Pair ELL students with bilingual peers. The BLS website has some Spanish content available.
