...
| **TEKS** | d(5)(A), d(5)(B) |
| **5E Phases** | Engage: Warm-Up · Explain: Teacher-modeled analysis method · Explore: Independent labor market analysis · Extend: Rapid share-out recommendation · Evaluate: Exit Ticket |
...
**Chunking:** the five data points and the three classifications are eight separate moves. Model the five data points first, stop, and ask the room to name which of the five was hardest to find before you go on. Then model the three classifications. Whichever data point drew the most hands becomes the one you check first when students start their own work.
...
**Stop and Jot:** the three classification cells are the written part. Post the modeled Electrician row from Activity 1 as the exemplar and two stems, the full *"According to BLS data, the job outlook for _____ is projected to grow _____% over the next 10 years. In DFW, the average salary is $_____. This occupation is classified as high-demand because _____"* and the shorter *"This trade is high-demand because BLS says jobs will grow _____%."* Read cells over shoulders while students write. If most are writing Yes with no figure attached, stop the room and re-model one cell.
...
Three volunteers share their recommendation and one number behind it. Listen for the reasons to differ: highest pay, strongest growth, or the closest fit with the student's skills and interests.
