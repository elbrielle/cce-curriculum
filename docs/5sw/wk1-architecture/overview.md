...
Students examine how design, planning, drafting, and construction roles work together. They compare three careers using one dated evidence set, then create and explain a building design through a teacher-managed Tinkercad Classroom or an equal paper route.
...
- create a teacher-managed Tinkercad Classroom, enable its student-safety settings, and prepare a class code;
- test the Classroom, WebGL performance, saving, and current export workflow on the student Chromebook network;
- place a starter model and the equal paper-design packet in Canvas;
- upload the licensed *Find Your Future* crops and the “Unexpected Architecture” city-goals slide only to locked Canvas folders;
- print only the students who need paper copies; Canvas annotation, upload, typed response, or media response are the default routes;
- review the fixed career evidence and answer guidance before teaching.

Do not direct every student to create an individual Autodesk account. Students join the teacher-managed Classroom by code and nickname unless the district has approved another account route.

## Materials

- Chromebooks and projector
- Teacher-managed Tinkercad Classroom and tested starter model
...
- Building-design sketch, command card, portfolio rubric, and private Canvas Assignment
...
- Tinkercad and paper designs earn the same evidence. Tool speed, device access, artistic polish, and public speaking confidence are not scored.
...
| 3 | Tinkercad foundations or paper-equivalent design | Two-view sketch and first design build |
...
1. source labels and accurate career evidence;
2. design requirements and documented revision;
3. accurate career-role and cluster connection;
4. explanation supported by specific evidence.
...
- If Tinkercad is unavailable, students use the same two-view design packet and revision criteria on paper.
...
- [BLS Interior Designers](https://www.bls.gov/ooh/arts-and-design/interior-designers.htm)
- [NCARB licensure overview](https://www.ncarb.org/become-architect/earn-license)
- [Irving ISD MacArthur CTE](https://www.irvingisd.net/departments-services/career-and-technical-education-cte/high-school-cte/macarthur-high-school)
