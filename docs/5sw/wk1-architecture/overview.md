...
!!! tip "Teacher Prep Checklist (1–2 weeks before the week starts)"
    ...
    - [ ] **H&L Workbook:** Ch 3 (pp. 37–54) photocopied OR H&L site license allows digital Chromebook distribution
    - [ ] **TinkerCAD Accounts:** Test login with 2 student Chromebooks on your school network to confirm SSO works
    - [ ] **Network Whitelisting:** IT has whitelisted `tinkercad.com` and `*.autodesk.com` (submit request 10 business days prior); confirm eDynamic Learning access is active
...
**Irving ISD Pathway:** Architecture (MacArthur HS) leads to AutoDesk Revit Architecture certification.
