...
1. **Navigate** to [tinkercad.com](https://www.tinkercad.com)
2. **Click** "Join Now" → select "Sign in with Google" → use school Google account
3. Once signed in, click **"Create new design"** to open the workspace
4. **Identify the workspace elements** on the projector:
