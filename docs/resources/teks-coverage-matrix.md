...
|---|---|---|---|---|---|
| d(1)A | Analyze and discuss assessment results | **E** | Wk0 (1SW), 4SW Wk1 | 1SW Wk2 Day 5 (H&L Pathway Fit), 2SW Wk3 Day 5 (Xello Learning Styles), 2SW Wk4 Day 3 (Xello Education Experience), 2SW Wk5 Day 5 (CareerOneStop Skills Matcher), 3SW Wk1 Day 4 (Xello Life Experiences), 3SW Wk2 Day 5 (Xello Work Experiences), 3SW Wk3 Day 5 (Xello Interests), 3SW Wk5 Day 5 (Xello Career Factors), 5SW Wk1, 6SW Wk6 | Wk0 is the seeding week; 4SW Wk1 is the explicit mid-year reconciliation |
...
| d(4)B | Transferable skills | **E** | 1SW Wk3 Day 1, Wk4 Day 4; 2SW Wk5; 4SW Wk6 Day 2; 6SW Wk4 | Every Hat Research week | Explicit "transferable skills" language in multiple exit tickets |
...
| d(4)E | Community service and volunteerism | **I** | 6SW Wk1 Day 4 (named) | 2SW Wk1 legal service, 3SW Wk1 Day 4 (Xello Volunteer Hours), 4SW Wk6 STEM programs | Matrix audit 2026-04-17: 3SW Wk1 Day 4 Xello Volunteer Hours added to Implicit Weeks. Still a gap candidate overall, but the Xello volunteer-logging anchor adds a second systematic touchpoint |
...
| d(8)B | Document HS courses and postsecondary requirements | **E** | 4SW Wk2 (full week), 6SW Wk6 Day 2 | None | Same buffer-week risk as d(8)A |
...
- **Explicit:** 33 of 37 TEKS codes (89%)
- **Implicit only:** 4 codes: d(3)D, d(3)F, d(4)D, d(4)E
- **Hard gaps (no coverage):** 0

## Flagged for Round-2 Deepening

These codes are covered but thinly. Consider deepening during round-2 revisions if teacher feedback surfaces student weakness:

- **d(3)D (Impact of effective planning).** Students build Career Plans but the metacognition about WHY planning matters is not explicitly taught. Consider a 10-min framing activity in 4SW Wk1 or 6SW Wk6 where students articulate the cost of NOT planning.
- **d(3)F (Co-curricular/extracurricular importance).** Mentioned across multiple weeks but never the explicit focus. Consider a 4SW Wk1 Day 4 admonition: "Every pathway has a student organization. Joining it doubles your career-exploration speed." Or convert 4SW Wk6 Day 3 exit ticket to require a specific extracurricular plan.
- **d(4)E (Community service and volunteerism).** Single explicit mention in 6SW Wk1 Day 4. Consider cross-linking to Building Blocks in Wk0 Day 3 (volunteering IS a Building Block) and adding to 4SW Wk6 transferable-skills work.
