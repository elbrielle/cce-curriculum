...
**What is Happening at Irving ISD?** **Robotic Manufacturing at Singley Academy** (part of Singley's School of Innovative Technology) prepares students for industry-recognized manufacturing credentials. Students who follow this pathway can graduate with a credential that gets them hired at real factories without a 4-year degree. **Welding** is offered separately at **MacArthur High School** under the Architecture, Construction and Engineering school. The workbook's district pages add the local detail students respond to most (FYF pp. 210-211: "What is Happening at My District?"): a student-run business that runs client consultations, digital design, and physical production; the Robotics & Manufacturing program of study; labs with precision laser cutters, CNC machines, and 3D printers; the Fanuc Robot Operator 1 industry certification; SkillsUSA as the student organization; and teams that compete regionally, at state, and nationally.
