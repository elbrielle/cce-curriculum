...
- **TEKS:** d(1)(C), d(2)(A)
- **Demonstration of Learning:** Career research worksheet for one programming career.
...
- Web Developer: HTML, CSS, JavaScript, frameworks (React, Vue), responsive design
- App Developer: Swift or Kotlin, mobile UI design, app store publishing
- Game Developer: Unity or Unreal Engine, C# or C++, art tools, sound design
