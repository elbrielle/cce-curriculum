# Week 3: Computer Science & Networking Careers
...
- Dated Networking Career Cards and Emerging IT Career Evidence Guide, which carry current BLS occupation labels, preparation, May 2024 national medians, 2024-34 growth, and direct source links
...
- **Emerging Occupation:** A new or rapidly changing occupation connected to new technology, demand, or work tasks. A new-sounding job title by itself is not enough evidence.
- **Proxy Occupation:** A broader occupation used when a source does not report the selected job title separately. A proxy can provide useful context, but its numbers do not describe the exact title.
...
|-----|-------|---------------|-------------|-----|
| 1 | Networking and Data Careers | Four-career evidence comparison + optional H&L browse + transferable-skill Venn | Four-role comparison + evidence-based Venn exit | Engage · Explore · Explain · Evaluate |
...
- **Day 1:** Four-role networking/data comparison + Venn exit (Programming vs. Networking skill overlap). *d(1)(C), d(4)(B)*
