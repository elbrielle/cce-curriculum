...
1. **Network Administrator** — Day-to-day operations. Manages user accounts, troubleshoots Wi-Fi, monitors network traffic. Often the first networking job for someone with a 2-year degree or certifications.
