...
| 4 | Pathway + 2 specific Hats named correctly with workbook/H&L evidence. |
| 3 | Pathway + 2 Hats named, one Hat may be general-sounding. |
| 2 | Pathway + 1 Hat only, OR 2 Hats but misplaced in wrong pathway. |
| 1 | Only a pathway OR only a career, not both. |
...
| 4 | All three required elements (RIASEC + Work Value + Building Block) with specific evidence, not generic language. Connection is concrete (a daily task matches a personality trait). |
