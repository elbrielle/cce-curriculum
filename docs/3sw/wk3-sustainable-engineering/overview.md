# Week 3: Sustainable Engineering and Pest Patrol
...
**Success Criteria:** I will know I am successful when my drone design has six labeled features, three evidence links, and one honest tradeoff; my revision record shows a specific change; and my trends evaluation uses two sourced facts plus one evidence limit.

## Demonstration of Learning

Students submit one evidence packet: the final Pest Patrol drone design, a peer-review and revision record, and a two-trend career evaluation. The recommended scoring tool is the 16-point Sustainable Engineering Design and Evidence Rubric.
...
Environmental engineers work on water, air, waste, and pollution-control systems. Agricultural engineers improve farm equipment and systems such as irrigation, spraying, harvesting, and field monitoring. Wind technicians and solar installers maintain energy equipment through different preparation routes. The career guide uses current BLS national data with the measure and date attached, so teachers do not have to verify live H&L titles or search for salary figures during class.

Irving ISD currently lists **Sustainable Engineering at Nimitz High School** and **Drone Engineering at Irving High School**. Present these as district options students may investigate. Do not promise admission, a credential, or a job outcome.

## Source Boundaries

- BLS figures in the week guides are May 2024 U.S. medians and 2024-34 projections. They are not DFW starting pay.
- H&L remains an optional exploration route. It is not the only source students need to complete the week.
- USDA describes useful agriculture-drone applications and real limits such as cost, calibration, accuracy, and profitability. Avoid presenting a drone as a complete solution by itself.
- Licensed workbook and Xello pages appear only in authenticated Canvas.
...
- Keep required directions visible. Place examples, vocabulary, and catch-up help in optional disclosures.
