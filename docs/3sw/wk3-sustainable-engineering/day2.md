...
1. Facts are copied accurately.
2. "Drone must" statements describe a function, not a decoration.
3. Students can point to the source that supports the statement.
