...
| **Materials** | Chromebooks, TDLR website ([tdlr.texas.gov](https://www.tdlr.texas.gov)), printed TDLR Licensing Pathway worksheet, projector |
...
1. From the TDLR home page, click **Programs** → **Cosmetology**
2. The Cosmetology page lists license types (Operator, Esthetician, Manicurist, Salon, etc.)
3. Click on **Cosmetology Operator** → find the requirements section
4. Look for: Required Hours, Exam Requirements, Application Fee, Renewal Process
