...
| **TEKS** | d(1)(B), d(1)(C) |
| **Deliverable** | SFX Texture Concept and Lab Brief, pages 1-3 |
| **Materials** | FYF pp. 127-129, concept brief, colored pencils, projector |

## Before Class

- Post the student guide and concept brief in Canvas.
- Project FYF p. 127, then pp. 128-129.
- Prepare one strong texture-map model and one cluttered non-example.
...
## Activity 2: Read the SFX Challenge (10 min)

Use FYF p. 128. Students answer:

1. What is a makeup prosthetic, and what does it change?
2. Why do texture and layering make an effect more believable?

Students get three lines for the first response and four for the second. A partner may help with oral rehearsal, but every student records individual evidence.
...
- a 2-3 sentence character description;
- a 2-3 color palette with the job of each color;
- one equal build route;
- a material or digital-layer explanation; and
- a full-page labeled sketch with at least three layers or material choices.

**Active monitoring:** At minute 10, every student should have the main texture and route. At minute 17, the map should show three labels. Redirect designs that use many unrelated textures or name materials that cannot produce the chosen visual effect.

## Exit Check (5 min)

Students name:

- one Human Services career;
- one specific task that career performs; and
- one design skill from today that transfers to that task.

**DELIVERABLE:** Completed research notes, concept fields, and labeled texture map.

## Support and Absence Route

- Use the embedded workbook images and the complete concept brief.
- Offer a texture photo bank and oral rehearsal before writing.
