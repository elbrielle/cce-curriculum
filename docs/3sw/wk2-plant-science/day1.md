...
- Post the fixed career guide and the licensed workbook pages in Canvas.
- Provide plain paper for the system sketch. Chart paper is optional.
...
Read clues aloud and color-code water, light, nutrients, and cleanliness. Students may use labels and short phrases rather than paragraphs. The workbook provides substantial response space on pp. 89-90; the system design can use the back of the page or plain paper. An absent student completes the same individual route without a partner.
