...
Model one complete evidence chain: ingredient constraint, preparation choice, customer result. Do not prepare or taste food. Students should not promise that a fictional dish is safe for every customer.
...
Students give a 30-second menu explanation to a partner, teacher, or voice recorder, then write the transferable-skill response on the brief. Public presentation is optional.

**DELIVERABLE:** Culinary Twist Menu Brief with all four menu elements, three sketch labels, one reader revision, and one transferable-skill connection.

## Differentiation

- **Support:** Offer two possible special ingredients, a strong/flat description pair, and a labeled plate outline.
