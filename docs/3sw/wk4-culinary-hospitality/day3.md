...
## Activity 1: Assign Roles and One Crisis (8 min)

**Source:** (FYF p. 117: "Hotel Rescue")

Build teams of up to six and assign roles. Each team receives one crisis: overbooking, short-staffed retreat, or unready accessible room. Assigning one crisis protects the time needed for role-specific evidence and avoids shallow answers to all three.
...
## Activity 2: Verify, Protect, Coordinate, Communicate (20 min)
...
## Activity 3: Read Another Response (10 min)

Teams post or exchange their response. Each student reads one different crisis, records one strong move, and names one risk or unanswered question. A teacher model replaces peer work when a student is absent or a team is unfinished.
...
- **Support:** Use the role starters and complete Verify before joining the team.
