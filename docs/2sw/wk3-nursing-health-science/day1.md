# Day 1: Health Science and Nursing Routes
...
**EXIT TICKET** (Comparison Matrix) · [Printable PDF](../../resources/exit-tickets/2sw-wk3-day1-health-science-and-nursing-routes.pdf):
