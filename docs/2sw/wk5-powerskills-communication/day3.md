...
### 4. Draft, schedule, and revise (20 min)

Students write one career-exploration goal, two short time blocks, one obstacle, and an if-then backup strategy. Goals remain private by default. Students may use a private self-check, teacher conference, or optional peer response.

Monitor for:

- a count or visible product;
- a real deadline;
- actions under the student's control;
