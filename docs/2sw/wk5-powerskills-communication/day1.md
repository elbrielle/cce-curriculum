...
### 2. Powerskills across careers (8 min)
...
### 4. Smoothie-company plan (22 min)
...
Students complete the two-career transfer section. Full evidence names the career, a likely conflict, the first safe move, and what stays the same across both careers.
...
- Language support: conflict = conflicto; listen = escuchar; compromise = compromiso; respectful = respetuoso.
