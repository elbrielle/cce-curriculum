...
### 3. Fictional Little Library message (20 min)
...
### 4. Fixed-fact workplace rewrite (12 min)
...
- Provide the frame: “The ____ is ____. Please ____ by ____. Questions should go to ____.”
- Language support: status = estado; audience = audiencia; concise = conciso; proofread = revisar.
- If Canvas or the discussion is unavailable, the two-page lab is the complete equal route.
