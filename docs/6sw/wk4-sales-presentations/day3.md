...
2. **Body — Three Key Facts (2 minutes)**
...
- **ELL:** Provide a bilingual outline template with Spanish sentence starters ("Mi carrera es _____. Elegí esta carrera porque _____"). Allow the presentation to be delivered in Spanish or bilingual format. Pair ESL students with bilingual peers for outline review.
