...
1. **Self-Assessment:** Know what you want. Use your H&L Climber Profile, RIASEC, Building Blocks, and the favorites you've collected all year.
2. **Research Openings:** Search job boards (Indeed, ZipRecruiter, LinkedIn, Handshake), company websites, and networking. Use specific keywords.
3. **Prepare Materials:** Resume (Wk 2), cover letter (Day 2), references (Day 3). Have these ready BEFORE you find a job posting.
