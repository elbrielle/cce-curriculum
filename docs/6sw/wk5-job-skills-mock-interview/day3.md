...
1. **List 3 potential references** with name, title, and how they know you
2. **For each, write one sentence** explaining why this person would say something positive about you
3. **Draft a permission email** asking ONE of them to be a reference
