...
- Default: one device per student, one projector, zero prints. Post the three-page portfolio, one-page rubric, and private Minor 1 Assignment.
- Paper route: one three-page portfolio and one one-page landscape rubric per student, plus one collection tray.
- Have students retrieve the CCE Six-Weeks Evidence Log from the paper CCE binder or teacher-designated digital folder. Do not attach the log to Minor 1 or print a second copy by default.
...
## Evidence Log Entry 6

Complete the portfolio and its visible revision first. Then copy these short phrases into Entry 6:

- **Artifact or task:** Education Career Evidence Portfolio
- **Transferable skill:** one skill the student used
- **Evidence:** one visible action from the student's strongest portfolio evidence
- **Revision or recovery move:** the visible revision
- **Next step:** the next action in the portfolio conclusion

The paper log returns to the CCE binder. The digital log stays in the teacher-designated folder. Entry 6 is not part of Minor 1, is not uploaded, and is not scored. This early 6SW transfer gives the later resume and interview lessons an evidence source without requiring another submission.
...
- Trim sharing and workbook rereading first. Protect every rubric criterion, revision, private submission, short Entry 6 transfer, and cleanup. Use the same portfolio in a scheduled recovery window; do not add a second packet.
