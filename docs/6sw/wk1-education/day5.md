...
Full evidence includes a source/date, current local boundary, design choice tied to learning, accurate statewide/provider distinction, responsibility/qualification evidence, tested revision, service value, limitation, and specific next action. Career preference is not graded.
