# Day 5: Marketing Plan Pitches + eDynamic 4.1 + H&L Favorites
...
|---|---|
| **Time** | 50 minutes |
| **Objectives** | Pitch a 1-minute Mini Marketing Plan combining the week's work; begin eDynamic Unit 4.1; favorite Marketing careers in H&L |
| **TEKS** | d(1)(C), d(3)(I), d(5)(C) |
| **Deliverable** | 1-minute Marketing Plan pitch + Marketing favorites in H&L + eDynamic 4.1 progress |
| **Materials** | Chromebooks, H&L accounts, eDynamic Learning Unit 4.1, projector, timer |
...
## Activity 1: Mini Marketing Plan Pitches (25 min)

**Source:** Compilation of the week's work (Marketing on the Move + Think Inside the Box + Hat Research)

Today students pull together everything from this week into a 1-minute Mini Marketing Plan pitch. They will use their Subscription Box MVP from Day 3 as the product (or substitute a different product if they prefer).
...
## Activity 2: eDynamic Unit 4.1 — Enterprise and Money Matters (12 min)

**Source:** eDynamic Learning Unit 4.1 (scope-and-sequence column 9)

Direct students to log into eDynamic Learning and open **Unit 4.1: Enterprise and Money Matters**. This unit covers Business Management & Administration, Finance, and Marketing/Sales/Service clusters together. Students focus specifically on the Marketing content.
...
## Activity 3: H&L Marketing Favorites + Career Plan Update (5 min)

**Source:** H&L Workbook Ch 5 (Hat Finder) + Ch 16 (Career Plan)
