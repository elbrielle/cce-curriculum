...
- **Support:** Provide 3 sample slogans for each product option ("Dive into Adventure," "Cereal in a Cup," "Drive Yourself Different"). Students pick one and modify it. Pre-built Canva templates with empty text boxes ready to fill.
