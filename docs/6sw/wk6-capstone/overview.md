# Week 6: Career Evidence Capstone

**6th Six Weeks** | 5 class periods | flexible 50-minute sequence
...
| 4 | Communicated capstone/revision | Five-page delivery record | Private media/annotation Major draft |
| 5 | Course reflection/transfer | Seven-page reflection | Private Assignment |

## Grading and Access

The 24-point rubric is student-visible. It remains a **Major draft** until the sixth-six-weeks 40/60 map is verified. Missing old pages, platform access, visual polish, public speaking, partner/family attendance, accent, eye contact, disability, camera use, English mechanics, or submission mode do not determine mastery unless meaning is unclear.
