...
**AS OF 2026-08-05: the official Irving ISD workbook ("Find Your Future", FYF) arrived and the curriculum is mid-realignment against it.** The generic H&L workbook is retired as a citation source. **Phases A (1SW, committed f2ea474) and B (2SW+3SW, complete 2026-08-05) are DONE**: re-cited to `(FYF p. N: "Section Name")`, district-expectations overlay applied (Learning Target/Success Criteria, five-move IISD blocks, 5E mapping), Wk0 fully audited, RIASEC renamed to the six H&L core personality types, Powerskills supplement retired (2SW Wk5 re-anchored on FYF-embedded lessons), preservation loop 6/6 both phases. Phase C (4SW-6SW, 18 weeks incl. the Ch-16→Capstone-Rungs spine) is pending. Standing rulings added in Phase B: 6SW Wk5 keeps a CCE-original mock interview (d(6)(C) would otherwise have zero year-wide coverage); campus/credential claims never come from one source alone (see PATHWAYS.md conflict notes; one fabricated credential was caught and fixed 2026-08-05). **Read `cce-curriculum/notes/fyf-realignment-plan.md` (plan of record, ratified decision register) and `cce-curriculum/notes/district-expectations-2026.md` (binding overlay spec) before touching any week.** Weeks in 2SW-6SW still carry stale generic-workbook citations until their phase lands.
