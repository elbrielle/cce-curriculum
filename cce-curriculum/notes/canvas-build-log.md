...
- The orchestrator now supports `--preflight` without a credential. The current pass confirms all 17 builders compile and all 18 coordinated 4SW-6SW teacher/student template pairs meet the scan-heading/semantic-callout/disclosure/no-legacy-tabs contract before the token prompt.
