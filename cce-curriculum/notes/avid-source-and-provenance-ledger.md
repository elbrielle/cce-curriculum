...
|---|---:|---|---|---|
| Monday | 15 | `cce-week1-day1-source-grounded.pptx` | `705ae7ae8208bad39d7db9939c75ef9470d7d4fc0ba9ab8cdac14211344d1ea8` | 15/15 full-size inspection; the Jenna Week 1.2 Think/share opening is now a concrete first-week-success Do Now; the agenda carries TEKS d(4)(A) and the exact notebook/goal/save sequence; every slide has timing, teacher move, student action, look-for, pivot/trim, recovery/access, and sources; fidelity pass; only inherited floral edge bleed flagged |
