...
3. **Platform setup remains incomplete.** The Grade 8 Xello completion and reporting path is now documented, but H&L class creation, rostering, the Coach Dashboard, eDynamic enrollment, and local escalation contacts remain outside the teacher-facing site. The only general guidance is prose buried in 1SW Wk0 Day 2 that says "confirm SSO before this lesson" without naming who to confirm with. `PLATFORMS.md` exists but sits at repo root, outside the site.
